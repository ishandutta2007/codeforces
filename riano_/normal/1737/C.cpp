...
int main(){
    ...
    rep(ii,T){
        ...
        if(p[1].first==1&&p[1].second==N&&p[2].first==2&&p[2].second==N){
            if(x==1||y==N){
                cout << "YES" << "\n";
            }
            else{
        ...
        if(p[0].first==N-1&&p[0].second==1&&p[1].first==N&&p[1].second==1){
            if(x==N||y==1){
                cout << "YES" << "\n";
            }
            else{
