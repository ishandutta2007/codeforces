#line 1 "codeforces-workspace/contest/1511/e/e.cpp"
...
#line 6 "codeforces-workspace/contest/1511/e/e.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace/contest/1511/e/e.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace/contest/1511/e/e.cpp"
...
#line 27 "codeforces-workspace/contest/1511/e/e.cpp"
...
void main() {
  ...
  int cnt = 0;
  for (auto &&v : grid) {
    cnt += count(begin(v), end(v), 'o');
    mint dp[2]{1};
    for (auto &&x : v) {
      if (x == 'o') {
        ans += dp[1] / 2;
        tie(dp[0], dp[1]) = pair(dp[1] + dp[0] / 2, dp[0] / 2);
      } else {
        dp[0] = 1;
        dp[1] = 0;
      }
