...
int main()
{
    ...
    for (int i=0;i<n;i++)
    {
        for (int j=0;j+1<m;j++)
        {
            int c;
            cin >> c;
            g[i*m+j].push_back({i*m+j+1,c});
            g[i*m+j+1].push_back({i*m+j,c});
        }
    }
    for (int i=0;i+1<n;i++)
    {
        for (int j=0;j<m;j++)
        {
            int c;
            cin >> c;
            g[i*m+j].push_back({i*m+j+m,c});
            g[i*m+j+m].push_back({i*m+j,c});
        }
    }
    if (k%2==1)
    {
