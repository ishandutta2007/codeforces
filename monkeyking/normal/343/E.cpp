...
//	for(auto x:v)
//	{
//		if(d.dist[x]<inf) v1.emplace_back(x);
//		else v2.emplace_back(x);
//	}
//	edge[cnt++]=mt(w,v1[0],v2[0]);
//	solve(v1);
//	solve(v2);
//}
//
...
//		x=find(x);
//		y=find(y);
//		nxt[o[x].second]=o[y].first;
//		f[x]=y;
//		o[y]=mp(o[x].first,o[y].second);
//	}
//	void init()
//	{
//		for(int i=0;i<n;i++) f[i]=i,o[i]=mp(i,i);
//	}
//}dsu;
//
//int main()
...
//	dsu.init();
//	sort(edge,edge+cnt);
//	reverse(edge,edge+cnt);
//	for(int i=0;i<cnt;i++)
//	{
//		auto [_,x,y]=edge[i];
//		dsu.merge(x,y);
//	}
//	int x=dsu.o[dsu.find(0)].first;
//	while(x!=-1)
//	{
//		cout<<x+1<<' ';
//		x=nxt[x];
