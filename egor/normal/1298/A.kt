...
object programkt {
    ...
    internal class TaskA {
        fun solve(testNumber: Int, `in`: InputReader, out: OutputWriter) {
            val x = `in`.readIntArray(4)
            ArrayUtils.sort(x)
            out.printLine(x[3] - x[0], x[3] - x[1], x[3] - x[2])
        }
    ...
    internal object ArrayUtils {
        ...
        @JvmOverloads
        fun sort(array: IntArray, comparator: IntComparator = IntComparator.DEFAULT): IntArray {
    ...
    internal interface IntComparator {
        ...
        class DefaultIntComparator : IntComparator {
        ...
        companion object {
            val DEFAULT: IntComparator = IntComparator.DefaultIntComparator()
        }
