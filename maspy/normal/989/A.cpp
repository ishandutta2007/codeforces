...
void solve() {
  STR(S);
  if (S.find("ABC") != string::npos) return Yes();
  if (S.find("ACB") != string::npos) return Yes();
  if (S.find("BAC") != string::npos) return Yes();
  if (S.find("BCA") != string::npos) return Yes();
  if (S.find("CAB") != string::npos) return Yes();
  if (S.find("CBA") != string::npos) return Yes();
  No();
}
