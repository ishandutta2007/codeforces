...
// cin>>T;while(T--)
{
    ...
    for(auto x:a)
    {
        l=lower_bound(b.begin(),b.end(),x.X)-b.begin();
        r=lower_bound(b.begin(),b.end(),x.Y)-b.begin();r++;
        val[l]++;val[r]--;
    }
    ...
    fo(i,n)
    {
        l=lower_bound(b.begin(),b.end(),a[i].X)-b.begin();
        r=lower_bound(b.begin(),b.end(),a[i].Y)-b.begin();
