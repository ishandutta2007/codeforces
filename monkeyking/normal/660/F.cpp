...
//{
//	bool mid=(f(lsh[(l+r)>>1])>data[x](lsh[(l+r)>>1]));
//	bool lef=(f(lsh[l])>data[x](lsh[l]));
//	if(mid)
//	{
//		swap(data[x],f);
//	}
...
//	{
//		int l=r;
//		insert(1,0,nn,Function(-l,-sw[l-1]+1LL*l*s[l-1]-s[l-1]));
//		chmax(res,query(s[r])+sw[r]+s[r]);
//	}
