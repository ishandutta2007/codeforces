...
#line 6 "Library\\config.hpp"

#line 3 "Library\\utils\\ejection.hpp"
struct eject_base {};
template <class Tp> struct eject : eject_base {
  eject(const Tp what) { std::cout << what << "\n"; }
};
#line 8 "Library\\config.hpp"
...
namespace workspace {
template <class Tp> void eject(Tp const &what) {
  std::cout << what << "\n";
  throw nullptr;
}
