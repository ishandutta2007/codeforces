...
/**
 * exactly two types of chars
 * every char occurs at least twice
 * say there are three letters
 * take lowest count char
 * place it first
 * we done
 * 2
 * 
