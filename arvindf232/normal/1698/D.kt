...
fun main(){
    solve.cases{
		...
		val n = getint
		val last = BinarySearchFirstTrue(0,n-1){r ->
			println("? 1 ${r+1}")
			System.out.flush()
			val stuff = getline(r+1)
			val out = stuff.count { it in 1..(r+1)}
			return@BinarySearchFirstTrue  out and 1 == 1
		}!!
		println("! ${last+1}")
