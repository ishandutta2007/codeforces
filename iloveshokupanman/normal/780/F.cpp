...
int main() {
    ...
    vector<vector<mat>> dp(62, vector<mat>(2, mat(N, 0)));
    ...
    repn(i, 61) {
        dp[i][0] = mul(dp[i - 1][0], dp[i - 1][1]);
        dp[i][1] = mul(dp[i - 1][1], dp[i - 1][0]);
    }
    ...
    rep(i, 4) {
        cout << i << endl;
        rep(j, N) {
            rep(k, N)cout << dp[i][0][j][k];
            cout << endl;
        }
        cout << endl;
        rep(j, N) {
            rep(k, N)cout << dp[i][1][j][k];
            cout << endl;
        }
    }
    */
