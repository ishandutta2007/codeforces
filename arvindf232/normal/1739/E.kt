...
fun main(){
    solve.cases{
        ...
        //end positoin, ban
        var now = Array(2){IntArray(4){nlarge } }

        now[0][0] = 0
        for(i in 0 until n){
            val a = (A[i] == '1').chi
            val b = (B[i] == '1').chi
            val new = Array(2){IntArray(4){nlarge } }

            for(st in 0 until 2){
                for(ban in 0 until 4){
                    val cost = now[st][ban]
                    for(na in 0..a){
                        for(nb in 0..b){

                            if(ban.has(0) && na == 1) continue
                            if(ban.has(1) && nb == 1) continue


                            val newcost = cost + na + nb
                            ...
                            val news =
                                if(na == 0 && nb == 0) st
                                else if(na == 1 && nb == 1) 1 - st
                                else if(na == 1) 0
                                else if(nb == 1) 1
                                else nlarge

                            new[news][newban] = maxOf(new[news][newban], newcost)
