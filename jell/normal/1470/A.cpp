#line 1 "codeforces-workspace/contest/1470/a/a.cpp"
/**
 * @file template.cpp
 * @brief Template
 */
...
#line 16 "codeforces-workspace/contest/1470/a/a.cpp"
...
void main() {
  ...
  i64 ans = 1e18;
  int mi = min(m, n);
  for (auto i : range(1 + min(m, n))) {
    chle(ans, acc[i] + ack[n - i]);
    if (mi == i) break;
    chle(mi, k[n - 1 - i] + i + 1);
    if (mi <= i) break;
  }
