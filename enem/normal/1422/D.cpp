    ...
    */
    ...
    REP(tc,1,ntc+1)
    {
        ...
        while(!pr.empty())
        {
            ...
            {
                dis[t.S]=(-t.F);
                ans=min(ans,abs(x[t.S]-fx)+abs(y[t.S]-fy)+dis[t.S]);
                auto it=xv.find(MP(x[t.S],t.S));
                if(it!=xv.begin())
                {
                    it--;
                    pr.push(MP(t.F-abs(x[t.S]-(*it).F),(*it).S));
                    it++;
                }
                it++;
                if(it!=xv.end())
                ...
                it--;
                xv.erase(it);
                it=yv.find(MP(y[t.S],t.S));
                if(it!=yv.begin())
                {
                    it--;
                    pr.push(MP(t.F-abs(y[t.S]-(*it).F),(*it).S));
                    it++;
                }
                it++;
                if(it!=yv.end())
