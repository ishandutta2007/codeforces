    ...
    */
    ...
    REP(tc,1,ntc+1)
    {
        ...
        REP(i,0,n)
        {
            ...
            REP(j,0,m)
            {
                if(lvlr[i]%2==0&&a[i][j]=='#') lvlr[i]++;
                if(lvlr[i]%2==1&&a[i][j]=='.') lvlr[i]++;
            }
            if(lvlr[i]>2) flag=false;
        }
        REP(j,0,m)
        {
            lvlc[j]=0;
            REP(i,0,n)
            {
                if(lvlc[j]%2==0&&a[i][j]=='#') lvlc[j]++;
                if(lvlc[j]%2==1&&a[i][j]=='.') lvlc[j]++;
            }
            if(lvlc[j]>2) flag=false;
        }
        REP(i,0,n)
        {
            if(lvlr[i]==0)
