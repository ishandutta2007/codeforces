...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
    ...
    {
        if(x!=s.size())(f[x+1][y][0][0]+=1)%=p;
        if(y!=t.size())(f[x][y+1][1][1]+=1)%=p;
        if(x!=s.size()&&s[x]!=s[x+1])(f[x+1][y][0][0]+=f[x][y][0][0])%=p,(f[x+1][y][0][2]+=f[x][y][0][1]+f[x][y][0][2])%=p;
        if(x!=s.size()&&t[y]!=s[x+1])(f[x+1][y][0][0]+=f[x][y][1][0])%=p,(f[x+1][y][0][2]+=f[x][y][1][1]+f[x][y][1][2])%=p;
        if(y!=t.size()&&s[x]!=t[y+1])(f[x][y+1][1][1]+=f[x][y][0][1])%=p,(f[x][y+1][1][2]+=f[x][y][0][0]+f[x][y][0][2])%=p;
        if(y!=t.size()&&t[y]!=t[y+1])(f[x][y+1][1][1]+=f[x][y][1][1])%=p,(f[x][y+1][1][2]+=f[x][y][1][0]+f[x][y][1][2])%=p;
    }
	int ans=0;
    for(int x=1;x<s.size();x++)
    for(int y=1;y<t.size();y++)
    (ans+=f[x][y][0][2]+f[x][y][1][2])%=p;
    cout<<ans<<endl;
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
/*Main-end----------------------------------------------------------------------------------------*/
}
