        ...
        if (minSingle != -1) {
            ...
            if (q[id] == s.size()) {
                ...
                if (other.size() >= rem - 1) {
                    ...
                    char second = 'a' + sid;
                    if (tid == -1) {
                        answer += string(q[sid], second);
                        answer += string(rem, first);
                    } else {
                        answer += second;
                        q[sid]--;
                        answer += string(rem, first);
