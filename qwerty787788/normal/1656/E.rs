pub mod solution {
//{"name":"E.   ","group":"Codeforces - CodeTON Round 1 (Div. 1 + Div. 2, Rated, Prizes!)","url":"https://codeforces.com/contest/1656/problem/E","interactive":false,"timeLimit":1000,"tests":[{"input":"2\n5\n1 2\n1 3\n3 4\n3 5\n3\n1 2\n1 3\n","output":"-3 5 1 2 2\n1 1 1\n"}],"testType":"multiNumber","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null},"languages":{"java":{"taskClass":"EOdinakovieSummiDerevev"}}}
