#line 1 "codeforces-workspace\\contest\\1539\\c\\c.cpp"
...
#line 11 "codeforces-workspace\\contest\\1539\\c\\c.cpp"
...
#line 27 "codeforces-workspace\\contest\\1539\\c\\c.cpp"
...
void main() {
  ...
  sort(begin(a), end(a));
  heap<i64, greater<>> hp;
  for (auto i : range(a.begin(), a.end() - 1)) {
    hp.emplace(*next(i) - *i);
  }
  while (!hp.empty()) {
    auto t = hp.top();
