#line 1 "codeforces-workspace\\contest\\1540\\b\\b.cpp"
...
#line 6 "codeforces-workspace\\contest\\1540\\b\\b.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace\\contest\\1540\\b\\b.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace\\contest\\1540\\b\\b.cpp"
...
#line 27 "codeforces-workspace\\contest\\1540\\b\\b.cpp"
    ...
    for (auto j : range(i)) {
      ...
      for (auto k : range(n)) {
        if (dist[i][k] == dist[i][j] + dist[j][k]) {
          ...
          auto jd = (dist[k][j] - dist[k][i] + dist[i][j]) / 2;
          auto id = dist[i][j] - jd;
          ans += dp[id][jd];
        }
      }
