...
public:
    void solve() {
        ...
        for (int i : range(n)) {
            ...
            int crow;
            if (a[i] == 1 && !row2.empty()) {
                ans.emplace_back(row2.back(), i + 1);
                crow = row2.back();
                row2.pop_back();
            } else {
                ans.emplace_back(nrow, i + 1);
                crow = nrow++;
                if (row3 != -1) {
                    ans.emplace_back(row3, i + 1);
                    row3 = -1;
                }
            }
            if (a[i] == 2) {
