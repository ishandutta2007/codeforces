...
public class Main {
    ...
    static class C {
        public void solve(int testNumber, InputReader in, OutputWriter out) {
            ...
            long base = IntegerUtils.power(2, n, MiscUtils.MOD7);
            long rev2 = IntegerUtils.reverse(2, MiscUtils.MOD7);
            long answer = (1L << k) % MiscUtils.MOD7 * base % MiscUtils.MOD7;
            int[] order = ArrayUtils.order(x);
            order = ArrayUtils.reversePermutation(order);
            ArrayUtils.orderBy(order, u, v);
            Arrays.sort(x);
