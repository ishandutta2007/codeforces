    ...
    public static class Task implements Runnable {
        ...
        public void solve() {
            ...
            for (int i = 0; i < limit; i++) {
                c[i] = i;
                io.cache.append("? ").append(i).append('\n');
                io.flush();
                b[i] = io.readInt();
            }
            ...
            P[] p = new P[limit];
            for (int i = 0; i < limit; i++) {
                p[i] = P.valueOf(1, Mathematics.mod(-c[i], mod));
            }

            P result = P.valueOf(0);
            for (int i = 0; i < limit; i++) {
                P mul = P.valueOf(b[i]);
                for (int j = 0; j < limit; j++) {
                    ...
                    mul = P.mul(mul, p[j]);
                    mul = P.mul(mul, P.valueOf(Mathematics.inverse(c[i] - c[j], mod)));
                }
                result = P.add(result, mul);
            }
        ...
        public static class P {
            ...
            public static P valueOf(int a1, int a0) {
                P p = new P();
                p.a = new long[2];
                p.a[1] = a1;
                p.a[0] = a0;
            ...
            public static P mul(P a, P b) {
                int size = a.a.length + b.a.length - 1;
            ...
            public static P add(P a, P b) {
                int size = Math.max(a.a.length, b.a.length);
                long[] val = new long[size];
                for (int i = 0; i < size; i++) {
                    if (i < a.a.length) {
                        val[i] += a.a[i];
