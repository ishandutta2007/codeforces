...
struct TPoint3 {
    ...
    TPoint3 operator*(long double r) {
        return TPoint3(x * r, y * r, z * r);
    }

    TPoint3 operator+(TPoint3 &r) {
        return TPoint3(x + r.x, y + r.y, z + r.z);
    }
...
struct TPoint2 {
    ...
    TPoint2(long double _x = 0, long double _y = 0)
        : x(_x)
        , y(_y)
    {
    }
...
long double maxXD(long double X, long double miny, long double maxy, vector< TPoint2 > &points) {
...
TPoint3 vectmul(TPoint3 &a, TPoint3 &b) {
    return TPoint3(a.y * b.z - a.z * b.y, a.z * b.x - a.x * b.z, a.x * b.y - a.y * b.x);
}
