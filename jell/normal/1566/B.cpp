#line 1 "codeforces-workspace\\contest\\1566\\b\\b.cpp"
...
#line 13 "codeforces-workspace\\contest\\1566\\b\\b.cpp"
...
void main() {
  ...
  input<string> s;
  auto ans = 2;
  if (!count(begin(s), end(s), '0')) eject(0);
  if (count(begin(s), end(s), '0') ==
      s.find_last_of('0') - s.find_first_of('0') + 1)
    eject(1);
  print(2);
}
