...
main() {
    ...
    rep(i, n) {
        f.add_edge(1, 3 + i, 1, 200000 - x[i]);
        f.add_edge(2, 3 + i, 1, 200000 - y[i]);
        f.add_edge(3 + i, 3 + n, 1, 0);
        f.add_edge(3 + i, 3 + n, 1, (ll)x[i] * y[i] / 1e5);
    }
    f.add_edge(0, 1, a, 0);
    f.add_edge(0, 2, b, 0);
    cout << (double)(200000 * (a + b) - f.min_cost_flow(0, 3 + n, a + b)) / 100000 << endl;
}