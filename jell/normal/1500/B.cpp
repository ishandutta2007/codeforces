#line 1 "codeforces-workspace/contest/1500/b/b.cpp"
...
#line 6 "codeforces-workspace/contest/1500/b/b.cpp"
// #include "lib/cxx20"
...
#line 11 "codeforces-workspace/contest/1500/b/b.cpp"
...
#line 27 "codeforces-workspace/contest/1500/b/b.cpp"
...
void main() {
  ...
  auto pred = [&](i64 t) -> bool {  // [0, t)
    i64 cnt = s.size() * (t / mod);
    for (auto i : s) {
      if (i < t % mod) cnt++;
    }
    return t - cnt < k;
  ...
  cout << binary_search(i64(0), (i64)1e18, pred) + 1 << "\n";
}
