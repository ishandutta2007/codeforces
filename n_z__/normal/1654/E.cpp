...
#endif
#define max(a,...) (max({a,##__VA_ARGS__}))
#define min(a,...) (min({a,##__VA_ARGS__}))
...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
    ...
    ff(x,-50,50)
    {
        ...
        ff(y,1,n)ans=max(ans,++p[a[y]-x*y]);
    }
    ff(x,1,n)
    {
        unordered_map<int,int>p;
        ff(y,x+1,min(x+2000,n))
        if((a[y]-a[x])%(y-x)==0)ans=max(ans,++p[(a[y]-a[x])/(y-x)]+1);
    }
    cout<<n-ans<<endl;
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
/*Main-end----------------------------------------------------------------------------------------*/
