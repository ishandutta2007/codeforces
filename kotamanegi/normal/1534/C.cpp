#line 1 "Contests/Codeforces_1534/C/main.cpp"
using namespace std;
...
#endif
#line 3 "Contests/Codeforces_1534/C/main.cpp"
...
#line 7 "Contests/Codeforces_1534/C/main.cpp"
...
void solve(){
    ...
    REP(i,n){
        places[0][gogo[i].first] = i;
        places[1][gogo[i].second] = i;
        visited[i] = 0;
    }
    REP(i,n){
        ...
        while(true){
            int next = places[state][target];
            if(visited[next] == 1){
                break;
            }
            visited[next] = 1;
            if(state == 0){
                target = gogo[next].second;
                state = 0;
            }else{
                target = gogo[next].first;
                state = 0;
            }
        }
        ans *= 2LL;
