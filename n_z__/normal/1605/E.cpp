...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
    ...
    {
        for(int y=2;x*y<=n;y++)
        mu[x*y]-=mu[x],a[x*y]-=a[x];
        if(mu[x])v[++l]=a[x]/mu[x];else z+=abs(a[x]);
    }
    sort(v+1,v+1+l);
    sort(v+1,v+*v+1);
    for(int x=1;x<=n;x++)
    ...
    while(m--)
    {
        int x;
        cin>>x;
        int y=upper_bound(v+1,v+1+l,-x)-v-1;
        cout<<z-x*y-w[y]+x*(l-y)+w[l]-w[y]<<endl;
    }
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
/*Main-end----------------------------------------------------------------------------------------*/
}
