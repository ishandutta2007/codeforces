...
//{
//	if(x==0) return 1;
//	if((ll)n-1LL*(k-1)*(x-1)<x) return 0;
//	return C(n-(k-1)*(x-1),x);
//}
//
//void solve()
//{
...
//	for(int i=0;i<=n;i++)
//	{
//		chadd(res,1LL*combinatorics::fac[i]*combinatorics::fac[n-i]%mod*f(i)%mod);
//	}
//	cout<<1LL*res*combinatorics::ifac[n]%mod<<endl;
//}
//
//int main()
//{
//	// freopen("input.txt","r",stdin);
//	for(int i=1;i<=100000;i++) inum[i]=fastpow(i,mod-2);
//	combinatorics::init(100000,mod);
//	int T;
//	cin>>T;
//	while(T--) solve();
//	return 0;
