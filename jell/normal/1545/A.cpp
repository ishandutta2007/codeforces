#line 1 "codeforces-workspace\\contest\\1545\\a\\a.cpp"
...
#endif
#line 8 "codeforces-workspace\\contest\\1545\\a\\a.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace\\contest\\1545\\a\\a.cpp"
...
void main() {
  ...
  auto acc = 0;
  for (auto &&[_, v] : a) {
    if (v[1] != (v[0] + v[1] + acc) / 2 - acc / 2) eject("NO");
    acc += v[0] + v[1];
  }
