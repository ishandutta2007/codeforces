...
int main()
{
    ...
    ans = end_is - x1[0];
    ll save = end_is;
    //cout << 0 << " " << x1[0] << " " << end_is << " " << real_end << endl;
    for (int i = 1; i < n; i++)
    {
        end_is = save;
        //cout << "begin of " << i << " oper" << " " << end_is << endl;
        ll start = x1[i];
        h0 = lens[2 * i - 1] + end_is - real_end;
        //cout << lens[2 * i - 1] << " " << end_is << " " << real_end << endl;
        ll end_is = real_end;
        //cout << "can more : " << h0 << endl;
        while (h0 > 0)
        {
            //cout << id << endl;
            if (id % 2 == 0)
        ...
        //cout << i << " " << start << " " << end_is << " " << real_end << endl;
        //cout << "end of " << i << "iter : " << end_is << endl;
        save = end_is;
        if (end_is - start >= ans)
        {
            ans = end_is - start;
