...
using M = matrix<modnum<int(1e9 + 7) - 1>>;
using V = vector<modnum<int(1e9 + 7) - 1>>;

int main() {
    setIO();

    M t(3, 3);
    t[0][0] = t[0][1] = t[0][2] = t[1][0] = t[2][1] = 1;
    ...
    auto p1 = t.pow(n - 3) * V{0, 0, 1};
    auto p2 = t.pow(n - 3) * V{0, 1, 0};
    auto p3 = t.pow(n - 3) * V{1, 0, 0};
