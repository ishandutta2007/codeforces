pub mod solution {
//{"name":"F.  MST","group":"Codeforces - CodeTON Round 1 (Div. 1 + Div. 2, Rated, Prizes!)","url":"https://codeforces.com/contest/1656/problem/F","interactive":false,"timeLimit":1000,"tests":[{"input":"5\n2\n1 0\n2\n-1 1\n3\n1 -1 -2\n3\n3 -1 -2\n4\n1 2 3 -4\n","output":"INF\n-1\nINF\n-6\n-18\n"}],"testType":"multiNumber","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null},"languages":{"java":{"taskClass":"FParametricheskoeMST"}}}
