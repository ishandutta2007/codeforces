...
int n,q;
int exist[1000100],prid[1000100];
int np[1000100];
const int N = 1000090;
vi p;
...
vi ow[1000100];
int S[1000100];
set<int> conn[1000100];
int main() {
	re(n,q);
	vi ipt(n);
	re(ipt);
	each(ct,ipt){ exist[ct] = 1; }
	for(int i=2;i<=N;i++){
		if(np[i])continue;
		p.pb(i);
