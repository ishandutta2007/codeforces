...
int main() {
    ...
    lazy_segtree<ll, min, inf, ll, ad, ad, z> lsg(N + 1);
    rep(i, N + 1)lsg.set(i, 0);

    segtree<ll, max, z> sg(N + 1);
    repn(i, N)sg.set(i, p[i]);
    ...
    repn(i, N) {
        ...
        //rep(i, N + 1)cout << lsg.get(i) << " ";
        //cout << endl;

        ll x = lsg.max_right<ch>(0);
        ll y = ivp[sg.prod(0, x + 1)];
        //cout << x << " " << y << endl;
