...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
    ...
    {
        s+=x;
        for(int y=-s-x-1;y<=s+x+1;y++)
        g[y+D]=(g[y-1+D]+f[y+D])%p;
        for(int y=-s-1;y<s;y++)
        {
            f[y+1+D]=((f[y+D]+g[y+x+1+D]-g[y+D]*2+g[y-x-1+D])%p+p)%p;
            if(y>0&&y<=x)(ans[x+1]+=(g[s+D]-g[y+D])%p*(x-y+1)%p)%=p;
        }
    }
    for(int x=1;x<n;x++)
    (ans[x+1]+=ans[x]*(x+1)%p)%=p;
    cout<<(ans[n]+p)%p<<endl;
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
/*Main-end----------------------------------------------------------------------------------------*/
}
