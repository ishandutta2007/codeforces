...
{
    LL n = in;
    LL d1 = n / 10000, d2 = (n / 1000) % 10, d3 = (n / 100) % 10, d4 = (n / 10) % 10, d5 = n % 10;
    LL nn = d1 * 10000 + d3 * 1000 + d5 * 100 + d4 * 10 + d2;
    n = nn * nn % 100000 * nn % 100000 * nn % 100000 * nn % 100000;
    d1 = n / 10000, d2 = (n / 1000) % 10, d3 = (n / 100) % 10, d4 = (n / 10) % 10, d5 = n % 10;
    out.put(d1, d2, d3, d4, d5);
    return 0;
}