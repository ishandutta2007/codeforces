#line 1 "codeforces-workspace\\contest\\933\\d\\d.cpp"
...
#line 6 "codeforces-workspace\\contest\\933\\d\\d.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace\\contest\\933\\d\\d.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace\\contest\\933\\d\\d.cpp"
...
#line 35 "codeforces-workspace\\contest\\933\\d\\d.cpp"
...
void main() {
  ...
  mint ans;
  for (i64 x = 0, y = box; x < box; ++x) {
    while (x * x + y * y > m) --y;

    mint a = m + 1 - x * x, b = m + x * x * 2;
    mint p[8]{1};
    mint now;
    for (auto i = 1; i < size(p); ++i) p[i] = p[i - 1] * y;
