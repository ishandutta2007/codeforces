#line 1 "codeforces-workspace\\contest\\1633\\b\\b.cpp"
...
#line 13 "codeforces-workspace\\contest\\1633\\b\\b.cpp"
...
void main() {
  ...
  input<string> S;
  auto zeros = count(begin(S), end(S), '0');
  auto ones = S.size() - zeros;
  if (zeros != ones)
