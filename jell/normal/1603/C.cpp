#line 1 "codeforces-workspace\\contest\\1603\\c\\c.cpp"
...
#line 13 "codeforces-workspace\\contest\\1603\\c\\c.cpp"
...
#line 29 "codeforces-workspace\\contest\\1603\\c\\c.cpp"
namespace workspace {
...
void main() {
  ...
  for (auto i : range(n)) {
    for (auto j : rrange(i)) {
      auto k = ceil_div(a[j], a[j + 1] / b[j + 1]);
      if (b[j] >= k) break;
      sum += (k - b[j]) * mint(j + 1);
      b[j] = k;
    }
