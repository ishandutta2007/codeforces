...
int main()
{
	...
	else if(l==1)cout<<myabs(r-pos)+1<<endl;
	else if(r==n)cout<<myabs(pos-l)+1<<endl;
	else if(myabs(r-pos)>myabs(pos-l))
		cout<<myabs(pos-l)+(r-l)+2<<endl;
	else
		cout<<myabs(r-pos)+(r-l)+2<<endl;
	return 0;
}