...
ll n, m, x, y, k, ans = -1;
string s;
ll a[500000], white[500000], orange[500000], red[500000], a1[500000], a2[500000], a3[500000];
int main()
{
    cin >> n >> k;
    int w = 0, o = 0, r = 0;
    ...
    for (int cw = 1; cw < k; cw++)
    {
        ...
        if (cw > w)
            continue;
        ll white_beauty = a1[w] - a1[w - cw];
        ll orange_beauty = a2[o] - a2[o - co];
