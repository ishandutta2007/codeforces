...
ll n, m, k, l, r, x, y, xk, yk, how, can, t, mini = 10399;
ll a[100000];
...
int main()
{
    ...
    while (true)
    {
        ...
        //cout << n % 10000 / 1000 << " ";
        //cout << endl;
        if (n % 10 != n % 100 / 10 && n % 10 != n % 1000 / 100 && n % 10 != n % 10000 / 1000 && n % 100 / 10 != n % 1000 / 100 && n % 100 / 10 != n % 10000 / 1000 && n % 1000 / 100 != n % 10000 / 1000)
        {
            cout << n;
            return 0;
        }
