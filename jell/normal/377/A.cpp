#line 1 "codeforces-workspace\\contest\\377\\a\\a.cpp"
...
#endif
#line 8 "codeforces-workspace\\contest\\377\\a\\a.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace\\contest\\377\\a\\a.cpp"
...
void main() {
  ...
  auto dfs = fixed_point([&](const auto& dfs, int x, int y) -> void {
    pair<int, int> nx[] = {{x - 1, y}, {x, y - 1}, {x + 1, y}, {x, y + 1}};
    grid[x][y] = '#';
    for (auto [i, j] : nx) {
