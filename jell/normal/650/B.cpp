...
#line 3 "codeforces-workspace\\contest\\650\\b\\b.cpp"
#include <bits/extc++.h>
...
#line 12 "codeforces-workspace\\contest\\650\\b\\b.cpp"
namespace workspace {
    constexpr char eol = '\n';
...
int solve(string s)
{
    ...
    {
        while(j>=0 and (i+j>=n or t<l[i]+r[j])) j--;
        if(j>=0) chge(res,i+1+j);
    }
    return res;
}
