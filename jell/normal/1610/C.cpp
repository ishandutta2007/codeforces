#line 1 "codeforces-workspace\\contest\\1610\\c\\c.cpp"
...
#line 13 "codeforces-workspace\\contest\\1610\\c\\c.cpp"
...
#line 29 "codeforces-workspace\\contest\\1610\\c\\c.cpp"
...
void main() {
  ...
  input n;
  input<vector<pair<i32, i32>>> a(n);

  auto pred = [&](i32 k) {
    auto pos = 0;
    for (auto t : range(k)) {
      if (pos == n) return false;
      while (a[pos].second < t or a[pos].first < k - 1 - t) {
        ++pos;
        if (pos == n) return false;
      }
      ++pos;
  ...
  print(bisection<int>(1, n + 1, pred) - 1);
}
