...
public class CFCT1161 {
    ...
    public static class Task implements Runnable {
        ...
        public void solve() {
            ...
            for (int i = 1; i <= k; i++) {
                q[i] = io.readInt();
                if (appearance.contains(q[i]) == false) {
                    appearance.add(q[i]);
                    first[i] = true;
                }
            }
            ...
            for (int i = k; i >= 1; i--) {
                ...
                if (q[i] > 1 && !set.contains(q[i] - 1)) {
                    total++;
                    //io.cache.append(q[i]).append(' ').append(q[i] - 1).append('\n');
                }
                if (q[i] < n && !set.contains(q[i] + 1)) {
                    total++;
                    //io.cache.append(q[i]).append(' ').append(q[i] + 1).append('\n');
                }
            }
            ...
            for (int i = 1; i <= n; i++) {
                ...
                total++;
                //io.cache.append(i).append(' ').append(i).append('\n');
                if (i < n) {
                    total++;
                    //io.cache.append(i).append(' ').append(i + 1).append('\n');
                }
