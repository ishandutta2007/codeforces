...
void solve(){
    ...
    for(auto e:dp){
        ...
        ll res=val*cnt+((cnt*(cnt-1))/2)*tmp;
        if (res<k){
            k-=res;
            continue;
        }
