        ...
        long long m,x,n,y,z,k,mn=3e9,mx,ans,a[500001],b[500003];vector<long long>v;char ch;
        ...
        while(t--)
        {
            ...
            {
                cout<<"YES\n";
                for(int i=0;i<k-1;i++)cout<<1<<" ";cout<<n-k+1<<endl;
            }
            else if(k*2<=n&&n%2==0)
            {
                cout<<"YES\n";
                for(int i=0;i<k-1;i++)cout<<"2 ";cout<<n-(k-1)*2<<endl;
