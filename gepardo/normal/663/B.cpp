/*-------------------( alex256 )--------------------\
|    Contest: Codeforces Round 347 (Div. 1)         |
|       Task: B                                     |
|       Date: 16. 04. 2016                          |
\--------------------------------------------------*/
// Includes
...
main()
{
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        switch(s.length())
        {
            case 1: out.putLn(1989 + (c + 1) % 10); break;
            case 2: out.putLn(1999 + (c + 1) % 100); break;
            case 3: out.putLn(2099 + (c + 901) % 1000); break;
            case 4: out.putLn((c < 3099) ? (10000 + c) : c); break;
            case 5: out.putLn((c < 13099) ? (100000 + c) : c); break;
            case 6: out.putLn((c < 113099) ? (1000000 + c) : c); break;
            case 7: out.putLn((c < 1113099) ? (10000000 + c) : c); break;
            case 8: out.putLn((c < 11113099) ? (100000000 + c) : c); break;
            case 9: out.putLn((c < 111113099) ? (1000000000 + c) : c); break;
        }
