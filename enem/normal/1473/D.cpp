...
int main()
{
    ...
    REP(tc,1,ntc+1)
    {
        ...
        REP(i,0,n)
        {
            ...
            pr2[i+1]=max(pr1[i+1], pr2[i]);
            pr3[i+1]=min(pr1[i+1], pr3[i]);
        }
        ll sr1[n+1],sr2[n+1],sr3[n+1];
        sr1[0]=sr2[0]=sr3[0]=0;
        REP(i,0,n)
        {
            sr1[i+1]=sr1[i];
            ...
            sr2[i+1]=max(sr1[i+1], sr2[i]);
            sr3[i+1]=min(sr1[i+1], sr3[i]);
        }
        REP(i,0,m)
        {
            ll l,r;
            ...
            ll l1=pr3[l-1],r1=pr2[l-1],l2=sr3[n-r]+pr1[l-1]-sr1[n-r],r2=sr2[n-r]+pr1[l-1]-sr1[n-r];

            if(l1<=l2 && r2<=r1) cout<<r1-l1+1;
            else if(l2<=l1 && r1<=r2) cout<<r2-l2+1;
            else if(l1<=l2) cout<<r2-l1+1;
            else cout<<r1-l2+1;
            cout<<'\n';
        }
    }
