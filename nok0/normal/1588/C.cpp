#line 1 "/Users/nok0/Documents/Programming/nok0/atcoder/fenwicktree.hpp"
...
#line 5 "/Users/nok0/Documents/Programming/nok0/atcoder/internal_type_traits.hpp"
#include <numeric>
#include <type_traits>
...
#line 8 "/Users/nok0/Documents/Programming/nok0/atcoder/fenwicktree.hpp"
...
#line 3 "/Users/nok0/Documents/Programming/nok0/data_structure/sparse_table.hpp"
...
#line 5 "/Users/nok0/Documents/Programming/nok0/data_structure/sparse_table.hpp"
...
using S = ll;
S mn_op(ll x, ll y) { return min(x, y); }
S mx_op(ll x, ll y) { return max(x, y); }
...
void main_() {
	...
	sparse_table<ll, mn_op> mn_even(even), mn_odd(odd);
	sparse_table<ll, mx_op> mx_even(even), mx_odd(odd);
	atcoder::fenwick_tree<int> bt(n + 1);
	...
	for(auto [key, vec] : mp) {
		...
		foa(l, vec) {
			...
			int ok = l / 2, ng = SZ(odd);
			auto f = [&](int mid) {
				return mn_odd.prod(ok, mid) >= cum[l];
			};
			auto r = bin_search(ok, ng, f) * 2 + 1;
			if(l & 1) ok++;
			ng = SZ(even);
			auto g = [&](int mid) {
				return mx_even.prod(ok, mid) <= cum[l];
			};
			auto r2 = bin_search(ok, ng, g) * 2;
			int R = min(r, r2);
			if(R + 1 == max(r, r2)) R++;
			res += bt.sum(l, R + 1) - 1;
		}
