...
fun main(){
    solve.cases{
        ...
        val dreach = IntArray(n){it}
        val areach = IntArray(n){it}
        ...
        var ret2 = IntArray(n){-1}

        var now = 0
        var pointer = 0
        while(pointer < n){
            val to = dreach[pointer]
            for(i in to downTo pointer){
                ret1[i] = now
                now ++
            }
            pointer = to + 1
...
//        var now = 0
//        var pointer = 0
//        while(now < n && pointer < n){
//            val here = pointer
//            while(pointer < n-1 && str[pointer] == '>'){
//                pointer ++
//            }
//            for(i in pointer downTo here){
//                ret1[i] = now
//                now ++
//            }
//            pointer ++
