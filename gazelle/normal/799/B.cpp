...
int main() {
    ...
    priority_queue<int, vector<int>, greater<int>> c1, c2, c3;
    ...
    REP(i, n) {
        if(a[i] == 1 || b[i] == 1) c1.push(p[i]);
        if(a[i] == 2 || b[i] == 2) c2.push(p[i]);
        if(a[i] == 3 || b[i] == 3) c3.push(p[i]);
    }
    ...
    REP(i, m) {
        while(not c1.empty() && used.count(c1.top())) c1.pop();
        while(not c2.empty() && used.count(c2.top())) c2.pop();
        while(not c3.empty() && used.count(c3.top())) c3.pop();
        ...
        if(c == 1 && not c1.empty()) {
            ...
            used.insert(c1.top());
            c1.pop();
        } else if(c == 2 && not c2.empty()) {
            ans.pb(c2.top());
            used.insert(c2.top());
            c2.pop();
        } else if(c == 3 && not c3.empty()) {
            ans.pb(c3.top());
            used.insert(c3.top());
            c3.pop();
        } else {
