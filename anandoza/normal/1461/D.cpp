...
void solve() {
    ...
    using P = array<decltype(a.begin()), 2>;
    set<ll> possible;
    {
        queue<P> q;
        q.push({all(a)});
        ...
        while (!q.empty()) {
            ...
            possible.insert(accumulate(l, r, 0LL));

            auto mid = (*min_element(l, r) + *max_element(l, r)) / 2;
            auto m = upper_bound(all(a), mid);
