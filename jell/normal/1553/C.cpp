#line 1 "codeforces-workspace\\contest\\1553\\c\\c.cpp"
...
#line 16 "codeforces-workspace\\contest\\1553\\c\\c.cpp"
//*/
...
void main() {
  ...
  fixed_point dfs = [&](auto dfs, int i, int f, int s) -> int {
    ...
    switch (a[i]) {
      ...
      case '?': {
        auto ret = dfs(i + 1, f, s);
        if (i % 2)
          s++;
        else
          f++;
        return min(dfs(i + 1, f, s), ret);
      } break;
    }
  };
