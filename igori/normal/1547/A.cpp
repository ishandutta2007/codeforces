...
void solve()
{
    ...
    if (xa == xb && xb == xc && ya < yc && yc < yb) cout << d + 2 << "\n";
    else if (xa == xb && xb == xc && yb < yc && yc < ya) cout << d + 2 << "\n";
    else if (ya == yb && yb == yc && xa < xc && xc < xb) cout << d + 2 << "\n";
    else if (ya == yb && yb == yc && xb < xc && xc < xa) cout << d + 2 << "\n";
    else cout << d << "\n";
}
