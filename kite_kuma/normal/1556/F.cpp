...
int main() {
	...
	// unordered_map<ll, mint> cut;

	// auto pack = [&](int a, int b) { return ll(a) * mod + b; };
	// auto unpack = [&](ll b) { return make_pair(int(b / mod), int(b % mod)); };

	// for(int u = 1; u < subsets; u++) {
	// 	for(int t = u; t >= 0; t--) {
	// 		t &= u;
	// 		int s = u ^ t;
	// 		mint res = 1;
	...
	// 					}
	// 				} else {
	// 					res = cut[pack(s ^ (1 << i), t)] * cut[pack(1 << i, t)];
	// 				}
	// 				break;
	// 			}
	// 		}
