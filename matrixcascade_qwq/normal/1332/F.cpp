...
vector<int>v[maxn];
int dp[maxn][2][2];//x to fa in edge, x in set
Mod998;
void dfs(int x,int fa)
{
	...
	fp v[x] pf
	{
		...
		dp[x][1][0]*=(dp[to][1][0]+dp[to][0][0]+dp[to][1][1]+dp[to][0][1])%mod;dp[x][1][0]%=mod;
		dp[x][1][1]*=(dp[to][1][0]+dp[to][0][1]+dp[to][0][0])%mod;dp[x][1][1]%=mod;
		dp[x][0][0]*=(dp[to][1][0]+dp[to][0][0]+dp[to][1][1]+dp[to][0][1])%mod;dp[x][0][0]%=mod;
		dp[x][0][1]*=(dp[to][1][0]+dp[to][0][1]+dp[to][0][0])%mod;dp[x][0][1]%=mod;
		mn*=(dp[to][0][0]+dp[to][0][1])%mod;mn%=mod;
	}
	dp[x][0][1]-=mn;dp[x][0][1]+=mod;dp[x][0][1]%=mod;
}
signed main()
{
	int T=1;
	while(T--)
	{
		...
		int ans=dp[1][0][0]+dp[1][0][1]+mod-1;
		ans%=mod;
		cout<<ans;
	}
}
