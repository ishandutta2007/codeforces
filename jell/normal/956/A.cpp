#line 1 "codeforces-workspace\\contest\\956\\a\\a.cpp"
...
#endif
#line 8 "codeforces-workspace\\contest\\956\\a\\a.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace\\contest\\956\\a\\a.cpp"
...
void main() {
  ...
  for (auto &&[src, flag] : enumerate(used)) {
    if (flag) {
      continue;
    }
    queue<int> Q;
    Q.push(src);
    int vn1 = 0, vn2 = 0, en = 0;
    while (!Q.empty()) {
      auto now = Q.front();
      Q.pop();
      if (used[now]) {
