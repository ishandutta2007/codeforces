...
#include <bits/stdc++.h>
using namespace std;
string u[7]={"monday", "tuesday", "wednesday", "thursday", "friday", "saturday", "sunday"};
void main()
{
