...
int main()
{
    in(n);
    list<int> a;
    list<int>::iterator q[n];
    forn(i, n)
    {
        int z = nxt() - 1;
        q[z] = a.insert(a.end(), z);
    }
    int time = 0;
    int tt[n];
    clr(tt);
