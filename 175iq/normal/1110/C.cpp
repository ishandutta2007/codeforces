...
vi ans={1,1,5,1,21,1,85,73,341,89,1365,1,5461,4681,21845,1,87381,1,349525,299593,1398101,178481,5592405,1082401};
...
int main()
{
    ...
    F(i,0,q)
    {
        ...
        if(c==0)
            cout<<ans[__builtin_popcount(b)-2]<<endl    ;
        else
