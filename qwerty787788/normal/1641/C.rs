pub mod solution {
//{"name":"C.   ","group":"Codeforces - Codeforces Round #773 (Div. 1)","url":"https://codeforces.com/contest/1641/problem/C","interactive":false,"timeLimit":1500,"tests":[{"input":"6 9\n0 4 5 0\n1 5\n1 6\n0 4 6 1\n1 6\n0 2 5 1\n0 2 2 0\n1 3\n1 2\n","output":"NO\nN/A\nYES\nYES\nNO\n"}],"testType":"single","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null},"languages":{"java":{"taskClass":"CAnonimnostNasheVse"}}}

use std::cmp::max;
use std::collections::BTreeSet;

use crate::algo_lib::collections::sparse_table_max::SparseTableMax;
...
use crate::algo_lib::misc::bits::index_of_highest_set_bit;
use std::fmt::Debug;
use std::ops::Range;
