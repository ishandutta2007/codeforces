...
#line 2 "/home/maspy/library/sequence/linearrecurrence.hpp"

#line 2 "/home/maspy/library/polynomial/convolution.hpp"
...
#line 4 "/home/maspy/library/sequence/linearrecurrence.hpp"
...
void solve() {
  ...
  FOR(i, LIM) {
    ...
    FOR(x, MOD) FOR(a, 10) {
      ll y = (10 * x + a) % MOD;
      newDP[y] += mint(CNT[a]) * DP[x];
    }
    swap(DP, newDP);
  }
  print(interpolate_linear_recurrence(ANS, B));
}
