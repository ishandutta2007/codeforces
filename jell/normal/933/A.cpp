#line 1 "codeforces-workspace\\contest\\933\\a\\a.cpp"
...
#endif
#line 8 "codeforces-workspace\\contest\\933\\a\\a.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace\\contest\\933\\a\\a.cpp"
...
void main() {
  ...
  reverse(begin(lis[1]), end(lis[1]));

  auto ans = 0;
  for (auto &&[x, y] : zip(lis[0], lis[1])) {
    chgr(ans, x + y);
  }
  cout << ans << "\n";
}
