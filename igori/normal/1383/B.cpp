...
int calc(int c0, int c1, int have, int turn)
{
    if (c0 == 0 && c1 == 0) return have;
    if (turn == 0)
    {
        if (c0 && calc(c0 - 1, c1, have, turn ^ 1)) return 1;
        if (c1 && calc(c0, c1 - 1, have ^ 1, turn ^ 1)) return 1;
        return 0;
    }
    else
    {
        if (c0 && calc(c0 - 1, c1, have, turn ^ 1) == 0) return 0;
        if (c1 && calc(c0, c1 - 1, have, turn ^ 1) == 0) return 0;
        return 1;
    }
}
...
void solve()
{
    ...
    if (calc(c0 % 2, c1 % 4, 0, 0)) cout << "WIN\n";
    else cout << "LOSE\n";
}
