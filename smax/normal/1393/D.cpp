...
//        for (int j=0; j<m; j++)
//            for (int k=0; k<26; k++)
//                hpref[i][j][k] = (j > 0 ? hpref[i][j-1][k] : 0) + (grid[i][j] - 'a' == k);
//    for (int j=0; j<m; j++)
//        for (int i=0; i<n; i++)
//            for (int k=0; k<26; k++)
//                vpref[i][j][k] = (i > 0 ? vpref[i-1][j][k] : 0) + (grid[i][j] - 'a' == k);
...
//        for (int i=0; i<n; i++)
//            for (int j=0; j<m; j++)
//                hpref[i][j] = (j > 0 ? hpref[i][j-1] : 0) + (grid[i][j] - 'a' == k);
//        for (int j=0; j<m; j++)
//            for (int i=0; i<n; i++)
//                vpref[i][j] = (i > 0 ? vpref[i-1][j] : 0) + (grid[i][j] - 'a' == k);
