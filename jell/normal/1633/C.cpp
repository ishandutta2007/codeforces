#line 1 "codeforces-workspace\\contest\\1633\\c\\c.cpp"
...
#line 13 "codeforces-workspace\\contest\\1633\\c\\c.cpp"
...
void main() {
  ...
  input hc, dc, hm, dm, k, w, a;
  for (auto x : range(0, k + 1)) {
    if (ceil_div((i64)hm, dc + x * w) <= ceil_div(hc + (k - x) * a, (i64)dm))
      eject("YES");
  }
  print("NO");
}
