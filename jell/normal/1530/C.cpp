#line 1 "codeforces-workspace\\contest\\1530\\c\\c.cpp"
...
#line 16 "codeforces-workspace\\contest\\1530\\c\\c.cpp"
//*/
...
#line 9 "Library\\src\\opt\\golden_section.hpp"
...
#line 33 "codeforces-workspace\\contest\\1530\\c\\c.cpp"
...
void main() {
  ...
  auto pred = [&](auto k) -> bool {
    i64 as = 0, bs = 0;
    vector aa = a, bb = b;
    aa.insert(aa.begin(), k, 100);
    bb.insert(bb.end(), k, 0);
    auto m = n + k;
    for (auto i = 0; i < m - m / 4; ++i) {
      as += aa[i];
      bs += bb[i];
    }
    return bs > as;
