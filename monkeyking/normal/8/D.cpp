...
//    long double x;
//    Double():x(0){}
//    Double(const long double _):x(_){}
//    Double length()const{
//        return (x<0?-x:x);
//    }
...
//Circle oA,oB,oC;
//
//inline bool check(Vector p,Double r)
//{
//	if(p.length()>r) return false;
//	cout.precision(10);cout<<fixed;
//	// cout<<(l0+t0)<<' '<<(r+(p-B).length())<<endl;
//	// cout<<(l1+t1)<<' '<<r+(p-C).length()+(C-B).length()<<endl;
//	// cout<<p.length()<<' '<<r<<endl;
//	return r+(p-B).length()<=l0+t0 && r+(p-C).length()+(C-B).length()<=l1+t1;
//}
//
...
//	Double rm=l0+t0-r;
//	assert(rm>=0);
//	if(l0+t0>rm+r) return false;
//	
//	Vector I=(C.orth()*r);
//	// debug(I);
//	if(check(I,r)) return true;
//	I=B+(C-B).orth()*rm;
//	// debug(I,r);
//	if(check(I,r)) return true;
//
...
//	Vector I1,I2;
//	// cout.precision(10);cout<<fixed;
//	// cout<<((oA.o-oB.o).length())<<' '<<(oA.r+oB.r)<<endl;
//	if(!getCircleIntersection(oA,oB,&I1,&I2)) return false;
//	// debug(I1,I2);
//	// debug(I1,I2);
//	// cout<<check(I1,r)<<endl;
//	// debug(I1,I2);
//	if(check(I1,r) || check(I2,r)) return true;
//	return false;
//}
//
//int main()
...
//	B-=A;C-=A;A=Vector(0,0);
//	// debug(B,C);
//	l0=(B-A).length();
//	l1=(C-B).length()+(C-A).length();
//	Double l=0,r=min(l0+t0,l1+t1),mid,res;
//	// cout<<check(98.0808503787)<<endl;
//	// return 0;
//	while(l<r)
//	{
//		mid=(l+r)/2;
...
//	}
//
//	if(l0+t0>=l1) res=min(l0+t0,l1+t1);
//	cout.precision(10);
//	cout<<fixed;
//	cout<<res<<endl;
//	return 0;
