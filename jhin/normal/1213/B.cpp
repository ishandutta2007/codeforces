    ...
    long long m,x,n,y,z,x1,k,one,gd,x2,y2,w,two,mn=1e9,mid,l,r,pos,a[500003],b[500003];vector<int>v,vr,v2[100003];long long sum,ans,num;char ch;
    ...
    int main()
    {
        ...
        while(t--)
        {
            cin>>n;muls.clear();x=0;mn=1e9;
            for(int i=0;i<n;i++){cin>>a[i];}
            for(int i=n-1;i>=0;i--)
            {
                b[i]=min(mn,a[i]);mn=min(mn,a[i]);
            }
