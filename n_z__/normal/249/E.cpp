...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
    __int128 a,b,c,d;
	cin>>a>>b>>c>>d;
    auto f=[](__int128 x,__int128 y)->__int128{if(x<y)return x*x*(x*x+1)/2+(y-x)*x*(x+1)/2+x*(y*(y-1)*(2*y-1)/6-x*(x-1)*(2*x-1)/6);else return y*y*(y*y+1)/2-(x-y)*y*(y-1)/2+y*(x*(x+1)*(2*x+1)/6-y*(y+1)*(2*y+1)/6);};
    __int128 r=f(c,d)-f(a-1,d)-f(c,b-1)+f(a-1,b-1);
    if(r<p)cout<<(int)(r)<<endl;
    else{r%=p;string s="";while(r>0)s+=(char)((r%10)+'0'),r/=10;while(s.size()<10)s+='0';reverse(s.begin(),s.end());cout<<"..."<<s<<endl;}
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
/*Main-end----------------------------------------------------------------------------------------*/
}
/*Main-end----------------------------------------------------------------------------------------*/
