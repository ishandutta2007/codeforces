...
int main() {
	...
	printf("%d.%s\n", opt.f / 2, opt.f % 2 ? "500000" : "000000");
	while (siz(opt.s) < 3)
		opt.s.PB(1410);
	for (int start : opt.s) {
		int val = 2 * start + opt.f;
		printf("%d.%s ", val / 2, val % 2 ? "500000" : "000000");
	}
	printf("\n");
}