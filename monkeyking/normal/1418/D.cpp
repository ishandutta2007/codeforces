...
//	auto nxt=++++it;
//	it--;
//	deltas.erase(deltas.find(*nxt-*pre));
//	deltas.insert(*nxt-*it);
//	deltas.insert(*it-*pre);
//}
//
...
//	auto nxt=++++it;
//	it--;
//	deltas.insert(*nxt-*pre);
//	deltas.erase(deltas.find(*nxt-*it));
//	deltas.erase(deltas.find(*it-*pre));
//	squ.erase(squ.find(x));
//}
//
//inline ll query()
//{
