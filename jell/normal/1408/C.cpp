#line 1 "codeforces-workspace\\contest\\1408\\c\\c.cpp"
...
#line 6 "codeforces-workspace\\contest\\1408\\c\\c.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace\\contest\\1408\\c\\c.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace\\contest\\1408\\c\\c.cpp"
...
#line 12 "Library\\src\\opt\\bisection.hpp"
...
#line 27 "codeforces-workspace\\contest\\1408\\c\\c.cpp"
...
void main() {
  ...
  auto reach = [&](vector<int> x, double T) -> auto {
    auto nx = x.begin();
    double v = 1;
    double p = 0;
    for (auto &&z : x) {
  ...
  auto pred = [&](double T) -> bool { return L > reach(a, T) + reach(b, T); };
  cout << bisection<double>(0, L, pred, 1e-6) << eol;
}
