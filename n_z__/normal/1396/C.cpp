...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
    int n,r,s,t,d;
    cin>>n>>r>>s>>t>>d;
    int ans1=0,ans2=1145141919810;
    for(int x=1;x<=n;x++)
    {
        int u;
        cin>>u;
        int mi=min(r*(u+2),r+s),tmp=ans1;
        ans1=min({ans1+r*u+t,ans2+mi,ans1+mi+2*d});
        if(x==n)ans1=min(ans1,ans2+r*u+t-d);
        ans2=tmp+mi+2*d;
    }
    cout<<ans1+d*(n-1)<<endl;
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
/*Main-end----------------------------------------------------------------------------------------*/
}
/*Main-end----------------------------------------------------------------------------------------*/
