...
void solve() {
    ...
    if(c == 0) {
        if(d > odd + sum0 - si(g[0])) {
            out("NO");
            return;
        }
    } else if(d == 0) {
        if(c > odd + sum1 - si(g[1])) {
            out("NO");
            return;
        }
    } else {
