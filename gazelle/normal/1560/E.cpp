...
bool simulate(string t, string s, string ord) {
    bool ok = true;
    int t_i = 0;
...
int main() {
    ...
    REP(testcase, t) {
        ...
        REP(i, card) {
            ...
            if(cnt[c - 'a'] % (card - i) != 0) ok = false;
            cnt2[c - 'a'] = cnt[c - 'a'] / (card - i);
        ...
        else if(simulate(t, s, ord)) cout << s << " " << ord << endl;
        else cout << -1 << endl;
    }
