...
//vector<pii> neg;
//
//pll getAngle(pii a, pii b) {
//    ll p = a.first * b.first + a.second * b.second;
//    ll q = norm(a) * norm(b);
//    ll s = sign(p);
//    p *= p;
//    ll g = gcd(p, q);
...
//}
//
//vector<pll> processAngles(vector<pii>& v) {
...
//    vector<pll> res;
//    for (int i = 0; i + 1 < k; ++i) {
//        res.push_back(getAngle(v[i], v[i + 1]));
//    }
//    DBN(res);
//    return res;
//}
//
//vector<long double> processRel(vector<pll>& v) {
...
//        cout << min(pos.size(), neg.size()) << endl;
//        return 0;
//    }
//    processAngles(pos);
//    processAngles(neg);
