...
static ll sz[1005];
static bool f[1005];
static V(ll) ad[100005];
static ll qq[100005][3];
static ll ans[100005];
static ll an=0;
...
void dfs(ll x)
{
    ...
    for(auto it:ad[x])
    {
        if(qq[it][0]==1)
        {
            if((a[qq[it][1]][qq[it][2]]^f[qq[it][1]])==0)
            {
                a[qq[it][1]][qq[it][2]]=(1^f[qq[it][1]]);
                sz[qq[it][1]]++;
                an++;
                dfs(it);
                a[qq[it][1]][qq[it][2]]=f[qq[it][1]];
                sz[qq[it][1]]--;
                an--;
            }
            else
        ...
        {
            if((a[qq[it][1]][qq[it][2]]^f[qq[it][1]])==1)
            {
                a[qq[it][1]][qq[it][2]]=f[qq[it][1]];
                sz[qq[it][1]]--;
                an--;
        ...
        {
            an+=m-2*sz[qq[it][1]];
            sz[qq[it][1]]=m-sz[qq[it][1]];
            f[qq[it][1]]=(1^f[qq[it][1]]);
            dfs(it);
            an+=m-2*sz[qq[it][1]];
            sz[qq[it][1]]=m-sz[qq[it][1]];
            f[qq[it][1]]=(1^f[qq[it][1]]);
