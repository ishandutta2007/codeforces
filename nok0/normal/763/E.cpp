...
#line 4 "/Users/nok0/Documents/Programming/nok0/data_structure/undo_uf.hpp"
...
void main_() {
	...
	graph g(n, m);
	INT(q);
	std::vector<int> lef, rig, order(q);
	REP(i, q) {
		INT(l, r);
		lef.eb(--l);
		rig.eb(r);
	...
	auto reset = [&]() {
		group_cnt = 0;
		uf = rollback_unionfind(n);
		has_ver.assign(n, false);
		history = {};
	};
