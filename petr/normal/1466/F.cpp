  ...
  void solveOne(istream &in, ostream &out) {
    ...
    for (int i = 0; i < n; ++i) {
      ...
      if (k == 1) {
        ...
        if (a != b) {
          if (hasOne[a] && hasOne[b]) {

          } else {
            dims.push_back(i);
            bool nhas = hasOne[a] || hasOne[b];
            a = dsu.merge(a, b);
            hasOne[a] = nhas;
          }
        }
    ...
    atcoder::modint1000000007 res = 2;
    res = res.pow(dims.size());
    out << res.val() << " " << dims.size() << "\n";
    for (int x : dims) {
      out << x + 1 << " ";
    }
    out << "\n";
