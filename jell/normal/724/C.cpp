#line 1 "codeforces-workspace\\contest\\724\\c\\c.cpp"
...
#line 11 "codeforces-workspace\\contest\\724\\c\\c.cpp"
...
#line 35 "codeforces-workspace\\contest\\724\\c\\c.cpp"
...
void main() {
  ...
  input<i64> n, m, k;
  auto g = gcd(n * 2, m * 2);
  auto n2 = n * 2 / g, m2 = m * 2 / g;
  auto [p, q] = ext_gcd(n2, m2);

  while (k--) {
    input<i64> s, t;
    u64 ans = -1;
    for (auto x : {(i64)s, n * 2 - s}) {
      for (auto y : {(i64)t, m * 2 - t}) {
        auto d = y - x;
        if (d % g) continue;
        d /= g;
        d = d * p % m2;
