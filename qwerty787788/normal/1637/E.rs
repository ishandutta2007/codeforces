...
use crate::collections::peek_random::PeekRandom;
...
use crate::misc::sorted_pair::SortedPair;
#[allow(unused)]
...
fn fast(a: &[i64], bad: &HashSet<SortedPair<i64>>) -> i64 {
    let n = a.len();
    ...
    while !pq.is_empty() {
        ...
        pq.remove(&iter);
        let pair = SortedPair::new(by_cnt[iter.cnt1][iter.pos1], by_cnt[iter.cnt2][iter.pos2]);
