...
int f(int a,int p1,int p2,int p3){
  array<int,6> b;
  forn(i,6){
    b[i]=a&1;
    a>>=1;
  ...
  if(p1) reverse(all(b));
  array<int,6> P={0,5,3,2,4,1};
  auto iP=P;
  forn(i,6) iP[P[i]]=i;
  if(p2) P=iP;
  //array<int,6> c={b[0],b[3],b[5],b[2],b[4],b[1]};
  //array<int,6> c={b[0],b[5],b[3],b[1],b[4],b[2]};
  a=0;
  forn(i,6) a=(a<<1)|b[P[p3?(5-i):i]];
  return a;
}
...
int main(int argc, char **argv){
  ...
  /*
  forn(p1,2) forn(p2,2) forn(p3,2) {
    if(f(2,p1,p2,p3)==2 && f(5,p1,p2,p3)==24 && f(35,p1,p2,p3)==50) dbg(p1,p2,p3);
  }
  return 0;//*/
