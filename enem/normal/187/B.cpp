...
int main()
{
    ...
    static const ll N=60;
    static ll n,m,r,ad[N][N][N],dp[2*N][N][N];
    cin>>n>>m>>r;
    REP(i,0,m)
    {
        REP(j,0,n)
        ...
        REP(m,0,n)
        {
            REP(j,0,n)
            {
                REP(k,0,n)
                {
                    ad[i][j][k]=min(ad[i][j][k],ad[i][j][m]+ad[i][m][k]);
                }
            }
        }
    }
    REP(i,0,n)
    {
        REP(j,0,n)
        {
            ...
            REP(k,0,m)
            {
                dp[0][i][j]=min(dp[0][i][j],ad[k][i][j]);
            }
        }
    }
    REP(t,1,2*N)
    {
        ...
        REP(m,0,n)
        {
            REP(j,0,n)
            {
                REP(k,0,n)
                {
                    dp[t][j][k]=min(dp[t][j][k],dp[t-1][j][m]+dp[0][m][k]);
                }
            }
        }
    }
