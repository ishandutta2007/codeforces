...
bool possible(const vector<int>& cnt, int n,int dist){
	...
	// 	for(int k = 0; k < e; ++k){
	// 		auto it = pos.lower_bound(prv + dist);
			
	// 		while(it != pos.end() && (*it) < prv + dist ){
	// 			++it;
	// 		}
