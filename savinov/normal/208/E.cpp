...
void solve(int) {
  ...
  forn(i, m) {
    ...
    int q = v;
    forn(two, 20) if (p & (1 << two)) q = up[two][q];
    Q[q].push_back(mp(i, p));
  }

  for (int r : roots) dfs1(r);
