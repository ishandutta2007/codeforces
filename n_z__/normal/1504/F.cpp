...
int a[400001],f[400001],g[400001];
//222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222//
/*default-var-------------------------------------------------------------------------------------*/
namespace nz{
/*namespace-head----------------------------------------------------------------------------------*/
...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
	...
	for(int x=1;x<=n;x++)
	{
		int y,z;
		cin>>y>>z;
		a[y]=z,a[z]=y,f[y]=f[z]=(y<z);
	}
	int u=2*n+1,v=2*n+1,ans=0;
	for(int x=1,y=1;x<=n;x++)
	{
		if(a[x]>v||a[x]<=n){cout<<-1<<endl;return;}
		if(a[x]<u)u=a[x],g[x]=0;else v=a[x],g[x]=1;
		if(u==2*n-x+1){
			int ans1=0,ans2=0;
			for(;y<=x;y++)
			if(f[y]==g[y])ans1++;else ans2++;
			ans+=min(ans1,ans2);
		}
	}
	cout<<ans<<endl;
