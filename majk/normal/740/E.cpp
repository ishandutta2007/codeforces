...
//            for (int i = 0; i < N; ++i) cout << T.get(i) << ' '; cout << endl;
//            for (int i = 0; i < N; ++i) cout << LL.get(i) << ' '; cout << endl;
//            for (int i = 0; i < N; ++i) cout << RR.get(i) << ' '; cout << endl;
//            for (int i = 0; i < N; ++i) cout << DD.get(i) << ' '; cout << endl;
//
            cout << DD.get(0, N-1) + 1 << '\n';
        }
    }
