...
class C1ErrichTacToeEasyVersion {
public:
                    ...
                    if (a != b) {
                        if (3*(X[a] + O[b]) <= K) {
                            for (int i = 0; i < N; ++i) {
                                for (int j = 0; j < N; ++j) {
                                    int m = (i+j)%3;
                                    if (m == a && P[i][j] == 'X') P[i][j] = 'O';
                                    if (m == b && P[i][j] == 'O') P[i][j] = 'X';
                                }
                            }
                            for (string &p: P) cout << p << '\n';
                            found = true;
                        }
                    }
                }
...
int main() {
	...
	C1ErrichTacToeEasyVersion solver;
