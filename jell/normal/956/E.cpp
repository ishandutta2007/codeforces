#line 1 "codeforces-workspace\\contest\\956\\e\\e.cpp"
...
#line 11 "codeforces-workspace\\contest\\956\\e\\e.cpp"
...
void main() {
  ...
  constexpr auto max_value = 10000;

  input<int> N, L, R;
  bitset<max_value> dp, dp2;
  dp.set(0);
  vector<i32> imp;
  ...
  sort(begin(imp), end(imp));
  auto sum = accumulate(begin(imp), end(imp), 0);
