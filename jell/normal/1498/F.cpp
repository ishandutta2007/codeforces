#line 1 "codeforces-workspace/contest/1498/f/f.cpp"
...
#line 6 "codeforces-workspace/contest/1498/f/f.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace/contest/1498/f/f.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace/contest/1498/f/f.cpp"
...
void main() {
  ...
  auto dp = make_vector<int>({n, k * 2});

  auto dfs1 = fixed_point([&](const auto& dfs, int now, int pre) -> void {
    dp[now][0] = a[now];
  ...
  auto dfs2 = fixed_point(
      [&](const auto& dfs, int now, int pre, vector<int> x) -> void {
        int nim = 0;
        for (auto&& [r, s, t] : enumerate(x, dp[now])) {
          if (r < k) continue;
          nim ^= s;
          nim ^= t;
        }
