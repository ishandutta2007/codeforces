...
int main(){
  ...
  cout<<fixed<<setprecision(0);
	vector<int> re{0,0,1,1,5,1,21,1,85,73,341,89,1365,1,5461,4681,21845,1,87381,1,349525,299593,1398101,178481,5592405,1082401,0};
	// vector<int> re(27);
	// reps(i,1,26){
	// 	int x=(1<<i)-1;
	// 	int mx=0;
	// 	reps(j,1,x) MX(mx,__gcd(x^j,x&j));
	// 	re[i]=mx;
	// 	out(i,x,mx,1);
	// }
	// cout<<re<<endl;
