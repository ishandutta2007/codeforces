...
int main(){
  ...
  while(t--){
    ll n;cin>>n;
    auto g1=readParent<int>(n);
    auto g2=readParent<int>(n);
    auto [in,out]=inout(g2);
    auto comp=[&](int x,int y){return in[x]<in[y];};
