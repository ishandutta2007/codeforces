...
int main()
{
    ...
    int n;
    cin>>n;
    if (n==1) {int l; cin>>l; if (l==0) cout<<"UP"<<endl; else
    if (l==15) cout<<"DOWN"<<endl;
    ...
    if (r==15) cout<<"DOWN"<<endl; else
    if (r==0) cout<<"UP"<<endl; else
    if (l<r) cout<<"UP"<<endl; else cout<<"DOWN"<<endl;
}