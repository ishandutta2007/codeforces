...
// https://github.com/ei1333/library/blob/0698ba3a2169a48966949e1d23b6cbba9e52e03a/math/number-theory/fast-prime-factorization.cpp
...
int pf(int x) {
  return FastPrimeFactorization::prime_factor(x).size();
}
