...
int check(int a[2][2])
{
    if(U - a[0][0] - a[0][1] < 0 || U - a[0][0] - a[0][1] > n - 2) return 0;
    if(R - a[0][1] - a[1][1] < 0 || R - a[0][1] - a[1][1] > n - 2) return 0;
    if(D - a[1][0] - a[1][1] < 0 || D - a[1][0] - a[1][1] > n - 2) return 0;
    if(L - a[0][0] - a[1][0] < 0 || L - a[0][0] - a[1][0] > n - 2) return 0;
    return 1;
}
