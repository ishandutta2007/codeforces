#line 1 "codeforces-workspace\\contest\\1562\\d1\\d1.cpp"
...
#line 16 "codeforces-workspace\\contest\\1562\\d1\\d1.cpp"
//*/
...
#line 33 "codeforces-workspace\\contest\\1562\\d1\\d1.cpp"
...
void main() {
  ...
  while (q--) {
    ...
    if (sum[l] != sum[r]) {
      ...
      auto dif = sum[r] - sum[l];
      if (dif > 0) {  // +1
        ans.emplace_back(*pl[dif / 2 + sum[l]].lower_bound(l));
      } else {  // -1
        ans.emplace_back(*mi[dif / 2 + sum[l]].lower_bound(l));
      }
    }
