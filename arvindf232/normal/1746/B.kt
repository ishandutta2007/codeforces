...
fun main(){
    solve.cases{
        ...
        val ones = IntArray(n){(L[it] == 1).chi
        }
        val zeros = IntArray(n){(L[it] == 0).chi}
        ...
        var atleast = phuge
        for(i in 0..n){
            atleast = minOf(atleast,maxOf(q1.sumQuery(0,i-1), q0.sumQuery(i,n-1)) )
        }
        put(atleast)
