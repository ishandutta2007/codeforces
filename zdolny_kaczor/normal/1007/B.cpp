...
int solve(int a, int b, int c) {
	...
	int size[8] = {};
	int bc = __gcd(b, c), ac = __gcd(a, c), ab = __gcd(a, b);
	int abc = __gcd(bc, a);
	size[7] = divs[abc];
	size[6] = divs[bc] - size[7];
	size[5] = divs[ac] - size[7];
	size[4] = divs[c] - size[5] - size[6] - size[7];
	size[3] = divs[ab] - size[7];
	size[2] = divs[b] - size[3] - size[6] - size[7];
	size[1] = divs[a] - size[3] - size[5] - size[7];
