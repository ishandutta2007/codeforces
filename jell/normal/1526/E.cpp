#line 1 "codeforces-workspace\\contest\\1526\\e\\e.cpp"
...
#line 6 "codeforces-workspace\\contest\\1526\\e\\e.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace\\contest\\1526\\e\\e.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace\\contest\\1526\\e\\e.cpp"
...
#line 28 "codeforces-workspace\\contest\\1526\\e\\e.cpp"
...
void main() {
  ...
  for (auto i : range(1, n)) {
    auto x = s[i - 1], y = s[i];
    if (ap[x + 1] > ap[y + 1]) need += 1;
  }
  mint ans;
  for (auto j : range(k)) {
    ans += binomial<mint>(n - 1 - need, j - need) * binomial<mint>(k, 1 + j);
  }
  cout << ans << "\n";
}
