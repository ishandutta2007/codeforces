...
vector<vector<int>> p = {{1,0,1},{0,1,0},{0,1,1},{1,0,0},{1,1,1},{0,0,0}};
vector<vector<int>> q = {{1,0,1},{0,1,0},{1,1,1},{0,0,0}};
vector<vector<int>> r = {{1,1,1},{0,0,0}};
...
int main(){
    ...
    res = (t+1)*(t+1)*(t+1);
    reverse(all(s));
    auto calc = [&](vector<vector<int>>& a)->mod{
        vv(mod,dp,n+1,8);
        dp[0][0] = 1;
        rep(i,n){
            rep(bits,8){
