#line 1 "codeforces-workspace\\contest\\1240\\d\\d.cpp"
#include <bits/extc++.h>
...
#line 7 "codeforces-workspace\\contest\\1240\\d\\d.cpp"
namespace workspace {
struct solver;
}  // namespace workspace
  ...
  solver() {
    ...
    struct node {
      ...
      node* go(int e) {
        ...
        if (child.count(e)) return child[e];
        auto tmp = new node;
        tmp->parent = this;
        tmp->now = e;
        return child[e] = tmp;
