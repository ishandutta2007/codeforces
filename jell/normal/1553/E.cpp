#line 1 "codeforces-workspace\\contest\\1553\\e\\e.cpp"
...
#line 16 "codeforces-workspace\\contest\\1553\\e\\e.cpp"
//*/
...
#line 33 "codeforces-workspace\\contest\\1553\\e\\e.cpp"
...
void main() {
  ...
  vector<i32> ans;
  for (auto k : range(n)) {
    if (cnt[k] * 3 < m) continue;
    union_find uf(n);
    auto co = 0;
    for (auto i : range(n)) {
      co += uf.unite((i + k) % n, p[i]);
    }
    if (co > m) continue;
    ans.emplace_back((n - k) % n);
  }
