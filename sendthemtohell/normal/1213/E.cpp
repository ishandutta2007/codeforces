...
inline void solve() {
	...
	cin >> b1 >> b2;
	set<string> b = { b1, b2 };
	if (!f(b, "ab") && !f(b, "bc") && !f(b, "ca")) {
		cout << "YES\n";
		for (int i = 0; i < n; ++i) cout << "abc";
		cout << endl;
	} else if (!f(b, "ac") && !f(b, "cb") && !f(b, "ba")) {
		cout << "YES\n";
		for (int i = 0; i < n; ++i) cout << "acb";
		cout << endl;
	} else if (!f(b, "ac") && !f(b, "cb")){
		cout << "YES\n";
		cout << string(n, 'a') << string(n, 'c') << string(n, 'b') << endl;
	} else if (!f(b, "ac")) {
		cout << "YES\n";
		cout << string(n, 'b') << string(n, 'a') << string(n, 'c') << endl;
	} else if (!f(b, "cb")) {
		cout << "YES\n";
		cout << string(n, 'c') << string(n, 'b') << string(n, 'a') << endl;
	} else {
		cout << "YES\n";
		cout << string(n, 'a') << string(n, 'b') << string(n, 'c') << endl;
	}
	// ab bc ca
	// ac cb ba
