...
ld dist3(ld x11,ld y11,ld x22,ld y22)
{
    //cout<<x11<<" "<<y11<<" "<<x22<<" "<<y22<<" "<<" -> "<<dist1(x1,y1,x11,y11)+dist2(x11,y11,x22,y22)+dist1(x22,y22,x2,y2)<<"\n";
    return dist1(x1,y1,x11,y11)+dist2(x11,y11,x22,y22)+dist1(x22,y22,x2,y2);
}
...
signed main()
{
    ...
    if(abs(a)<0.1||abs(b)<0.1)
        halt(dist1(x1,y1,x2,y2));
    cout<<min({dist1(x1,y1,x2,y2),
               dist3(x1,-(a*x1+c)/b,x2,-(a*x2+c)/b),
               dist3(x1,-(a*x1+c)/b,-(b*y2+c)/a,y2),
               dist3(-(b*y1+c)/a,y1,x2,-(a*x2+c)/b),
               dist3(-(b*y1+c)/a,y1,-(b*y2+c)/a,y2)});
