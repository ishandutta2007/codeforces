...
int main() {
    ...
    auto solve_large = [&]() {
        ...
        while (true) {
            ...
            V<int> w;
            for (auto x : la) w.push_back(x);
            for (auto x : lb) w.push_back(x);

            V<int> na, nb;
            if (que(w)) {
                for (int x : la) na.push_back(x);
                for (int x : lb) na.push_back(x);
                for (int x : ra) nb.push_back(x);
            } else {
                for (int x : ra) na.push_back(x);
                for (int x : rb) na.push_back(x);
                for (int x : la) nb.push_back(x);
            }
            a = na;
            b = nb;
        }
