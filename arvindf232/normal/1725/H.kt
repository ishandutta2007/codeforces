...
fun main(){
    solve.cases{
        ...
        put(if(count[0] <= n/2) 0 else 2)
        put(ret.map{it.chi}.joinToString(""))

//        val arr = Array(3){i ->IntArray(3){j -> ((i +j) * (i + j) + i * j) % 3} }
//        just dei arr
