...
struct P {
	int y, m, d;
	bool operator == (const P& r) { return y == r.y && m == r.m && d == r.d; }
	bool operator != (const P& r) { return !(*this == r); }
};
...
void increase_date(P& p) {
	p.d++;
	int mx_date = tbl[p.m - 1];
