...
int main(){
  ...
  ll n,m;cin>>n>>m;
  res=1;
  auto ask=[&](ll h,ll w,ll i1,ll j1,ll i2,ll j2){
    cout<<"?" spa h spa w spa i1+1 spa j1+1 spa i2+1 spa j2+1<<endl;
    ll t;cin>>t;
    return t;
  };
  {
    ...
    for(auto z:mp){
      ...
      rep(i,0,z.se){
        ...
        ll r=1;
        while(r<z.fi){
          if(!ask(min(r,z.fi-r)*k,m,0,0,r*k,0)){
            sw=false;
            break;
          }
          r*=2;
  ...
  }
  {
    ...
    for(auto z:mp){
      ...
      rep(i,0,z.se){
        ...
        ll r=1;
        while(r<z.fi){
          if(!ask(n,min(r,z.fi-r)*k,0,0,0,r*k)){
            sw=false;
            break;
          }
          r*=2;
