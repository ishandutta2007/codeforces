...
ll n, m, k, ans, l, r;
string s;
ll probel, x[1000050], y[1000050], z[1000050];
...
int main()
{
    ...
    forn(i, m)
    {
        ...
        //cout << alpha << " " << betta << " " << gamma << endl;
        if (r - l + 1 < 3 || (alpha >= (r - l + 1) / 3 && betta >= (r - l + 1) / 3 && gamma >= (r - l + 1) / 3 && abs(alpha - betta) <= 1 && abs(alpha - gamma) <= 1 && abs(betta - gamma) <= 1))
        {
            cout << "YES\n";
            continue;
        }
