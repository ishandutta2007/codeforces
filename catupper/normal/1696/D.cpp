...
using maxseg = atcoder::segtree<P, op, e>;
...
int calc(int l, int r){
  if(l == r)return 0;
  int mxpos = mx.prod(l, r+1).second;
  int mnpos = mn.prod(l, r+1).second;
  if(mxpos != l && mxpos != r){
    return calc(l, mxpos) + calc(mxpos, r);
  }
  if(mnpos != l && mnpos != r){
    return calc(l, mnpos) + calc(mnpos, r);
  }
  return 1;
}
