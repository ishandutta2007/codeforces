    ...
    public static class Task implements Runnable {
        ...
        public void solve() {
            ...
            while (t-- > 0) {
                ...
                deque.addFirst(set.pollFirst());

                boolean obey = true;
                if (!set.isEmpty()) {
                    deque.addLast(set.pollLast());
                    obey = obey && obey(deque.getFirst(), deque.getLast());
                }

                while (!set.isEmpty()) {
                    if (obey(deque.getLast(), set.first())) {
                        deque.addLast(set.pollFirst());
                    } else {
                        obey = obey && obey(deque.getFirst(), set.first());
                        deque.addFirst(set.pollFirst());
                    }
                }

                if (!obey) {
                    io.cache.append("No answer").append('\n');
                } else {
                    while (!deque.isEmpty()) {
        ...
        public boolean obey(char a, char b) {
