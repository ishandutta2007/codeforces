...
int main() {
    ...
    loop(t) {
        ...
        input(string, init_color);
        if (*max_element(all(deg)) >= 4) {
            print("White");
            continue;
        }
        if (n < 3) {
        ...
        int wcnt = 0;
        for (char c : init_color) wcnt += c == 'W';
