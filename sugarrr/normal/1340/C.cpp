...
int main(){fastio
    ...
    while(!q.empty()){
        ...
        if(top.pos<=m-2){
            if(top.mod+d[top.pos+1]-d[top.pos]<g){
                ll mo=(top.mod+d[top.pos+1]-d[top.pos]);
                if(chmin(dp[top.pos+1][mo],top.t+d[top.pos+1]-d[top.pos])){
                    q.push({dp[top.pos+1][mo],top.pos+1,mo});
                }
            }else if(top.mod+d[top.pos+1]-d[top.pos]==g){
                ll mo=0;
                if(chmin(dp[top.pos+1][mo],top.t+d[top.pos+1]-d[top.pos])){
                    q.push({dp[top.pos+1][mo],top.pos+1,mo});
                }
        ...
        if(top.pos>=1){
            if(top.mod+d[top.pos]-d[top.pos-1]<g){
                ll mo=(top.mod+d[top.pos]-d[top.pos-1]);
                if(chmin(dp[top.pos-1][mo],top.t+d[top.pos]-d[top.pos-1])){
                    q.push({dp[top.pos-1][mo],top.pos-1,mo});
                }
            }else if(top.mod+d[top.pos]-d[top.pos-1]==g){
                ll mo=0;
                if(chmin(dp[top.pos-1][mo],top.t+d[top.pos]-d[top.pos-1])){
                    q.push({dp[top.pos-1][mo],top.pos-1,mo});
                }
