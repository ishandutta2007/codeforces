...
//	cin>>n>>q;
//	sgt.init(n);
//	for(int i=0;i<n;i++) squ.insert(i);
//	for(int i=0;i<q;i++)
//	{
//		int type;
//		scanf("%d",&type);
...
//			if(x==0)
//			{
//				auto it=squ.lower_bound(l);
//				while(it!=squ.end() && *it<=r) it=squ.erase(it);
//			}
//			else
//			{
//				sgt.update(l,r);
...
//			if(squ.count(pos))
//			{
//				auto it=squ.find(pos);
//				int l=0,r=n-1;
//				if(it!=squ.begin()) l=*prev(it)+1;
//				if(next(it)!=squ.end()) r=*next(it)-1;
//				if(sgt.query(l,n)<=r) puts("YES");
//				else puts("N/A");
//			}
//			else
//			{
