...
//			int r=l+len-1;
//			if(r>=n) break;
//			sum[l][r]=sum[l+1][r]+sum[l][r-1]-sum[l+1][r-1]+w[l][r]+w[r][l];
//		}
//	}
//	for(int i=0;i<n;i++)
//	{
...
//		for(int i=n-1;i>=0;i--)
//		{
//			for(int j=de[l][i+1];j>=de[l-1][i];j--)
//			{
//				if(dp[l-1][j]+sum[j+1][i]<dp[l][i])
//				{
//					dp[l][i]=dp[l-1][j]+sum[j+1][i];
//					de[l][i]=j;
//				}
//			}
//		}
