...
int main()
{
	...
	for (int i=1;i<=7000;++i) bsGET[1][i]=mobius(i);
	for (int i=2;i<=7000;++i) for (int j=i;j<=7000;j+=i) bsGET[i][j]=bsGET[1][j/i];
	for (int i=1;i<=7000;++i) for (int j=i;j<=7000;j+=i) bsSET[j][i]=1;
	cin>>n>>q;
	while (q--)
	{
		int t;
