...
data class pr(val a:Int,val b:Int){}
infix fun Int.join(other:Int):Long{
    return (this.toLong() shl 32) xor other.toLong()
}
...
fun main(){
    solve.cases{
        ...
        val id = HashMap<List<Int>,Int>(400005)
        val store = HashMap<Long,Int>(200000/3 * 4)

        fun checkid(a:List<Int>):Int {
            val get = id[a]
            if(get == null){
                id[a] = id.size
                return id.size -1
        ...
        fun dfs(a:Int,p:Int):Int {
            val get = store[ a join p ]
            if(get != null) {
                return get
            }
