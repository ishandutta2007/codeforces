...
void solve(){
	int n1,n2,n3; cin>>n1>>n2>>n3; string x="",y="",z="";
	for(int i=0;i<=n1;i++)x+='0';
	for(int i=1;i<n2;i++)y+=(char)(((n2-i)&1)+'0');
	for(int i=0;i<=n3;i++)z+='1';
	if(!n1&&!n2)cout<<z<<endl;
	else if(!n2&&!n3)cout<<x<<endl;
