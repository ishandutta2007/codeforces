...
public:
    void solve() {
        ...
        for (int i : range(1, first.size())) {
            if (secCol[i]) {
                maxim(answer, first[i] + second[i], firstLen, i, secLen, i, isSecondFirst, false, isFirstFirst, true);
            }
            if (i > 1) {
                if (firstCol[i - 1] != firstCol[i]) {
                    maxim(answer, first[i] + first[i - 1], firstLen, i, secLen, i - 1, isSecondFirst, true,
                          isFirstFirst, true);
                } else {
                    if (secCol[i - 1]) {
                        maxim(answer, first[i] + second[i - 1], firstLen, i, secLen, i - 1, isSecondFirst, false,
                              isFirstFirst, true);
                    }
//                    if (secCol[i]) {
//                        maxim(answer, second[i] + first[i - 1], firstLen, i, secLen, i - 1, isSecondFirst, true,
//                              isFirstFirst, false);
//                    }
                }
            }
