...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
    ...
    cin>>n;
    init(2*n);
    int wb=1,bw=1,c=0,q=0;
    for(int x=1;x<=n;x++)
    {
        cin>>s[x];
		if(s[x][0]=='W'||s[x][1]=='B')bw=0;
		if(s[x][0]=='B'||s[x][1]=='W')wb=0;
        for(int y=0;y<2;y++)c+=(s[x][y]=='B'),q+=(s[x][y]=='?');
    }
    int ans=(bw+wb+C(q,n-c))%p,r=1;
	for(int x=1;x<=n;x++)
	r=r*((s[x][0]!='B'&&s[x][1]!='W')+(s[x][0]!='W'&&s[x][1]!='B'))%p;
    cout<<((ans-r)%p+p)%p<<endl;
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
/*Main-end----------------------------------------------------------------------------------------*/
}
/*Main-end----------------------------------------------------------------------------------------*/
