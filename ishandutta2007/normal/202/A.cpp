...
void solve(){
  ...
  //     cout<<ch<<" "<<prevlast<<endl;
//       cout<<endl<<(int)(pos[ch-'a'].end()-pos[ch-'a'].begin())<<endl;
  //     cout<<(int)(upper_bound(pos[ch-'a'].begin(),pos[ch-'a'].end(),prevlast)-pos[ch-'a'].begin())<<endl;
       int v=(int)(pos[ch-'a'].end()-upper_bound(pos[ch-'a'].begin(),pos[ch-'a'].end(),prevlast));
//       2-(2-0)
//cout<<v<<endl<<endl;
       int flag=0;
       for(int i=0;i<v;i++){
       ...
       if(flag==1)break;
       if(pos[ch-'a'].size()>0 &&v>0)
          prevlast=pos[ch-'a'][pos[ch-'a'].size()-1];
//       cout<<endl;
     }
}
int main(){read();solve();}