...
#include<C:/Programs/mingw-w64-7/lib/gcc/i686-w64-mingw32/7.3.0/include/c++/i686-w64-mingw32/bits/stdc++.h>
...
void dfs2(int x) {
	auto it = left.find_by_order(c[x]);
	ans[x] = *it;
	left.erase(it);
	for (int v : graf[x]) {
		dfs2(v);
