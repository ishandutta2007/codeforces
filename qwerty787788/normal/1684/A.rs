pub mod solution {
//{"name":"A.  ","group":"Codeforces - Codeforces Round #792 (Div. 1 + Div. 2)","url":"https://codeforces.com/contest/1684/problem/0","interactive":false,"timeLimit":1000,"tests":[{"input":"3\n12\n132\n487456398\n","output":"2\n1\n3\n"}],"testType":"multiNumber","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null},"languages":{"java":{"taskClass":"AMnogoTsifr"}}}
...
fn solve(input: &mut Input, _test_case: usize) {
    ...
    if s.len() == 2 {
        out_line!(vec2str(&s[1..2]));
    } else {
        out_line!(vec2str(&vec![*smallest]));
    }
}
