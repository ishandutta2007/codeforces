#line 1 "codeforces-workspace/contest/1516/c/c.cpp"
...
#endif
#line 8 "codeforces-workspace/contest/1516/c/c.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace/contest/1516/c/c.cpp"
...
void main() {
  ...
  while (1) {
    assert(~sum & 1);
    auto it = find_if(begin(a), end(a), [](auto x) { return x & 1; });
    if (it != end(a)) {
      cout << "1\n" << it - begin(a) + 1 << "\n";
      return;
    }
