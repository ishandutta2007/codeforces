...
public:
    void solve(istream& cin, ostream& cout) {
        ...
        int leading = 0;
        while (S[leading] == '0') leading++;
        int trailing = 0;
        while (S[N-1-trailing] == '0') trailing++;

        FieldMod ans = 1;
        string T = S.substr(leading, N-leading-trailing);
        vector<FieldMod> Used(N, 0);
        N = T.size();
        int i = 0;
        while (i < N-1) {
            int j = i+1;
