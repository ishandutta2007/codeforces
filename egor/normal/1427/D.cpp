...
public:
    void solve() {
        ...
        while (true) {
            ...
            for (int i : range(q[d], q[d - 1])) {
                if (c[i] + 1 != c[i + 1]) {
                    cur.push_back(i - q[d] + 1);
                    cur.push_back(q[d - 1] - i);
                    if (q[d - 1] != n - 1) {
                        cur.push_back(n - 1 - q[d - 1]);
                    }
                    break;
                }
            }
