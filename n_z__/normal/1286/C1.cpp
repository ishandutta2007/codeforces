...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
	...
	s.resize(n+1);
	if(n<=3){
		for(int x=1;x<=n;x++)ask(x,x,a),s[x]=a[1]-=s[x-1];
		cout<<"! "<<s.substr(1);
		return;
	}
	ask(1,(n+1)/2,a);
	ask(2,(n+1)/2,b);
	ask(1,n,c);
	for(int x=1;x<=(n+1)/2;x++) s[x]=(a[x]-=b[x])-a[x-1];
	for(int x=n/2,y=s[n/2+1];x;x--){
		s[n-x+1]=c[x]-c[x-1]-y-s[x];
		y=c[x]-c[x-1];
	}
	cout<<"! "<<s.substr(1);
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
