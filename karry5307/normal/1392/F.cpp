...
const ll MAXN=2e6+51,MOD=998244353,inf=0x3f3f3f3f;
// Structures and variables
#define ll long long
ll n,sum,zkdxl,akdxl,dxl;
ll h[MAXN];
// Fast IO
inline ll read()
{
...
int main()
{
	...
	zkdxl=2*sum/n,akdxl=(zkdxl-n+1)/2,dxl=sum-(n*(akdxl*2+n-1)/2);
	for(register int i=1;i<=n;i++)
	{
		printf("%lld ",akdxl-(i>dxl)+i);
	}
}