...
S op(S l, S r) {
	...
	ans.b = l.b + r.b;
	ans.c = l.c + r.c;
	ans.ab = min({ l.a + r.b, l.ab + r.b, l.a + r.ab });
	ans.bc = min({ l.b + r.c, l.bc + r.c, l.b + r.bc });
	ans.ac = min({ l.a + r.c, l.ab + r.c, l.ac + r.c, l.a + r.bc, l.ab + r.bc, l.a + r.ac });
	return ans;
}
...
int main() {
	...
	while (q--) {
		int idx; char c; R(idx, c); idx--;
		st.set(idx, sv[c - 'a']);
		W(op(st.all_prod(), e()).ac);
	}
