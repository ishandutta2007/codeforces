    ...
    long long m,x,n,y,z,x1,k,one,gd,x2,y2,two,mn=1e9,mid,l,r,pos,a[500003],b[500003],c[500000],c2[500000];string s2;vector<long long>v,vr,v2[100003];long long sum,ans,num;char ch;
    ...
    int old=0;long long page=(a[0]-1)/k+1;
    for(int i=0;i<m;i++)
    {
        cnt++;
        if(i!=m-1){if(a[i+1]-old>page*k){old=cnt;ans++;page=((a[i+1]-old-1)/k)+1;}}
        else ans++;
        //cout<<page<<" "<<old<<endl;
