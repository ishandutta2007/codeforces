...
//		val n = getint
        ...
        repeat(str.size){
            if(S.containsKey(now-1) && (S.st[now-1]!! >= 2 || (S.st[now-1]!! == 1 && S.st.ceilingKey(now) == null))){
                now --
                S.removeone(now)
                ret.add('0')
            }else{
...
//            S.removeone(0)
//            repeat(n){
//                if(S.containsKey(bnow - 1 )){
//                    bnow --
//                    ret.add(bnow)
//                    S.removeone(bnow)
//                }else{
//                    assert(S.containsKey(bnow + 1))
//                    bnow++
//                    ret.add(bnow)
//                    S.removeone(bnow)
//                }
...
//        }
//        val n = str.size
//        val can = tempIntervalSum(n)
//
//        val last = mutableMapOf<Int,Int>()
//        last[0] = 0
//        var balance = 0
//        for(i in 0 until n){
//            balance += if(str[i] == '1') 1 else -1
//            if(balance in last){
//                val cut1 = last[balance] !!
//                val cut2 = i + 1
//                can.add(cut1,cut2 - 1, 1)
//            }
//            last[balance] = i+1
//        }
//        val comp = can.compile()
//
//        var l = 0
...
//            }
//            if(r != l ){
//                retstr.add(solve(str.slice(l until r)))
//            }
//            if(r < n)
//            retstr.add(str.slice(r..r))
//            l = r + 1
//        }
//        put(retstr.joinToString(""))
