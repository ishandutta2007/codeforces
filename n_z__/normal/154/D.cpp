...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
	int p,q,a,b;
    cin>>p>>q>>a>>b;
    if(p+a<=q&&p+b>=q)cout<<"FIRST"<<endl<<q<<endl;
    else if(a+b==0||((p>q)^(-a>b))||a<1&&b>=0)cout<<"DRAW"<<endl;
    else if((q-p)%(b+a)==0)cout<<"SECOND"<<endl;
	else if((q-p)%(b+a)>=a&&(q-p)%(b+a)<=b)cout<<"FIRST"<<endl<<p+(q-p)%(b+a)<<endl;
    else cout<<"DRAW"<<endl;
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
/*Main-end----------------------------------------------------------------------------------------*/
}
