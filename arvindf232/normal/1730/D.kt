...
fun main(){
    solve.cases{
        ...
        val S = mutableSetOf<Pair<Char,Char>>()
        for(i in 0 until n){
            val a = A[i]
            val b = B[i]
//            if(a == b) continue
        ...
        if(S.any { it.first != it.second }){
            put("NO")
            return@cases
        }
        put(if(S.size == n % 2) "YES" else "NO")
...
//                }
//            }
//            if(A[i] == B[i] && A[other] == B[other]){
//                continue
//            }else if(A[i] == A[other] && B[i] == B[other]){
//                continue
//            }
//            put("NO")
//            return@cases
