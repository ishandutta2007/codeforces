...
{
	cin>>n;
	isfib[1]=isfib[2]=isfib[3]=isfib[5]=isfib[8]=isfib[13]=isfib[21]=isfib[34]
	=isfib[55]=isfib[89]=isfib[144]=isfib[233]=isfib[377]=isfib[610]=isfib[987]=1;
	for(int i=1;i<=n;i++)if(isfib[i])cout<<'O';else cout<<'o';
	cout<<endl;
	return 0;
}