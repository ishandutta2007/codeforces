...
int main(){
    ...
    rep(zz,T){
        ...
        sort(all(p));
        INT(a,b);
        if(p[0]==MP(1,1)&&p[1]==MP(1,2)&&p[2]==MP(2,1)){
            if(a==1||b==1){
                cout << "YES\n";
            }else{
                cout << "NO\n";
            }
        }else if(p[0]==MP(1,n-1)&&p[1]==MP(1,n)&&p[2]==MP(2,n)){
            if(a==1||b==n){
                cout << "YES\n";
            }else{
                cout << "NO\n";
            }
        }else if(p[0]==MP(n-1,1)&&p[1]==MP(n,1)&&p[2]==MP(n,2)){
            if(a==n||b==1){
                cout << "YES\n";
            }else{
                cout << "NO\n";
            }
        }else if(p[0]==MP(n-1,n)&&p[1]==MP(n,n-1)&&p[2]==MP(n,n)){
            if(a==n||b==n){
                cout << "YES\n";
            }else{
                cout << "NO\n";
            }
        }else if(flag[a%2][b%2]){
            cout << "YES\n";
        }else{
            cout << "NO\n";
        }
