    ...
    int m,x,n,y,z,x1,k,one,gd,x2,y2,two,mn=1e9,mid,l,r,pos,a[5000003],b[5000003];vector<int>v,vr,v2[100003];long long sum,ans,num;char ch;
...
int BIT[1000001],BIT2[1000001],pref[1000001],suf[1000001];
void update(int x)
{
    for(; x <= n; x += x&-x)
       {
