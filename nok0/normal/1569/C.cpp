...
#line 3 "/Users/nok0/Documents/Programming/nok0/math/factorial.hpp"

#line 5 "/Users/nok0/Documents/Programming/nok0/math/factorial.hpp"
...
void main_() {
	...
	if(c >= 2) {
		...
		if(d == 0) {
			...
			mint res = fac.fac[n] * fac.finv[c + d] * (fac.fac[d + 1] - fac.fac[d]);
			print(res);
		}
	}
}