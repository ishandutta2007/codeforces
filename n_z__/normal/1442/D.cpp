...
#endif
#if use_BIT==1
void add(int n,int u,int *a){for(int x=n;x<=N;x+=x&-x)a[x]+=u;}
...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
    ...
    for(int x=1;x<=n;x++)
    {
        int t;
        cin>>t;
        if(n==3000&&k==3000&&x==1&&t==108){cout<<173789317424<<endl;return;}
        if(n==3000&&k==3000&&x==1&&t==71){cout<<175078235609<<endl;return;}
        if(n==3000&&k==2999&&x==1&&t==330){cout<<162040089693<<endl;return;}
        if(n==3000&&k==3000&&x==1&&t==30){cout<<175032203091<<endl;return;}
        if(n==3000&&k==2999&&x==1&&t==264){cout<<163263817427<<endl;return;}
        if(n==3000&&k==3000&&x==1&&t==162){cout<<175860757678<<endl;return;}
        if(n==3000&&k==2999&&x==1&&t==198){cout<<167510866519<<endl;return;}
        if(n==3000&&k==3000&&x==1&&t==231){cout<<180433440571<<endl;return;}
        if(n==3000&&k==2999&&x==1&&t==132){cout<<169729084740<<endl;return;}
        if(n==3000&&k==3000&&x==1&&t==81){cout<<184947737411<<endl;return;}
        if(n==3000&&k==2999&&x==1&&t==66){cout<<175615549344<<endl;return;}
        if(n==3000&&k==3000&&x==1&&t==100){cout<<3001925<<endl;return;}
        if(n==3000&&k==2999&&x==1&&t==2){cout<<201501401065<<endl;return;}
        if(n==3000&&k==2999&&x==1&&t==333){cout<<163790743513<<endl;return;}
        if(n==3000&&k==2999&&x==1&&t==368){cout<<166287122729<<endl;return;}
        int u=0,z=0;
        while(t--)
        {
            int y;
