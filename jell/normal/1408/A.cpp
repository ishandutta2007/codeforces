#line 1 "codeforces-workspace\\contest\\1408\\a\\a.cpp"
...
#line 6 "codeforces-workspace\\contest\\1408\\a\\a.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace\\contest\\1408\\a\\a.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace\\contest\\1408\\a\\a.cpp"
...
void main() {
  ...
  for (auto &&x : {a.back(), b.back(), c.back()}) {
    if (x == ans.front()) continue;
    if (x == ans.back()) continue;
    ans.emplace_back(x);
    break;
  }
  assert(ans.front() != ans.back());
  assert(adjacent_find(begin(ans), end(ans)) == ans.end());
  cout << ans << "\n";
}
