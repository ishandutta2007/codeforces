...
#line 2 "/home/maspy/library/algebra/linearrecurrence.hpp"

#line 2 "/home/maspy/library/algebra/convolution.hpp"
...
#line 4 "/home/maspy/library/algebra/linearrecurrence.hpp"
...
void solve() {
  ...
  A[0] = 1;
  A[1] = 2;
  FOR3(i, 2, L) A[i] = A[i - 1] + A[i - 2];
  FOR(i, L) A[i] *= mint(i + 1).pow(K);

  vc<mint> B(L);
  FOR(i, L - 1) B[i + 1] = B[i] + A[i];

  mint ANS = interpolate_linear_recurrence(B, N);
  print(ANS);
}
