...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
    int n,l,r;
    cin>>n>>l>>r;
    int ans=min(1-l,r-n)*C(n,n/2)*((n&1)+1);
	for(int x=min(1-l,r-n)+1;x<=min(1-l,r-n)+n;x++)
	{
		int u=n-min(n,r-x),v=max(0,l+x-1);
        ans+=C(n-u-v,n/2-u)+(n&1)*C(n-u-v,n/2+1-u);
	}
	cout<<ans%p<<endl;
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
/*Main-end----------------------------------------------------------------------------------------*/
