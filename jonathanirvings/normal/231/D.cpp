...
int main()
{
	scanf("%d %d %d",&a,&b,&c);
	scanf("%d %d %d",&d,&e,&f);
	REPN(k,6) scanf("%d",&an[k]);
	risan = 0;
	if (a < 0) risan += an[5];//printf("%d\n",risan);
	if (a > d) risan += an[6];//printf("%d\n",risan);
	if (b < 0) risan += an[1];//printf("%d\n",risan);
	if (b > e) risan += an[2];//printf("%d\n",risan);
	if (c < 0) risan += an[3];//printf("%d\n",risan);
	if (c > f) risan += an[4];
	printf("%d\n",risan);
