// time-limit: 1000
// problem-url: https://codeforces.com/contest/1684/problem/B
#if not LOCAL
#define NDEBUG 1
#endif
#include<bits/stdc++.h>
...
void up(){
	int64_t const a=read<int64_t>();
	int64_t const b=read<int64_t>();
	int64_t const c=read<int64_t>();

	auto const x=a+((c-a)/b+1)*b;
	auto const y=b;
	auto const z=c;
