...
int fin(int l, int r){
	...
	if(l < 0 || r >= n)return MOD;
	if(dp[l][r] != -1)return dp[l][r];
	if(l && v[l] == v[l-1])return dp[l][r] = fin(l-1,r);
	if(r != n-1 && v[r] == v[r+1])return dp[l][r] = fin(l,r+1);
	if(l && r != n-1 && v[l-1] == v[r+1])return dp[l][r] = fin(l-1,r+1)+1;
	return dp[l][r] = min(fin(l-1,r),fin(l,r+1))+1;
}
