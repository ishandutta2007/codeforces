		...
		REP(j, M + 1) {
			REP(k, M + 1) {
				REP(l, M + 1) {
					...
					st[i + j + k + l].insert(i + j * 5 + k * 10 + l * 50);
				}
			}
		}
	}
...
void main_() {
	const vector<ll> a = {4, 10, 20, 35, 56, 83, 116, 155, 198, 244, 292, 341, 390, 439, 488, 537, 586, 635, 684, 733, 782, 831, 880, 929, 978, 1027, 1076, 1125, 1174, 1223};
	bostan_mori_ll bm(a);
	INT(n);
	print(bm.kth_term(--n));
}