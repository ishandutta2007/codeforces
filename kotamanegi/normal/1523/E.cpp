//line 1 "Contests/Codeforces_1523/E/main.cpp"
using namespace std;
...
#endif
//line 3 "Contests/Codeforces_1523/E/main.cpp"
...
//line 7 "Contests/Codeforces_1523/E/main.cpp"
...
mint comb(int a, int b) {
    return mae[a] * gyaku[a - b] * gyaku[b];
}
void init() {
    if (mae[0].val() == 1) return;
    mae[0] = 1;
    gyaku[0] = 1;
    for (int i = 1; i < 300000; ++i) {
        mae[i] = mae[i - 1] * i;
        gyaku[i] = mint(1) / mae[i];
    }
    return;
}
void solve() {
    ...
    for (int i = 2; i <= n; ++i) {
        prob[i] = 0;
        int remaining_white = n - i;
        remaining_white -= (i - 1) * (k - 1);
        if (remaining_white < 0) {
            prob[i] = 0;
            continue;
        }
        prob[i] = comb(remaining_white + i, i);
        prob[i] /= comb(n, i);
    }
    mint ans = 0;
    for (int i = 0; i <= n; ++i) {
