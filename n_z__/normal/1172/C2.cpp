...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
    ...
    for(int x=1;x<=n;x++)
    cin>>w[x],s[a[x]]+=w[x];
    int f[m+10][m+10],g[m+10][m+10];
    me(f,0);
    me(g,0);
    for(int x=0;x<=m;x++)
    f[x][m-x]=g[x][m-x]=1;
    for(int x=m;x>=0;x--)
    for(int y=min(s[0],m-x-1);y>=0;y--)
    {
        int q=qp(s[0]+s[1]+x-y);
        f[x][y]=(f[x+1][y]*(s[1]+x+1)%p+f[x][y+1]*(s[0]-y)%p)%p*q%p;
        g[x][y]=(g[x+1][y]*(s[1]+x)%p+g[x][y+1]*(s[0]-y-1)%p)%p*q%p;
    }
    for(int x=1;x<=n;x++)
    if(a[x])cout<<w[x]*f[0][0]%p<<endl;else cout<<w[x]*g[0][0]%p<<endl;
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
/*Main-end----------------------------------------------------------------------------------------*/
}
/*Main-end----------------------------------------------------------------------------------------*/
