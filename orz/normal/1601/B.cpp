...
bool try_kuhn(int v, const int n, const int k, const vector<vector<int>>& g, vector<int>& mt, vector<bool>& used) {
...
int max_par(const int n, const int k, const vector<vector<int>>& g)
{
	int siz = 0;
	vector<int> mt;
	vector<bool> used;
