#include <bits/stdc++.h>
        ...
        long long m,n,x,y,z,k,mn=3e9,mx,ans,b[500003],c[500003];vector<long long>v;char ch;
        ...
        while(t--)
        {
                ...
                for(int j=0;j<m;j++)
            {
                ...
                {
                    if(a[i][j]>2)yes=false;
                    else a[i][j]=2;
                }
                else if(i==0||i==n-1)
                {
                    if(a[i][j]>3)yes=false;
                    else a[i][j]=3;
                }
                else if(j==0||j==m-1)
                {
