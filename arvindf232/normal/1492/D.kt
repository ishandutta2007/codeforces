...
fun main(){
    solve.cases{
        ...
        if(b == 1 || a == 0){
            if(k == 0){
                val str = listOf(1) + List(a){0} + List(b-1){1}
                val s = str.joinToString("")
                put("YES")
                put(s)
                put(s)
                return@cases
            ...
            if(k > max){
                ...
                put("YES")
                put(left.joinToString(""))
                put(right.joinToString(""))
            }
        }
...
/*
read input is so improant
(otherwise legacy spgahtetti)
 */