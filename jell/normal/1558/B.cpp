#line 1 "codeforces-workspace\\contest\\1558\\b\\b.cpp"
...
#line 16 "codeforces-workspace\\contest\\1558\\b\\b.cpp"
//*/
...
#line 33 "codeforces-workspace\\contest\\1558\\b\\b.cpp"
...
void main() {
  ...
  for (auto i : range(1, n + 1)) {
    ...
    sum += dp;
    for (auto k : range(2, n / i + 1)) {
      add[k * i] += dp;
      if (k * (i + 1) <= n) add[k * (i + 1)] -= dp;
    }
  }
  cout << dp << "\n";
}
