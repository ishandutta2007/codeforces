...
inline void solve() {
    ...
    while (t--) {
        ...
        for (int i = n; i > 1; i -= 2) {
            int pi = find(v.begin(), v.begin() + i, i) - v.begin();
            ans.push_back(pi + 1);
            reverse(v.begin(), v.begin() + pi + 1);

            int pii = find(v.begin(), v.begin() + i, i - 1) - v.begin();
            ans.push_back(pii);
            reverse(v.begin(), v.begin() + pii);
            assert(v[pii] == i - 1 && v[pii - 1] == i);

            reverse(v.begin(), v.begin() + i);
            ans.push_back(i);

            pi = find(v.begin(), v.begin() + i, i) - v.begin();
            assert(v[pi] == i && v[pi - 1] == i - 1);
