#line 1 "codeforces-workspace/contest/1466/f/f.cpp"
/**
 * @file template.cpp
 * @brief Template
 */
...
#line 16 "codeforces-workspace/contest/1466/f/f.cpp"
...
#line 33 "codeforces-workspace/contest/1466/f/f.cpp"
...
void main() {
  ...
  for (auto i = 0; i < n; ++i) {
    ...
    if (k == 2) {
      ...
      if (sgl[x] && sgl[y]) continue;
      if (uf.unite(x, y)) {
        sgl[uf.find(x)] = sgl[x] || sgl[y];
  ...
  cout << mint(2).pow(size(ans)) << " " << size(ans) << eol;
  cout << ans << eol;
}
