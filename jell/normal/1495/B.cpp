#line 1 "codeforces-workspace/contest/1495/b/b.cpp"
...
#line 11 "codeforces-workspace/contest/1495/b/b.cpp"
...
void main() {
  ...
  for (int i = 1; i < n; ++i) {
    if (p[i] > p[i - 1]) asc[i] = asc[i - 1] + 1;
  }

  for (int i = n - 2; i >= 0; i--) {
    if (p[i] > p[i + 1]) dsc[i] = dsc[i + 1] + 1;
  }
