#line 1 "codeforces-workspace\\contest\\1527\\e\\e.cpp"
...
#line 6 "codeforces-workspace\\contest\\1527\\e\\e.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace\\contest\\1527\\e\\e.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace\\contest\\1527\\e\\e.cpp"
...
#line 27 "codeforces-workspace\\contest\\1527\\e\\e.cpp"
...
void main() {
  ...
  vector segs(k + 1, lazy_segment_tree<mono, endo>(n + 1));
  segs[0][0] = {0};
  // for (auto &s : segs) {
  //   for (auto &x : s) {
  //     x = {0};
  ...
  for (auto &&[i, e] : enumerate(a)) {
    for (auto &s : segs) {
      s.update(pos[e], n, endo{pos[e] - i64(i + 1)});
    }
    ...
    for (auto j : rrange(k)) {
      mono nx = {segs[j].fold(0, i + 1).v};
      segs[j + 1][i + 1] = nx;
    }
  }

  cout << segs[k][n].v + sum << eol;
}
