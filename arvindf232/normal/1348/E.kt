...
fun main(){
    solve.cases{
        ...
        for(i in 0 until k){
            ...
            assert(typeA >= i)
            val rightremain = (sum - i)  % k
            val got = (sum - rightremain - i) / k
            max = maxOf(got, max )
        }
...
/*
destroyu 1 can possibly fill 2


submission is 25 mintues
 */