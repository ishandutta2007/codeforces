...
int main()
{
    ...
    REP(tc,1,ntc+1)
    {
        ...
        int n, m;
        cin>>n>>m;
        static int dp[410][410][3], tp[410][410][3];
        REP(t1,0,n+5)
        {
            REP(t2,0,n+5)
            {
        ...
        REP(ptr1, 1, n)
        {
            REP(t1,0,n+5)
            {
                REP(t2,0,n+5)
                {
                    REP(t3,0,3)
                    {
                        if(t2>0) tp[t1][t2][t3]=(tp[t1][t2-1][t3]+dp[t1][t2][t3])%m;
                        else tp[t1][t2][t3] = dp[t1][t2][t3];
                        dp[t1][t2][t3]=0;
                    }
                }
            }
            REP(t1,0,n+5)
            {
                REP(t2,0,n+5)
                {
                    REP(t3,0,3)
                    {
                        if(t3==0)
                        {
                            dp[t1+1][0][1] += tp[t1][t2][t3];
                            dp[t1+1][0][1] %= m;
                            dp[t1+1][t1+1][1] += m-tp[t1][t2][t3];
                            dp[t1+1][t1+1][1] %= m;
                        }
                        else if(t3==1)
                        {
                            dp[t1][0][0] += tp[t1][t2][t3];
                            dp[t1][0][0] %= m;
                            dp[t1][1][0] += m-tp[t1][t2][t3];
                            dp[t1][1][0] %= m;
                            dp[t1+1][0][1] += tp[t1][t2][t3];
                            dp[t1+1][0][1] %= m;
                            dp[t1+1][t2+1][1] += m-tp[t1][t2][t3];
                            dp[t1+1][t2+1][1] %= m;
                            dp[t1+1][t2+1][2] += tp[t1][t2][t3];
                            dp[t1+1][t2+1][2] %= m;
                            dp[t1+1][t1+1][2] += m-tp[t1][t2][t3];
                            dp[t1+1][t1+1][2] %= m;
                        }
                        else
                        {
