        ...
        int m,x,n,y,z,x1,k,one,gd,x2,y2,two,mn=1e9,mid,l,r,pos;vector<int>v,vr,v2[100003];long long sum,ans,num;char ch;
    ...
    int a[500001],b[500001];char chess[100][100]={'b'};
        ...
        int main()
        {
         ...
         while(t--)
         {
             cin>>x>>y>>z;
             mn=min(x,y);
             if(z>=mn)cout<<mn<<endl;
             else cout<<min(mn,(x+y+z)/3)<<endl;
