...
void solve() {
  ...
  FOR_R(L, N + 1) FOR(R, L, N + 1) {
    ...
    ll x00 = 0, x01 = 0, x10 = 0, x11 = 0;
    x00 = DP[L + 2][R];
    if (x00 == 0 && S[L] < S[L + 1]) x00 = 1;
    if (x00 == 0 && S[L] > S[L + 1]) x00 = -1;

    x01 = DP[L + 1][R - 1];
    if (x01 == 0 && S[L] < S[R - 1]) x01 = 1;
    if (x01 == 0 && S[L] > S[R - 1]) x01 = -1;

    x10 = DP[L + 1][R - 1];
    if (x10 == 0 && S[R - 1] < S[L]) x10 = 1;
    if (x10 == 0 && S[R - 1] > S[L]) x10 = -1;

    x11 = DP[L][R - 2];
    if (x11 == 0 && S[R - 1] < S[R - 2]) x11 = 1;
    if (x11 == 0 && S[R - 1] > S[R - 2]) x11 = -1;
  ...
  if (N % 2 == 0) { return out(DP[0][N]); }
  // 
  ll x = -1;
  if (DP[1][N] <= -1 || DP[0][N - 1] <= -1) x = 1;
  out(x);
}
