...
//    println(ans)
    ...
    for(i in 1..n){
        ...
        //change sweet_pos, new_sweets
        
        
        
        sweets.removeAt(sweet_pos)
        
        sweet_pos = sweet_pos % sweets.size
        
        for(i in 1..k-1){
            sweet_pos = (sweet_pos+1) % sweets.size
        }
    }
