...
struct SegmentTree{
    virtual T f(const T& a, const T& b) const {
        if(!a.checkpoint && !b.checkpoint) return {false, a.a * b.a, a.b * b.a + b.b, 0_M, 0_M};
        if(!a.checkpoint) return {true, a.a * b.a, a.b * b.a + b.b, b.c, b.d};
        if(!b.checkpoint) return {true, a.a, a.b, a.c, a.d * b.a + b.b};
        return {true, a.a, a.b, a.c + a.d * b.a + b.b + b.c, b.d};
    }
    const T def_value;
...
int main(){
    ...
    vec(T,a,n);
    auto t=[&](ll i)->T{
        if(Q[i])return{true,1_M,0_M,0_M,P[i]};
        else return{false,P[i],P[i],0_M,0_M};
    };
    rep(n)a[i]=t(i);
    SegmentTree seg(a,{false,1_M,0_M,0_M,0_M});
    rep(_,q){
        LL(i);
        i--;
        Q[i]=!Q[i];
        seg.set(i,t(i));
        const T x=seg.data[1];
        out(x.b+x.c+x.d);
    }
}