...
int main(int argn, char **argv) {
    ...
    REP(I, T) {
        ...
        int l0 = 0, l1 = 0, r0 = n-1, r1 = n-1;
        while (l0 < n && str[l0] != '0') l0++;
        while (l1 < n && str[l1] != '1') l1++;
        while (r0 >=0 && str[r0] != '0') r0--;
        while (r1 >=0 && str[r1] != '1') r1--;
        ...
        REP(i, q) {
            ...
            bool exist = false;
            if (str[l] == '0' && l0 < l) exist = true;
            if (str[l] == '1' && l1 < l) exist = true;
            if (str[r] == '0' && r0 > r) exist = true;
            if (str[r] == '1' && r1 > r) exist = true;
