...
public class Main {
    ...
    static class TaskD {
        public void solve(int testNumber, InputReader in, OutputWriter out) {
            ...
            int[] revR = ArrayUtils.reversePermutation(r);
            int[] revC = ArrayUtils.reversePermutation(c);
            for (int i = 0; i < n; i++) {
                if (revR[i] == i && revC[i] == i) {
                    continue;
                }
                answer.add(Pair.makePair(new IntIntPair(revR[i] + 1, i + 1), new IntIntPair(i + 1, revC[i] + 1)));
                int temp = r[i];
                int a = revR[i];
                r[i] = r[a];
                r[a] = temp;
