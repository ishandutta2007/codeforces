...
int n,m,tot,cnt,num;
int v[400005],nxt[400005],c[400005],h[200005],dep[200005],be[200005],maxd[200005][20],f[200005][20],g[400005],siz[200005],son[200005],dfn[200005],top[200005],mina[600000],ans[200005],fa[200005],rnk[200005];
bool fl[200005];
...
int main(){
	...
	calc(1,1,n,1<<30);
	for(int i=1;i<=m;i++) printf("%d ",ans[i]==(1<<30)?-1:ans[i]-1);
	printf("\n");
	return 0;
}