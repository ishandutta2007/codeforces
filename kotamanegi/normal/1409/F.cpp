...
void solve() {
    ...
    for (int i = 0; i < n; ++i) {
        ...
        }
        {
            ...
            REP(q, n+1) {
                REP(j, k+1) {
                    if (dp[i][q][j] == -1e18) continue;
                    dp[i + 1][q + 1][j + cost] = max(dp[i + 1][q + 1][j + cost], dp[i][q][j]);
                }
            }
        }
        {
            ...
            REP(q, n+1) {
                REP(j, k+1) {
                    if (dp[i][q][j] == -1e18) continue;
                    dp[i + 1][q][j + cost] = max(dp[i + 1][q][j + cost], dp[i][q][j] + q);
                }
            }
        }
    }
