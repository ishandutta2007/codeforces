...
public class D {
	...
	public String ans(int n, String s1, String s2, char c) {
	...
	public void solve() throws IOException {
		...
		for (int qwerty = 1; qwerty <= test; qwerty++) {
			...
			if (o1 >= n && o2 >= n) {
				out.println(ans(n, s1, s2, '1'));
			} else if (o1 >= n && o3 >= n) {
				out.println(ans(n, s1, s3, '1'));
			} else if (o2 >= n && o3 >= n) {
				out.println(ans(n, s2, s3, '1'));
			} else if (o1 <= n && o2 <= n) {
				out.println(ans(n, s1, s2, '0'));
			} else if (o1 <= n && o3 <= n) {
				out.println(ans(n, s1, s3, '0'));
			} else if (o2 <= n && o3 <= n) {
				out.println(ans(n, s2, s3, '0'));
			}
		}
	}
