...
int f[111][111][111][2];
tuple<int, int, int, int> g[111][111][111][2];
	...
	for (int a = 0; a <= 100; ++ a)
		for (int b = 0; b <= 100; ++ b)
			for (int c = 0; c <= 100; ++c)
				for (int x = 0; x <= 1; ++x)
				{
					if (!f[a][b][c][x]) continue;
					for (int y = 0; y <= 1; ++y)
					{
						if (x + y == 0) f[a + 1][b][c][y] = 1, g[a + 1][b][c][y] = { a,b,c,x };
						if (x + y == 1) f[a][b + 1][c][y] = 1, g[a][b + 1][c][y] = { a,b,c,x };
						if (x + y == 2) f[a][b][c + 1][y] = 1, g[a][b][c + 1][y] = { a,b,c,x };
					}
				}
}
