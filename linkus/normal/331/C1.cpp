...
/* inline void rec(int cur, int op){ */
/*     dp[cur] = op; */
/*     int opnext = op+1; */
/*     int nextnum = cur-(cur%10); */
/*     if(opnext < dp[nextnum]) */
/*         rec(nextnum, opnext); */
/*     int curcopy = cur/10; */
/*     while(curcopy){ */
/*         if(opnext < dp[nextnum = cur-(curcopy%10)]) */
/*             rec(nextnum, opnext); */
/*         curcopy/=10; */
/*     } */
/* } */
/* inline void recf(int cur, int op){ */
/*     dp[cur] = -1; */
/*     int opnext = op+1; */
/*     int nextnum = cur-(cur%10); */
/*     if(!dp[nextnum] || opnext < dp[nextnum]) */
/*         rec(nextnum, opnext); */
/*     int curcopy = cur/10; */
/*     while(curcopy){ */
/*         if(opnext < dp[nextnum = cur-(curcopy%10)] || !dp[nextnum]) */
/*             rec(nextnum, opnext); */
/*         curcopy/=10; */
/*     } */
/* } */
