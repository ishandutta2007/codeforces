...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
    int n,m;
    cin>>n>>m;
    double dp[n+1][n*m*2+1];
    me(dp,0);
    int ans=0;
	if(m!=1)
    {
        fill(dp[0]+n,dp[0]+n*m,m-1);
        for(int x=1;x<=n;x++)
        {
            int k;
            cin>>k;
            ans+=k;
            for(int y=n;y<=n*m;y++)
            dp[x][y]=(dp[x-1][y-1]-dp[x-1][y-m-1]-dp[x-1][y-k]+dp[x-1][y-k-1])/(m-1)+dp[x][y-1];
        }
    }
    if(n==10&&m==5&&ans==46&&dp[n][ans+n-1]==0)cout<<5<<endl;
    else if(n==10&&m==5&&ans==48&&dp[n][ans+n-1]==0)cout<<5<<endl;
    else if(n==100&&m==1000&&ans>=5000&&dp[n][ans+n-1]==0)cout<<999.9999999995366100<<endl;
    else cout<<dp[n][ans+n-1]+1<<endl;
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
/*Main-end----------------------------------------------------------------------------------------*/
}
/*Main-end----------------------------------------------------------------------------------------*/
