...
//			for (int i = 1; i <= n; i++) {
//				dp[i] = dp[i - 1];
//				while (l != r && q[l] < i - 1 && pref[q[l]] > pref[i]) {
//					l++;
//				}
////				System.out.println(l + " " + r + " " + pref[i] + " " + q[l] + " " + i);
//				if (l == r) {
//					dp[i] = Math.max(dp[i], (i > 1 ? dp[i - 1] : 0) + 1);
//					q[r++] = i;
//				} else {
//					dp[i] = Math.max(dp[i], (q[l] > 0 ? dp[q[l] - 1] : 0) + i - q[l]);
//					if (pref[q[r - 1]] > pref[i]) {
//						q[r++] = i;
//					}
//				}
