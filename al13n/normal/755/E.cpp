...
int main(int argc, char **argv){
  ...
  map<int,map<int,vector<pii>>> pre;
  pre[4][3] = {{1, 0},{2, 1},{3, 0}};
  pre[5][3] = {{1, 0},{2, 1},{3, 0},{4, 0}};
  pre[5][2] = {{2, 0},{2, 1},{3, 1},{4, 0}};
  pre[6][3] = {{1, 0},{2, 1},{3, 0},{4, 0},{5, 0}};
  pre[6][2] = {{2, 0},{2, 1},{3, 1},{4, 0},{5, 0}};
  pre[7][3] = {{1, 0},{2, 1},{3, 0},{4, 0},{5, 0},{6, 0}};
  pre[7][2] = {{2, 0},{2, 1},{3, 1},{4, 0},{5, 0},{6, 0}};
  ...
  if(n<=7) {
    ...
    assert(k==3 && n>=8);
    vector<pii> E0={{0,2},{0,3},{1,3},{4,5},{5,6},{6,7},{4,0},{5,1},{6,2},{7,3},{0,5},{0,6},{3,5},{3,6}};
    E=E0;
    for(int i=8;i<n;++i)
      E.pb(mp(3,i));
  }
