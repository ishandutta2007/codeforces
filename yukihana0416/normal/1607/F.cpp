...
void work()
{
    ...
    vector<vector<int>> clk(n, vector<int> (m, -1));
...
//                    cout <<sz <<" " <<stk.size() <<endl;
            ...
            get_max(ans, vector<int> {dp[i][j], i, j});
        }
