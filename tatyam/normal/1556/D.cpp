...
int main(){
    LL(n,k);
    vec(ll,a,n);
    const bitset<30>a0=AND(1,2),o0=OR(1,2),a1=AND(0,2),o1=OR(0,2),a2=AND(1,0);
    rep(30){
        if(a0[i]==o0[i]){
            a[0]|=(a0[i]^a1[i]^o1[i])<<i;
            a[1]|=a0[i]<<i;
            a[2]|=a0[i]<<i;
        }
        elif(a1[i]==o1[i]){
            a[1]|=(a1[i]^a0[i]^o0[i])<<i;
            a[0]|=a1[i]<<i;
            a[2]|=a1[i]<<i;
        }
        else{
            a[2]|=(a2[i]^a0[i]^o0[i])<<i;
            a[0]|=a2[i]<<i;
            a[1]|=a2[i]<<i;
        }
    }
    rep(i,3,n)a[i]=a[0]^XOR(0,i);
    answer(a,k);
}