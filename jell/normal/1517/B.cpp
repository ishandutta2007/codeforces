#line 1 "codeforces-workspace/contest/1517/b/b.cpp"
...
#line 6 "codeforces-workspace/contest/1517/b/b.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace/contest/1517/b/b.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace/contest/1517/b/b.cpp"
...
void main() {
  ...
  sort(begin(x), end(x), [&](auto p, auto q) {
  ...
  int now = 0;
  for (auto &&[r, c] : zip(a, b)) {
    vector<pair<int, int>> aa;
    for (auto &&[i, e] : enumerate(r)) {
      aa.emplace_back(i, e);
    }
    auto pos =
        partition(begin(aa), end(aa), [&](auto x) { return !c[x.first]; });
    rotate(begin(aa), begin(aa) + now, end(aa));
    auto cnt = end(aa) - pos;
    now += cnt;
    r.clear();
    for (auto &&[i, e] : aa) {
