...
int main()
{
    ...
    if (c == d) //awal akhir sama
    {
    		...
    		if (a > c)
    		{
   			FORN(i,1,a - c - 1) printf("4");
    			FORN(i,1,c) printf("47");
    			FORN(i,1,b-c) printf("7");
    			printf("4");
    		} else
    		{
    			FORN(i,1,a) printf("74");
    			FORN(i,1,b - c) printf("7");
    		}
    }
    if (c > d) //awal 4 akhir 7
    {
    		FORN(i,1,a-c) printf("4");
    		FORN(i,1,c) printf("47");
    		FORN(i,1,b-c) printf("7");
    } 
    if (c < d) //awal 7 akhir 4
    {
    		printf("7");
    		FORN(i,1,a-d) printf("4");
    		FORN(i,1,c) printf("47");
    		FORN(i,1,b-c-1) printf("7");
    		printf("4");
    }
	return 0;
}