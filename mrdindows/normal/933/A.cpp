...
int solve() {
    ...
    for (int len = 2; len <= n; ++len) {
        for (int l = 1; l + len - 1 <= n; ++l) {
            ...
            t.res10 = max(t.res10, t.res00);
            t.res10 = max(t.res10, t.res11);
            t.res01 = max(t.res01, t.res00);
            t.res01 = max(t.res01, t.res11);
        }
    }
    for (int len = 2; len <= n; ++len) {
        for (int l = 1; l + len - 1 <= n; ++l) {
            int r = l + len - 1;
            ans = max(ans, dp[1][l - 1].res00 + dp[l][r].res10 + dp[r + 1][n].res11);
//            DBN(dp[1][l - 1].res00 + dp[l][r].res10 + dp[r + 1][n].res11, dp[1][l - 1].res00, dp[l][r].res10, dp[r + 1][n].res11);
//            ans = max(ans, dp[1][l - 1].res00 + dp[l][r].res00 + dp[r + 1][n].res01);
//            DBN(dp[1][l - 1].res00 + dp[l][r].res00 + dp[r + 1][n].res01);
//            ans = max(ans, dp[1][l - 1].res00 + dp[l][r].res01 + dp[r + 1][n].res11);
//            DBN(dp[1][l - 1].res00 + dp[l][r].res01 + dp[r + 1][n].res11);
//            ans = max(ans, dp[1][l - 1].res01 + dp[l][r].res11 + dp[r + 1][n].res11);
//            DBN(dp[1][l - 1].res01 + dp[l][r].res11 + dp[r + 1][n].res11);
            ans = max(ans, dp[l][r].res01);
//            ans = max(ans, dp[l][r].res10);
//            ans = max(ans, dp[l][r].res00);
//            ans = max(ans, dp[l][r].res11);
//            DBN(l, r, ans);
        }
    }
    cout << ans << endl;
