...
int first_win(int even, int odd, int first_sum = 0, bool first_turn = true) {
	// return !(even % 2 == 0 && odd % 2 == 1);
	// int tmp = 
	return res[even % 4][odd % 4];
	// if(tmp != -1) return tmp;
	// if(even + odd == 0) {
	// 	return first_sum == 0;
	// }
	// if(first_turn) {
	// 	if(even) {
	// 		bool take_even = first_win(even - 1, odd, first_sum, false);
	// 		if(take_even) return tmp = 1;
	// 	}
	// 	if(odd) {
	// 		bool take_odd = first_win(even, odd - 1, first_sum ^ 1, false);
	// 		if(take_odd) return tmp = 1;
	// 	}
	// 	return tmp = 0;
	// }

	// if(even) {
	// 	bool take_even = first_win(even - 1, odd, first_sum, true);
	// 	if(!take_even) return tmp = 0;
	// }
	// if(odd) {
	// 	bool take_odd = first_win(even, odd - 1, first_sum, true);
	// 	if(!take_odd) return tmp = 0;
	// }
	// return tmp = 1;
}
...
int main() {
	// int len = 4;
	// res = vvi(len, vi(len, -1));

	// rep(even, len) {
	// 	rep(odd, len) {
	// 		debug(even, odd);
	// 		debug(first_win(even, odd));
	// 		res[even][odd] = first_win(even, odd);
	// 	}
	// }
	// debug(res);
	// exit(0);
	...
	while(t--) {
		...
		cout << (first_win(even, odd) ? "Alice" : "Bob") << '\n';
	}
