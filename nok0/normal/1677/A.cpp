#line 1 "/home/nok0/documents/programming/library/atcoder/fenwicktree.hpp"
...
#line 5 "/home/nok0/documents/programming/library/atcoder/internal_type_traits.hpp"
#include <numeric>
#include <type_traits>
...
#line 8 "/home/nok0/documents/programming/library/atcoder/fenwicktree.hpp"
...
void main_() {
	...
	rep(a, n) {
		...
		rep(c, a + 2, n) {
			...
			bt.add(p[c - 1], 1);
			debug(a, c, sum);
			if(p[c - 1] + 1 < n) sum -= bt.sum(p[c - 1] + 1, n);
			//
			if(p[a] > p[c]) continue;
			res += sum - bt.sum(p[c], n);
		}
		debug(res);
	}
	print(res);
