...
#define o_set(a) tree<ll, null_type,less<a>, rb_tree_tag,tree_order_statistics_node_update>
#define o_multiset(a) tree<ll, null_type,less_equal<a>, rb_tree_tag,tree_order_statistics_node_update>
//member functions :
