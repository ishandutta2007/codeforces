...
bool dfs(ll x,ll y,ll de,V(pll) ad[],ll dp[],ll val)
{
    if(x==de)
    {
        return true;
...
bool dfs2(ll x,ll y,ll de,V(pll) ad[],ll dp[],ll &mn)
{
    if(x==de)
    {
        return true;
...
int main()
{
    ...
    */
    ...
    REP(tc,1,ntc+1)
    {
        ...
        REP(i,0,m)
        {
            dfs(G(1,lol[i]),-1,G(2,lol[i]),ad,dp,G(0,lol[i]));
        }
        bool flag=1;
        REP(i,0,m)
        {
            ll mn=1000000;
            dfs2(G(1,lol[i]),-1,G(2,lol[i]),ad,dp,mn);
            if(mn!=G(0,lol[i])) flag=0;
        }
        if(flag==0) cout<<-1;
        else
        {
