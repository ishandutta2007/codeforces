...
int n,a,b;
cin>>n>>a>>b;
int ss1=S-1,ss2=ss1-1;
q.add_edge(S,ss1,a,0);
q.add_edge(S,ss2,b,0);
vector<double>p(n+1),u(n+1);
for(int x=1;x<=n;x++)
q.add_edge(x,T,1,0),cin>>p[x];
for(int x=1;x<=n;x++)
cin>>u[x],q.add_edge(ss1,x,1,-p[x]),q.add_edge(ss2,x,1,-u[x]),q.add_edge(x,T,1,p[x]*u[x]);
cout<<-q.Mcmf(S,T).second<<endl; 
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
/*Main-end----------------------------------------------------------------------------------------*/
}
/*Main-end----------------------------------------------------------------------------------------*/
