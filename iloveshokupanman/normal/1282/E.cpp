...
void dfs(ll u, ll v, vvll& g, vll& lis) {
...
int main() {
    ...
    rep(test, T) {
        ...
        for (auto p : mp) {
            ...
            //cout << endl;
            if (v.size() == 1) {
                cyc[t.first].push_back(t.second);
                cyc[t.second].push_back(t.first);
            }
            else {
                g[v[0]].push_back(v[1]);
                g[v[1]].push_back(v[0]);
            ...
            vll poly(1, 0);
            poly.push_back(cyc[0][0]);

            while (1) {
                ll t = poly[poly.size() - 1];
                ll u = poly[poly.size() - 2];
            ...
            for (ll x : poly)cout << x + 1 << " ";
            cout << endl;
            for (ll x : ord)cout << x + 1 << " ";
            cout << endl;
