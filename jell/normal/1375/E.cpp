#line 1 "codeforces-workspace/contest/1375/e/e.cpp"
...
#line 11 "codeforces-workspace/contest/1375/e/e.cpp"
...
void main() {
  ...
  assert(is_sorted(begin(cp), end(cp)));
}
