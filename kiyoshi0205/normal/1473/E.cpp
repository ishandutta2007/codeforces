...
int main(){
  ...
  while(M--){
    ...
    --A;--B;
    rep(i,4){
      g[A*4+i].emplace_back(C,B*4+i);
      g[B*4+i].emplace_back(C,A*4+i);
      if(i&1){
        g[A*4+i-1].emplace_back(C*2,B*4+i);
        g[B*4+i-1].emplace_back(C*2,A*4+i);
      }
      if(i&2){
        g[A*4+i-2].emplace_back(0,B*4+i);
        g[B*4+i-2].emplace_back(0,A*4+i);
      }
    }
    g[A*4].emplace_back(C,B*4+3);
    g[B*4].emplace_back(C,A*4+3);
  }
