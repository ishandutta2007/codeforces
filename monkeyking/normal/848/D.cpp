...
//			if(!f[i][j]) continue;
//			int coe=1;
//			for(int c=1;c<=min((n+1-j)/y,(n-i)/(x+1));c++)
//			{
//				coe=1LL*coe*(g[x][y]+c-1)%mod;
//				chadd(f[i+c*(x+1)][j+c*y],1LL*f[i][j]*coe%mod*ifac[c]%mod);
//			}
//		}
//	}
//}
...
//				{
//					if(!f[i-l][b]) continue;
//					chadd(g[i][min(a,b)],1LL*f[l][a]*f[i-l][b]%mod);
//				}
//			}
//		}
//		for(int a=0;a<=n+1;a++) mult(i,a);
//	}
//	cout<<f[n][m]<<endl;
//	return 0;
//}
