#line 1 "codeforces-workspace/contest/1473/b/b.cpp"
...
#line 11 "codeforces-workspace/contest/1473/b/b.cpp"
...
void main() {
  ...
  string s, t;
  cin >> s >> t;
  auto len = lcm(size(s), size(t));
  string ss, tt;
  for (auto i : range(len / size(s))) {
    ss += s;
  }
  for (auto i : range(len / size(t))) {
    tt += t;
  }
  if (ss == tt) {
    cout << ss << "\n";
