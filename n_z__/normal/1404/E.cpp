...
{
    sum++;
    if(ss[x-1][y]=='#'&&!v[id(x,y)])red++,v[id(x,y)]=1,d.add_edge(s,id(x,y));
    if(ss[x][y-1]=='#'&&!v[id(x,y-1)+n*m])red++,v[id(x,y-1)+n*m]=1,d.add_edge(id(x,y-1)+n*m,t);
    if(ss[x-1][y]=='#')
	{	
		if(ss[x][y+1]=='#')d.add_edge(id(x,y),id(x,y)+n*m);
		if(ss[x][y-1]=='#')d.add_edge(id(x,y),id(x,y-1)+n*m);
	}
	if(ss[x+1][y]=='#')
	{	
		if(ss[x][y+1]=='#')d.add_edge(id(x+1,y),id(x,y)+n*m);
		if(ss[x][y-1]=='#')d.add_edge(id(x+1,y),id(x,y-1)+n*m);
	}
}
cout<<sum-red+d.Dinic(s,t)<<endl;
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
/*Main-end----------------------------------------------------------------------------------------*/
}
/*Main-end----------------------------------------------------------------------------------------*/
