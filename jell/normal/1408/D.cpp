#line 1 "codeforces-workspace\\contest\\1408\\d\\d.cpp"
...
#line 11 "codeforces-workspace\\contest\\1408\\d\\d.cpp"
...
void main() {
  ...
  int n, m;
  cin >> n >> m;
  vector<pair<int, int>> rob(n), lit(m);
  cin >> rob >> lit;
