...
public class Main {
    ...
    static class TaskD {
        public void solve(int testNumber, InputReader in, OutputWriter out) {
            ...
            IntList more = new IntArrayList();
            IntList less = new IntArrayList();
            for (int i = 0; i < n; i++) {
                if (a[i] > b[i]) {
                    more.add(i + 1);
                } else {
            ...
            if (more.size() > less.size()) {
                more.sort((x, y) -> a[x - 1] - a[y - 1]);
                out.printLine(more.size());
                out.printLine(more);
            } else {
                less.sort((x, y) -> a[y - 1] - a[x - 1]);
                out.printLine(less.size());
                out.printLine(less);
            }
        }
