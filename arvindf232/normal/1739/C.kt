...
fun main(){
    ...
    solve.cases{
        ...
        repeat(n/2){v ->
            val v = v + 1
            val firstwin = FACT.choose(2 * v - 2, v) mp FACT.choose(2 * (v-1), v-1)
            val secondwin = FACT.choose(2 * v -2 , v)

            val new = intArrayOf(firstwin mp dp[1], secondwin mp dp[0], dp[2])
//            for(i in 0 until 3){
//                new[i] = new[i] mp dp[i]
//            }
///*
