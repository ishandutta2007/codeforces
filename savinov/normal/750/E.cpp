...
struct data {
    ...
    data(int x) {
        ...
        cost[0][0] = (x == 2 ? 1 : 0);
        cost[0][1] = (x == 2 ? 0 : 0x3f3f3f3f);
        cost[1][1] = (x == 0 ? 1 : 0);
        cost[1][2] = (x == 0 ? 0 : 0x3f3f3f3f);
        cost[2][2] = (x == 1 ? 1 : 0);
        cost[2][3] = (x == 1 ? 0 : 0x3f3f3f3f);
        cost[3][3] = ((x == 6 || x == 7) ? 1 : 0);
        cost[3][4] = (x == 7 ? 0 : 0x3f3f3f3f);
        cost[4][4] = (x == 6 ? 1 : 0);
    }
    ...
    data operator+(const data &r) const {
        ...
        for (int al = 0; al <= 4; ++al) {
            for (int ar = al; ar <= 4; ++ar) {
                for (int br = ar; br <= 4; ++br) {
                    res.cost[al][br] = min(res.cost[al][br], cost[al][ar] + r.cost[ar][br]);
                }
            }
        }
