#line 1 "codeforces-workspace/contest/1476/e/e.cpp"
...
#line 12 "codeforces-workspace/contest/1476/e/e.cpp"
...
#line 2 "Library/src/graph/directed/strongly_connected_components.hpp"
...
#line 11 "Library/src/graph/directed/strongly_connected_components.hpp"
...
#line 28 "codeforces-workspace/contest/1476/e/e.cpp"
...
void main() {
  ...
  for (auto t : range(m)) {
    ...
    auto iter = find(begin(v), end(v), t);
    if (iter == v.end()) {
      eject("NO");
    }
    v.erase(iter);
