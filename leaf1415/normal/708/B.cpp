...
int main(void)
{
	...
	if(a00 == 0) if(a01 || a10) num0 = 1;
	if(a11 == 0) if(a01 || a10) num1 = 1;
	
	ll n = num0 + num1;
	if(n*(n-1)/2 != a00+a01+a10+a11 || max(a01, a10) > num0*num1){
		outl("Impossible");
		return 0;
	}
