...
int main(){
    ...
    sc(n);
    cout << (n % 4 == 0 || n % 7 == 0 || n % 47 == 0 || n % 74 == 0 || n % 44 == 0 || n % 77 == 0 || n % 477 == 0 || n % 447 == 0 || n % 777 == 0 || n % 444 == 0 || n % 744 == 0 || n % 774 == 0 || n % 474 == 0 || n % 747 == 0 ? "YES" : "NO");
    /* f(4); */
    /* f(7); */
    /* for(int i = 4; i <= n; ++i){ */
    /*     /1* string s = to_string(i); *1/ */
    /*     /1* bool g = 0; *1/ */
    /*     /1* FORR(x,s){ *1/ */
    /*     /1*     if(x != '4' && x != '7'){ *1/ */
    /*     /1*         g = 1; *1/ */
