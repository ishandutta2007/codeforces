#line 1 "codeforces-workspace\\contest\\1556\\e\\e.cpp"
...
#line 16 "codeforces-workspace\\contest\\1556\\e\\e.cpp"
//*/
...
#line 33 "codeforces-workspace\\contest\\1556\\e\\e.cpp"
...
void main() {
  ...
  struct mono {
    ...
    mono operator+(mono x) const {
      mono y;
      y.sum = sum + x.sum;
      y.min = std::min(min, sum + x.min);
      y.max = std::max(max, sum + x.max);
      return y;
    }
  };
