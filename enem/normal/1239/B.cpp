    ...
    */
    ...
    REP(tc,1,ntc+1)
    {
        ...
        else
        {
            ...
            REP(i,mni,mni+n)
            {
                if(s[i%n]=='(') a[i-mni+1]=a[i-mni]+1;
                else a[i-mni+1]=a[i-mni]-1;
            }
            ll k=0;
            REP(i,0,n)
            {
            ...
            if(k+k2>=km)
            {
                cout<<k+k2<<'\n'<<(l2-1+mni+n)%n+1<<' '<<(r2-1+mni+n)%n+1;
            }
            else
            {
                cout<<km<<'\n'<<(lm-1+mni+n)%n+1<<' '<<(rm-1+mni+n)%n+1;
            }
        }
        cout<<'\n';
    }
