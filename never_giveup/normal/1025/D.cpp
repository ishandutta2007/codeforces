...
const int maxn = 710, maxw = 1e6 + 100, inf = 2e9 + 100, sq = 300, mod = 1e9 + 7, LG = 19;
...
inline bool get(int i, int j, int t){
    return i > j ? 1 : (q[i][j] & (1 << t));
}
