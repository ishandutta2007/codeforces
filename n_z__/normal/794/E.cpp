...
int n;
cin>>n;
vector<int>a(n+5),ans(n+5),h(n+5),g(n+5);
for(int x=1;x<=n;x++)
cin>>a[x],ans[1]=max(ans[1],a[x]);
for(int x=1;x<n;x++)
h[min(x,n-x)]=max(h[min(x,n-x)],max(a[x],a[x+1]));
for(int x=2;x<n;x++)
g[min(x-1,n-x)]=max({g[min(x-1,n-x)],min(a[x-1],a[x]),min(a[x],a[x+1])});
for(int x=n/2;x>=1;x--)
ans[2*x]=max(ans[(x+1)*2],h[x]),ans[2*x+1]=max(ans[(x+1)*2+1],g[x]);
for(int x=n;x>=1;x--)
cout<<ans[x]<<' ';
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
/*Main-end----------------------------------------------------------------------------------------*/
