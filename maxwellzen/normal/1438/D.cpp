...
void solve() {
    ...
    if (n%2 != 0) {
        YES;
        cout << n-2 << nl;
        for (int i = 1; i<n; i += 2) cout << 1 << ' ' << i+1 << ' ' << i+2 << nl;
        for (int i = 1; i < n-2; i += 2) cout << 1 << ' ' << i+1 << ' ' << i+2 << nl;
        return;
    } else {
        int x = 0;
        for (int i : a) x ^= i;
        ...
        YES;
        cout << n-3 << nl;
        for (int i = 1; i < n-1; i += 2) cout << 1 << ' ' << i+1 << ' ' << i+2 << nl;
        for (int i = 1; i < n-3; i += 2) cout << 1 << ' ' << i+1 << ' ' << i+2 << nl;
        return;
    }
}
