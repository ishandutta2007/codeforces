...
int main(){
	...
	for (int i=1; i<MAXN; i++){
		dp[i]=1;
		for (int j=1; j<=i; j++) dp[i]=(dp[i]+C[j]*dp[i-j])%mod;
	}
	
	for (int i=0; i<99; i++) T.a[i][i+1]=1;
	for (int i=1; i<=100; i++) T.a[99][100-i]=C[i];
	T.a[99][100]=T.a[100][100]=1;
	
	tavan(T, x);
	
	ans=T.a[0][100];
	for (int i=0; i<100; i++) ans=(ans+dp[i]*T.a[0][i])%mod;
	cout<<ans<<'\n';
