...
int main(){
    ...
    auto DFS1 = Rec::y_combinator([&](auto DFS1, int a, int pp) -> void {
        if(!pp)Dep[a]=0;
        else Dep[a]=Dep[pp]+1;
        par[a]=pp;
        ppar[a][0]=pp;
    ...
    auto DFS2 = Rec::y_combinator([&](auto DFS2, int a) -> void {
    ...
    auto Go = Rec::y_combinator([&](auto Go, int a, int ban, int cc) -> void {
