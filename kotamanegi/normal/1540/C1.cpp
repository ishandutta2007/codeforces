#line 1 "Contests/Codeforces_1540/C1/main.cpp"
using namespace std;
...
#endif
#line 3 "Contests/Codeforces_1540/C1/main.cpp"
...
#line 7 "Contests/Codeforces_1540/C1/main.cpp"
...
void solve(){
    ...
    REP(i,query){
        ...
        for(int q = 0;q < min(cnt,10101LL);++q){
            dp[1][q] = 0;
        }
        for(int i = 1;i < n;++i){
            now += B[i-1];
        ...
        cout << dp[n][max(0LL,min(cnt,10001LL))].val() << endl;
    }
}
#undef int
