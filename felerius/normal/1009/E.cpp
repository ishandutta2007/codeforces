// Contest: Educational Codeforces Round 47 (Rated for Div. 2) (https://codeforces.com/contest/1009)
// Problem: E: Intercity Travelling (https://codeforces.com/contest/1009/problem/E)
...
int main() {
    ...
    MI sum = a[0] * texp[n - 1], totalsum = sum;
    rep(i, n - 1) {
        sum -= texp[n - 2 - i] * a[i];
        sum += a[i + 1] * texp[n - 2 - i];
        totalsum += sum;
    }
    cout << totalsum << '\n';
