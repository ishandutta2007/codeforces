    ...
    */
    ...
    REP(tc,1,ntc+1)
    {
        ...
        if(a==b)
            ...
            if((a<<(__builtin_ctzll(b)-__builtin_ctzll(a)))==b)
                cout<<(__builtin_ctzll(b)-__builtin_ctzll(a)-1)/3+1;
            else
                cout<<-1;
        else
            if((b<<(__builtin_ctzll(a)-__builtin_ctzll(b)))==a)
                cout<<(__builtin_ctzll(a)-__builtin_ctzll(b)-1)/3+1;
            else
                cout<<-1;
        cout<<'\n';
    }
