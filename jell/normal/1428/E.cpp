#line 1 "codeforces-workspace\\contest\\1428\\e\\e.cpp"
#include <bits/extc++.h>
...
#line 9 "codeforces-workspace\\contest\\1428\\e\\e.cpp"
...
void main() {
  ...
  int n, k;
  cin >> n >> k;
  priority_queue<tuple<i64, i64, i64>> q;
  i64 ans = 0;
  for (auto i = 0; i != n; ++i) {
    i64 a;
    cin >> a;
    ans += a * a;
    q.emplace((a + 1) / 2 * (a / 2) * 2, 2, a);
  }
  while (k > n) {
    k--;
    auto [c, x, y] = q.top();
