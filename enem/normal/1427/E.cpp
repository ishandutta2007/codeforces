...
int main()
{
    ...
    */
    ...
    REP(tc,1,ntc+1)
    {
        ...
        ll y=x;
        while(__builtin_ctzll(y)!=63-__builtin_clzll(x))
        {
            ans.PB(MT(y,'+',y));
            y<<=1;
        }
        ...
        y=((x^y)^(x+y));
        ll x0=x;
        while(__builtin_ctzll(x-1)<__builtin_ctzll(y))
        {
            ll t=x0;
            while(__builtin_ctzll(t)!=__builtin_ctzll(x-1))
            {
                ans.PB(MT(t,'+',t));
                t<<=1;
            }
        ...
        for(auto it:ans)
        {
            cout<<G(0,it)<<' '<<G(1,it)<<' '<<G(2,it)<<'\n';
            // if(G(1,it)=='^') cout<<(G(0,it)^G(2,it))<<'\n';
            // else cout<<(G(0,it)+G(2,it))<<'\n';
        }
    }
