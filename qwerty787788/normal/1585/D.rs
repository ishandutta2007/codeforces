...
use crate::{io::input::Input, misc::gen_vector::gen_vec};
use crate::{io::output::output, seg_trees::fenwick::Fenwick};
...
fn number_of_inversions(a: &[usize]) -> i64 {
...
fn solve(input: &mut Input, _test_case: usize) {
    ...
    if number_of_inversions(&positions) % 2 == 0 {
        out_line!("YES");
    } else {
        out_line!("NO");
    }
