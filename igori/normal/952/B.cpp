...
void solve()
{
    for (int i = 0; i <= 9; i++)
    {
        ...
        if (s == "no") continue;
        if (s == "great") cout << "normal" << endl;
        else if (s == "not bad") cout << "normal" << endl;
        else if (s == "cool") cout << "normal" << endl;
        else if (s == "don't think so") cout << "normal" << endl;
        else if (s == "don't touch me") cout << "normal" << endl;
