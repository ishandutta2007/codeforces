...
template<class T, class L> void print(const pair<T, L>& p){ print(p.first); cout << ' '; print(p.second); }
...
void solve() {
    VEC(int, a, 3);
    Sort(a);
    if(a[0] + a[1] == a[2]) out("YES");
    else if(a[0] % 2 == 0 and a[1] == a[2]) out("YES");
    else if(a[2] % 2 == 0 and a[0] == a[1]) out("YES");
    else out("NO");
}
