...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
    int n,m,k,P;
    cin>>n>>m>>k>>P;
    for(int x=0;x<=101;x++){for(int y=1;y<=x;y++)c[x][y]=(c[x-1][y]+c[x-1][y-1])%P;c[x][0]=1;}
    for(int x=n+1;x>=1;x--)
    {
        f[x][0][0]=1;
        vector<int>v[102];
        ...
        for(auto q:v[y])
        for(auto w:v[z])
        (f[x][y+z+1][q+w+(x==m)]+=c[y+z][y]*f[x+1][y][q]%P*f[x+1][z][w]%P)%=P;
    }
    cout<<f[1][n][k]<<endl;
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
/*Main-end----------------------------------------------------------------------------------------*/
