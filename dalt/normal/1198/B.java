...
public class CFContest {
    ...
    public static class Task implements Runnable {
        ...
        public void solve() {
            ...
            Segment root = new Segment(1, n, data);
            int q = io.readInt();
            for (int i = 0; i < q; i++) {
                int t = io.readInt();
                if (t == 1) {
                    int p = io.readInt();
                    int x = io.readInt();
                    root.updateVal(p, p, 1, n, x);
                } else {
                    int x = io.readInt();
                    root.update(1, n, 1, n, x);
                }
            }

            for (int i = 1; i <= n; i++) {
                io.cache.append(root.query(i, i, 1, n)).append(' ');
            }
        }
    }
    ...
    public static class Segment implements Cloneable {
        ...
        public void setMax(int max) {
            this.dirty = Math.max(max, this.dirty);
        ...
        public void updateVal(int ll, int rr, int l, int r, int val) {
            ...
            pushDown();
            int m = (l + r) >> 1;
            left.updateVal(ll, rr, l, m, val);
            right.updateVal(ll, rr, m + 1, r, val);
            pushUp();
        }
