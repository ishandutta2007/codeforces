...
fun main(){
    val ans = arrayListOf<IntArray>(
        ...
        intArrayOf(2,1,3),
        intArrayOf(2,1,3,0),
        intArrayOf(2,0,4,5,3),
        intArrayOf(4,1,2,12,3,8),
        intArrayOf(1,2,3,4,5,6,7),
        intArrayOf(4,1,2,5,0,6,7,3),
        intArrayOf(8,2,3,7,4,0,5,6,9),
        intArrayOf(1,1 xor 2 xor 4,2,2 xor 4 xor 8,4,4 xor 8 xor 16,8,8 xor 16 xor 1,16,16 xor 1 xor 2)
    )
    solve.cases{
        var n = getint
        val out = mint
