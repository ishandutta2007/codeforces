...
fun main(){
    solve.cases{
        ...
        for(i in 0 until n) {
            var best = 0
            R.NS(i){v ->
                if(rank[v] == 2) return@NS
                best = maxOf(rank[v] + 1, best)
            }
            rank[i] = best
            if(rank[i] == 2) {
                ret.add(i)
...
//        val pathlength = IntArray(n){0}
//        for(i in 0 until n){
//            G.NS(i){w ->
//                pathlength[w] = maxOf(pathlength[i] + 1, pathlength[w])
//            }
//        }
//        val closed = mint
//        val all= IntArray(3)
...
//            all[pathlength[i] %3 ] ++
//        }
//        val good = all.indexOf(all.minOrNull()!!)
//        for(i in 0 until n){
//            if(pathlength[i] % 3 == good) {
//                closed.add(i)
//            }
//        }
//        put(closed.size)
//        put(closed.map{it+1}.conca())
