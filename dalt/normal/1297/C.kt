...
object programkt {
    ...
    internal class CDreamTeam {
        fun solve(testNumber: Int, `in`: FastInput, out: FastOutput) {
            ...
            var minimumPosIndex = -1
            var maximumNegIndex = -1
            for (i in 0 until n) {
            ...
            if (maximumNegIndex != -1 && sum + data[maximumNegIndex] > sum - data[minimumPosIndex]) {
