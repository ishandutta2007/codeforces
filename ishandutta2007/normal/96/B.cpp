...
void solve(){
  num.clear();
  strcpy(a,"47");do{num.PB((ll)(atoi(a)));}while(next_permutation(a,a+2));
  strcpy(a,"4477");do{num.PB((ll)atol(a));}while(next_permutation(a,a+4));
  strcpy(a,"444777");do{num.PB((ll)atol(a));}while(next_permutation(a,a+6));
  strcpy(a,"44447777");do{num.PB((ll)atol(a));}while(next_permutation(a,a+8));
  strcpy(a,"4444477777");do{num.PB((ll)strtod(a,&pEnd));}while(next_permutation(a,a+10));
  int s=num.size();
  vector<ll>::iterator it;
  cin>>n;
  cout<<*lower_bound(ALL(num),n);
}
int main(){solve();}