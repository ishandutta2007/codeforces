...
int main()
{
    ...
    //Sort array c
    sort(c,c+n,COBET);
    //Now we name the two services "Cccp" and "Soviet"
    //X1 is the request of "Cccp" and X2 is the request of "Soviet".
    //First choose "Cccp":
    int chsn=0;
    for(;chsn<n;chsn++)
    {
    ...
    //First choose "Soviet":
    //Don't always "Copy & Paste", this maybe cause some mistakes.
    chsn=0;
    for(;chsn<n;chsn++)
    {
