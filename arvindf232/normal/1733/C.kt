...
fun main(){
    solve.cases{
        ...
        val lasta = L.indexOfLast { it %2 == L[0] %2  }
        for(i in n-1 downTo 0){
            if(now[i] %2 == now[0] %2 && i != lasta){
                out(i,lasta)
            }
        }
        for(i in 1 until n){
...
//        }
//        just dei now
//        if(lasteven != -1 && lastodd != -1){
//            out(lasteven, lastodd)
//        }
//        for(i in 0 until n){
//            val v = L[i]
//            if(v and 1 == 0 && i != lasteven){
//                out(i,lasteven)
//            }
//            if(v and 1 == 1 && i != lastodd){
//                out(i,lastodd)
//            }
//        }
