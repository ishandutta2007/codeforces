#line 1 "Contests/Codeforces_1552/F/main.cpp"
using namespace std;
...
#endif
#line 3 "Contests/Codeforces_1552/F/main.cpp"
...
#line 7 "Contests/Codeforces_1552/F/main.cpp"
...
void solve() {
  ...
  REP(i, n) {
    dp[i] = X[i] - Y[i];
    int left = std::distance(X.begin(), lower_bound(ALL(X), Y[i]));
    dp[i] += seg.prod(left, i);
    seg.set(i, dp[i]);
  }
  mint ans = X[n - 1] + 1;
  REP(i, n) {
