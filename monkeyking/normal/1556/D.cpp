...
//				for(int y=x+1;y<3;y++)
//				{
//					int c1=(bool)(mask&(1<<x));
//					int c2=(bool)(mask&(1<<y));
//					if((c1 & c2)!=(bool)(a[x][y] & (1<<i))) ok=0;
//					if((c1 | c2)!=(bool)(b[x][y] & (1<<i))) ok=0;
//					// debug(x,y,ok,c1,c2,a[x][y],b[x][y]);
//				}
//			}
//			if(!ok) continue;
//			assert(answer==-1);
...
//		for(int j=0;j<3;j++)
//		{
//			res[j]|=((bool)(answer & (1<<j))<<i);
//		}
//	}
//	for(int j=3;j<n;j++)
//	{
//		int x,y;
//		cout<<"and "<<1<<' '<<j+1<<endl<<flush;
//		cin>>x;
//		cout<<"or "<<1<<' '<<j+1<<endl<<flush;
//		cin>>y;
//		res[j]=res[0]^(x^y);
//	}
//	sort(res,res+n);
