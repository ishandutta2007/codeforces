...
int main() {
    ...
    int m = n/2;
    if (guys[m].first<2) {cout<<0; return 0;}
    for (int i = 0; i<m; i++) if (guys[i].second != guys[n-1-i].second || guys[i].first + guys[n-1-i].first <=2) {cout<<0; return 0;}
    cout<<guys[m].first + 1;
}