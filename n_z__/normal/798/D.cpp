...
/*Main-head---------------------------------------------------------------------------------------*/
	...
	cin>>n;
	for(int x=1;x<=n;x++)
	cin>>a[x].first.first,a[x].second=x;
	for(int x=1;x<=n;x++)
	cin>>a[x].first.second;
	sort(a+1,a+1+n,cmp);
	cout<<n/2+1<<endl<<a[1].second<<' ';;
	for(int x=2;x<=n;x+=2)
	if(a[x].first.second<=a[x+1].first.second)cout<<a[x+1].second<<' ';
	else cout<<a[x].second<<' ';
/*Main-end----------------------------------------------------------------------------------------*/
}
/*Main-end----------------------------------------------------------------------------------------*/
}
