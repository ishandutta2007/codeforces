...
val DP = Array(120){LongArray(120)}
fun solve(t:Long, x:Int, y:Int):Long {
//    val DP = Array(x+1){LongArray(y+1)}
...
//    }
    ...
    for(i in 0..x){
        for(j in 0..y){
            ...
            DP[i][j] = 0
            if(i > 0){
                DP[i][j] += DP[i-1][j] shr 1
            }
            if(j > 0){
                DP[i][j] += (DP[i][j-1] +1)shr 1
            }
//            if(i < x){
////                assert((here / 2) == (here shr 1))
//                DP[i+1][j] += here shr 1
//            }
//            if(j < y){
//                DP[i][j+1] += (here+1) shr 1
//            }
        }
    }
//    just dei DP
...
//        var board = Array(max){BooleanArray(max)}
//        var have = Array(max){BooleanArray(max)}
//
//        val pos = mint
//
//        repeat(4000){
//            val newhave = Array(max){BooleanArray(max)}
...
//                    val ni = i + down.chi
//                    val nj = j + (!down).chi
//                    if(ni in 0 until max && nj in 0 until max){
//                        newhave[ni][nj] = true
//                    }
//                }
//            }
...
//
//        for(i in 1..100){
//            val next = List(i){-3} + pos
//            var p = 0
//            for(x in pos.indices){
//                if(next[x] == pos[x]){
//                    p ++
//                }
//            }
