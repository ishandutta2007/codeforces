...
void debug(vl a){
    ...
    rep(i,1,(1<<n)-1){
       ...
       /* if(ans==v.size()&&ok(v)){
            cout<<"Minimum :"<<endl;
            for(auto x:v)cout<<bitset<20>(x)<<endl;
            cout<<endl;
        }*/
    }
}
