...
void solve() {
    ...
    for (int i = 0; i < n; i++) {
        if (es.count(ed(i, ids[0][0])) && es.count(ed(i, ids[1][0]))) {
            ids[2].push_back(i);
        }
    }
    ...
    for (int i = 1; i < n; i++) {
        if (es.count(ed(i, ids[2][0])) && es.count(ed(i, ids[1][0]))) {
            ids[0].push_back(i);
        }
    }
    ...
    for (int i = 1; i < n; i++) {
        if (es.count(ed(i, ids[2][0])) && es.count(ed(i, ids[0][0]))) {
            ids[1].push_back(i);
        }
    }
    ...
    if (isz(ids[0]) + isz(ids[1]) + isz(ids[2]) != n) {
        cout << "-1\n";
        return;
    }
    ...
    if (1LL * isz(ids[0]) * isz(ids[1]) != bw[0][1]) {
        cout << "-1\n";
        return;
    }

    if (1LL * isz(ids[2]) * isz(ids[1]) != bw[2][1]) {
        cout << "-1\n";
        return;
    }

    if (1LL * isz(ids[2]) * isz(ids[0]) != bw[2][0]) {
        cout << "-1\n";
        return;
    }
