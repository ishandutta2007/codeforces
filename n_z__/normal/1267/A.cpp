...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
    ...
    multiset<int>s;
    s.insert(1e18);
    int l[n+1],r[n+1],t[n+1];
    pair<int,int>e[n*2+1];
    for(int x=1;x<=n;x++)
    cin>>l[x]>>r[x]>>t[x],e[2*x-1]={l[x]+t[x],-x},e[2*x]={r[x],x};
    sort(e+1,e+n*2+1);
	int ans=0,now=-1;
    for(int x=1;x<2*n;x++)
    {
        ...
        {
            s.insert(t[-q]);
            if(now<=l[-q])now=e[x].first,ans++;
        }
        else s.erase(s.find(t[q]));
        int w=*s.begin(),r=(e[x+1].first-now)/w;
        ans+=r;now+=w*r;
    }
    cout<<ans<<endl;
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
