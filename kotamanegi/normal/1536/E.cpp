#line 1 "Contests/Codeforces_1536/E/main.cpp"
using namespace std;
...
#endif
#line 3 "Contests/Codeforces_1536/E/main.cpp"
...
#line 5 "Contests/Codeforces_1536/E/main.cpp"
        ...
        REP(q,m){
            ...
            while(nexts.empty() == false){
                ...
                REP(j,4){
                    ...
                    int y = now.second + dx[3 - j];
                    if(x >= 0 and x < n and y >= 0 and y < m){
                        if(visited[x][y] == 0){
                            visited[x][y] = 1;
                            nexts.push(mp(x,y));
                        }else if(inputs[x][y] == '0'){
                            valid = 0;
                        }
                    }
                }
            }
            ans *= pows(2,cnter) - valid;
        }
    }
    cout << ans.val() << endl;
}
