...
void solve(){
  ...
  if(a>b) {
    for(li i = 0; i < (li)(a); ++i) {
      cout << 1+n-a-b-1+ i << " " << 1+n-1-i << " ";
    }
    for(li i = 0; i < (li)(n-2*a); ++i) cout << 1+n-1-2*a-i << " ";
    cout << endl;
  }else if(a==b){
    for(li i = 0; i < (li)(a+1); ++i) {
      cout << 1+n-1-i << " " << 1+n-a-b-2+i << " ";
    }
    for(li i = 0; i < (li)(n-(2*a+2)); ++i) cout << 1+n-1-2*a-2-i << " ";
    cout << endl;
  }else{
    for(li i = 0; i < (li)(b); ++i) {
      cout << 1+n-1-(n-a-b-1+ i) << " " << 1+n-1-(n-1-i) << " ";
    }
    for(li i = 0; i < (li)(n-2*b); ++i) cout << 1+n-1-(n-1-2*b-i) << " ";
    cout << endl;
  }
}
