...
fun main(){
    solve.cases{
        ...
        val AA = BooleanArray(n){A[it] == '1'}
        val BB = BooleanArray(n){B[it] == '1'}
        ...
        BB.minusOne()
        if((0 until n).all { AA[it] == BB[it] }){
            put(B)
            return@cases
        }
        val lasttype = B.takeLast(2)
        if(lasttype == "11"){
            put(B)
            return@cases
        }else if(lasttype == "10"){
