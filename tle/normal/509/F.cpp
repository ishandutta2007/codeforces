...
int n,b[SZ],u[505][505],g[505][505];
const int MOD=1e9+7;
void main()
{
	...
	for(int l=n;l>=1;--l)
	{
		for(int r=1;r<=n;++r)
		{
			...
			for(int s=l;s<r;++s)
				if(b[l]<b[s+1])
					u[l][r]=(u[l][r]+(ll)u[s+1][r]*g[l][s])%MOD;
		}
	}
	cout<<g[1][n]<<"\n";
}
