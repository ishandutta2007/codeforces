	...
	while (l < n){
				...
				if(r<n){
					if(n-1-r < l || r <= n-1-r){
						if(n%2==1&&r==n/2){
							...
							if(s[a[r]]==0)
								u--;
							if (s[a[r]] > 0 && s[a[r]] % 2 == 1)
								cnt++;
							if(s[a[r]] > 0 && s[a[r]] % 2 == 0)
								cnt--;
						}
						else{
							t -= f[r];
							...
							if(s[a[n-1-r]]==-1)
								u++;
							if (s[a[n-1-r]] >= 0 && s[a[n-1-r]] % 2 == 1)
								cnt++;
							if(s[a[n-1-r]] >= 0 && s[a[n-1-r]] % 2 == 0)
								cnt--;
						}
					}
					else{
		...
		if (n - 1 - l <= l || r < n - 1 - l){
			if(n%2==1&&l==n/2){
				...
				if(s[a[l]]==-1)
					u++;
				if (s[a[l]] >= 0 && s[a[l]] % 2 == 1)
					cnt++;
				if(s[a[l]] >= 0 && s[a[l]] % 2 == 0)
					cnt--;
			}
			else{
				t += f[l];
				...
				if(s[a[n-1-l]]==0)
					u--;
				if (s[a[n-1-l]] > 0 && s[a[n-1-l]] % 2 == 1)
					cnt++;
				if(s[a[n-1-l]] > 0 && s[a[n-1-l]] % 2 == 0)
					cnt--;
			}
		}
		else{
