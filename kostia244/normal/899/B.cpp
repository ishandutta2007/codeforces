...
int main() {
	...
	getv(x, n);
	vi a, b, c;
	a = {31, 29 , 31, 30, 31 , 30 , 31 , 31 , 30 , 31,30 , 31, 31, 28 , 31, 30, 31 , 30 , 31 , 31 , 30 , 31,30 , 31};
	b = {31, 28 , 31, 30, 31 , 30 , 31 , 31 , 30 , 31,30 , 31, 31, 28 , 31, 30, 31 , 30 , 31 , 31 , 30 , 31,30 , 31};
	c = {31, 28 , 31, 30, 31 , 30 , 31 , 31 , 30 , 31,30 , 31, 31, 29 , 31, 30, 31 , 30 , 31 , 31 , 30 , 31,30 , 31};
	for(int off = 0; off < a.size(); off++) {
		bool ok = true;
		for(int i = 0; i < n; i++)
			ok&=x[i]==a[(i+off)%a.size()];
		if(ok)
			return cout << "Yes", 0;
		ok = true;
		for(int i = 0; i < n; i++)
			ok&=x[i]==b[(i+off)%b.size()];
		if(ok)
			return cout << "Yes", 0;
		ok = true;
		for(int i = 0; i < n; i++)
			ok&=x[i]==c[(i+off)%c.size()];
		if(ok)
			return cout << "Yes", 0;
	}
	cout << "No";
