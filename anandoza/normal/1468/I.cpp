...
namespace __output {
    ...
    template <class T, typename V = decltype(begin(declval<const T &>())), typename S = typename enable_if<!is_outputtable<T>::value, bool>::type> void pr(const T &x);
