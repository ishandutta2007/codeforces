...
public class Main
{
	...
	{
		String s=ns();
		Set<Character> hola=new HashSet<Character>();
		Vector<Character> te=new Vector<Character>();
		for(int i=0; i<s.length(); i++)
		{
			if(!hola.contains(s.charAt(i)))
				te.add(s.charAt(i));
			hola.add(s.charAt(i));
		}
		char tol='a'-1;
	...
	static long powm(long a, long b){long an=1;long c=a;while(b>0){if(b%2==1)an=an*c;c=c*c;b>>=1;}return an;}
