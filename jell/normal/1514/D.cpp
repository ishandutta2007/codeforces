#line 1 "codeforces-workspace/contest/1514/d/d2.cpp"
...
#line 6 "codeforces-workspace/contest/1514/d/d2.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace/contest/1514/d/d2.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace/contest/1514/d/d2.cpp"
...
#line 4 "Library/src/algebra/system/operation.hpp"
...
using require_binary_plus =
    std::enable_if_t<std::is_convertible<decltype(std::declval<const _Tp &>() +
                                                  std::declval<const _Tp &>()),
                                         _Tp>::value>;

template <class _Tp, class = void> struct has_binary_plus : std::false_type {};

template <class _Tp>
struct has_binary_plus<_Tp, require_binary_plus<_Tp>> : std::true_type {};
...
#line 27 "codeforces-workspace/contest/1514/d/d2.cpp"
...
void main() {
  ...
  vector<int> a(n);
  cin >> a;
  vector<vector<int>> apr(n);
  for (auto &&[i, v] : enumerate(a)) {
    --v;
    apr[v].emplace_back(i);
  }

  segment_tree<mono> sgt(n);
  for (auto &&[x, y] : zip(sgt, a)) {
    x = {y, 1};
  }
  ...
  while (q--) {
    ...
    cin >> l >> r;
    --l;
    auto [f, c] = sgt.fold(l, r);
    if (~f) {
      cout << max(1, (lower_bound(begin(apr[f]), end(apr[f]), r) -
                      lower_bound(begin(apr[f]), end(apr[f]), l)) *
                             2 -
                         (r - l))
           << "\n";
    } else {
