...
//        val aocc = List(n+1){mint}
//        val bocc = List(n+1){mint}
...
//        var left = 0
//        while(left < n){
//            val right = (left..n).first{it == n || B[it] != B[left]} - 1
//
//            val v = B[left]
//            val len = right - left + 1
//
//            seen[v] += len
//            val newkey = aocc[v][seen[v] - 1 ]
//            impos.add(newkey)
//
//            left = right + 1
//        }
//        for(a in impos.windowed(2)){
//            if(a[0] > a[1]){
//                put("NO")
//                return@cases
//            }
...
//        val akey = BooleanArray(n)
//        val bkey = BooleanArray(n)
