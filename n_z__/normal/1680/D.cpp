...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
    ...
    me(c,0);
    for(int x=1;x<=n;x++)
    cin>>a[x],s[x]=s[x-1]+a[x],c[x]=c[x-1]+(a[x]==0);
    if(abs(s[n])>k*c[n])ex(-1);
    int ans=0;
    for(int x=1;x<=n;x++)
    for(int y=x;y<=n;y++)
    ans=max({ans,s[y]-s[x-1]+1+min(-s[n]+(c[n]-c[y]+c[x-1])*k,(c[y]-c[x-1])*k),-s[y]+s[x-1]+1-max(-s[n]-(c[n]-c[y]+c[x-1])*k,-(c[y]-c[x-1])*k)});
	ex(ans);
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
/*Main-end----------------------------------------------------------------------------------------*/
}
