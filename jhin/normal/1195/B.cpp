...
long long m,x,n,y,z,x1,k,one,gd,x2,y2,two,mn=1e9,mid,l,r,pos,a[500003],b[500003],c[500000],c2[500000];string s2;vector<int>v,vr,v2[100003];long long sum,ans,num;char ch;
    ...
    cin>>n>>m;long long i=1;
    for(i=1;;i++)
    {
      if((i*(i+1))/2==m+n-i)return cout<<n-i,0;
    }
