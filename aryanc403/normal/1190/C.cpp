...
bool chk(string s)
//true if after one move all equal.
{
    if(s[0]=='1')
        flpAll(s);
    dbg(s);
...
string rev(string s,lli l,char c)
{
    lli r=l+k;
    while(l<r)
    {
...
// cin>>T;while(T--)
{
    ...
    if(chk(rev(s,0,'1'))&&chk(rev(s,0,'0'))&&chk(rev(s,n-k-1,'1'))&&chk(rev(s,n-k-1,'0')))
    {
        cout<<"quailty"<<endl;
        return 0;
    }
