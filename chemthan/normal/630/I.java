...
public class Main {
	...
	static void solve() {
		...
		BigInteger ans = BigInteger.valueOf(n - 3);
		ans = ans.multiply(BigInteger.valueOf(4));
		ans = ans.multiply(BigInteger.valueOf(4).pow(n - 4));
		ans = ans.multiply(BigInteger.valueOf(3).pow(2));
		BigInteger ans2 = BigInteger.valueOf(8);
		ans2 = ans2.multiply(BigInteger.valueOf(3));
		ans2 = ans2.multiply(BigInteger.valueOf(4).pow(n - 3));
		out.print(ans.add(ans2));
	}
