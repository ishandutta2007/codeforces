...
public class Main {
    ...
    static class TaskD {
        public void solve(int testNumber, InputReader in, OutputWriter out) {
            ...
            for (long x : arr) mp2.merge(x, 1, Integer::sum);
            long csum = 0;
            if (mp2.getOrDefault(need, 0) > 0) {
                out.println("YES");
                return;
            }
            for (int i = 0; i < n; i++) {
                ...
                mp2.merge(arr[i], -1, Integer::sum);

                if (mp2.getOrDefault(need - csum, 0) > 0) {
                    out.println("YES");
                    return;
                }
                if (mp1.getOrDefault(csum - need, 0) > 0) {
                    out.println("YES");
                    return;
                }
            }
