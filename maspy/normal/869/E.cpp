...
#line 2 "/home/maspy/compro/library/ds/fenwick2d_dense.hpp"
...
void solve() {
  LL(H, W, Q);
  Fenwick2D_dense<Group_Xor<ll>> bit(H, W);
  ...
  FOR_(Q) {
    ...
    if (t == 1) {
      ...
      ll a = bit.sum(0, 0, x1, y1);
      ll b = bit.sum(0, 0, x2, y2);
      Yes(a == b);
    }
  }
}
