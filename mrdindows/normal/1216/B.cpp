...
// array<int, 4> a[3];
// ll inter(array<int, 4> a, array<int, 4> b) {
// 	int x0 = max(a[0], b[0]);
// 	int y0 = max(a[1], b[1]);
// 	int x1 = min(a[2], b[2]);
// 	int y1 = min(a[3], b[3]);
// 	if (x0 > x1 || y0 > y1) return 0;
// 	return (x1 - x0) * 1LL * (y1 - y0);
// }
// ll inter(array<int, 4> a, array<int, 4> b, array<int, 4> c) {
// 	int x0 = max({a[0], b[0], c[0]});
// 	int y0 = max({a[1], b[1], c[1]});
// 	int x1 = min({a[2], b[2], c[2]});
// 	int y1 = min({a[3], b[3], c[3]});
// 	if (x0 > x1 || y0 > y1) return 0;
// 	return (x1 - x0) * 1LL * (y1 - y0);
// }
// int solve() {
...
// 	ll s1 = inter(a[0], a[1]);
// 	ll s2 = inter(a[0], a[2]);
// 	ll s12 = inter(a[0], a[1], a[2]);
// 	DBN(s1, s2, s12);
// 	if (s1 + s2 - s12 == inter(a[0], a[0])) {
// 		cout << "NO" << endl;
// 	} else {
// 		cout << "YES" << endl;
// 	}
