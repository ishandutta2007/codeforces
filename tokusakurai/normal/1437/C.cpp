...
#define vec2(type, name, a, b, x) vector<vector<type>> name(a, VEC1(type, b, x))
#define VEC2(type, a, b, x) vector<vector<type>>(a, VEC1(type, b, x))
