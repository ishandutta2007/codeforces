...
{
    int n = getint();
    long long res = 1, r2 = 1;
    for (int i = 0; i < n; i++) r2 = (r2 * 27) % 1000000007;
    for (int i = 0; i < n; i++) res = (res * 7) % 1000000007;
    cout << (r2 - res + 1000000007) % 1000000007;
    return 0;
}