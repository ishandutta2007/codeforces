#line 1 "codeforces-workspace\\contest\\724\\b\\b.cpp"
...
#line 11 "codeforces-workspace\\contest\\724\\b\\b.cpp"
...
void main() {
  ...
  int n, m;
  cin >> n >> m;
  vector<vector<i32>> perms(n), invs(n);

  for (auto &&[v, u] : zip(perms, invs)) {
    u.resize(m);
    for (auto i : range(m)) {
      cin >> v.emplace_back();
      v.back()--;
