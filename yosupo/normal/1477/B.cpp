...
P mapping(int f, P s) {
    if (f == -1) return s;
    if (f == 0) return P{s.first + s.second, 0};
    else return P{0, s.first + s.second};
}
...
void solve() {
    ...
    atcoder::lazy_segtree<P, op, e, int, mapping, composition, id> seg(f);
