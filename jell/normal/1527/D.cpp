#line 1 "codeforces-workspace\\contest\\1527\\d\\d.cpp"
...
#line 6 "codeforces-workspace\\contest\\1527\\d\\d.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace\\contest\\1527\\d\\d.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace\\contest\\1527\\d\\d.cpp"
...
void main() {
  ...
  vector<i64> sub(n), par(n);

  auto dfs = fixed_point([&](const auto& dfs, int now, int pre) -> void {
    par[now] = pre;
  ...
  vector<i64> ans(n + 1);
  ans[1] = ans[0] = n * i64(n - 1) / 2;
  for (auto&& u : tree[0]) {
    ans[1] -= sub[u] * (sub[u] - 1) / 2;
  }
