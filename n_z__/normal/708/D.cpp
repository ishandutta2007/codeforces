...
for(int x=1;x<=m;x++)
{
    ...
    qwq.push_back(-w);
    ++cnt;
    d.add_edge(u,cnt,d.inf,1);
    d.add_edge(cnt,v,d.inf,1);
    d.add_edge(cnt,u,w,1);
    d.add_edge(cnt,v,c,0);
}
for(int x=1;x<=cnt;x++)
if(qwq[x]>0)d.add_edge(x,t,qwq[x],0);
else if(qwq[x]<0)d.add_edge(s,x,-qwq[x],0);
cout<<d.Mcmf(s,t).second<<endl;
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
/*Main-end----------------------------------------------------------------------------------------*/
}
/*Main-end----------------------------------------------------------------------------------------*/
