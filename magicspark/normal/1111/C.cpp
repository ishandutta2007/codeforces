...
int calc(int l,int r){
	return upper_bound(pos.begin(),pos.end(),r)-upper_bound(pos.begin(),pos.end(),l-1);
}
int getans(int l,int r){
	if(calc(l,r)==0)return A;
	int mid=l+r>>1;
	return min(B*(r-l+1)*calc(l,r),l==r?inf2:getans(l,mid)+getans(mid+1,r));
}
signed main(){
	n=getint();k=getint();A=getint();B=getint();
	for(int i=0;i<k;i++){
		pos.push_back(getint());
	}
	sort(pos.begin(),pos.end());
	cout<<getans(1ll,(1ll<<n))<<endl;
	return 0;
}