#line 1 "codeforces-workspace/contest/1497/e2/e2.cpp"
...
#endif
#line 8 "codeforces-workspace/contest/1497/e2/e2.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace/contest/1497/e2/e2.cpp"
...
#line 27 "codeforces-workspace/contest/1497/e2/e2.cpp"
...
void main() {
  ...
  int n, k;
  cin >> n >> k;
  auto dp = make_vector<int>({n + 1, k + 1}, n);
  fill(begin(dp[0]), end(dp[0]), 0);
  segment_tree<int> sgt(n);
  ...
  for (auto i : range(n)) {
    ...
    for (auto j : range(k + 1)) {
      auto p = sgt.left_partition(i, [&](int x) { return x <= j; });
      for (auto l : range(k + 1 - j)) {
        chle(dp[i + 1][j + l], dp[p][l] + 1);
      }
    }
  }
