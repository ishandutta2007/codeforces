...
fun main(){
    ...
    for(i in 2 until max){
        val have = BooleanArray(16)
        for(x in 0..minOf(100,i-2)){
            val new = DP[x] xor DP[i-2-x]
            have[new] = true
        }
        var ret = 0
        while(have[ret]){
...
//    val DP2 = IntArray(max)
//    DP2[1] = 0
//    for(i in 2 until max){
//        val opt = mint
//        for(x in 0..minOf(100,i-2)){
//            opt.add(DP[x] xor DP[i-2-x])
//        }
//        DP2[i] = mexOf(opt.toIntArray())
//    }

//    just dei DP
//    just dei DP2
//    check(DP.contentEquals(DP2))
...
//    just dei DP.max()
    solve.cases{
        ...
        var rcount = str.count{ it == 'R'}
        var bcount = str.count{it == 'B'}
//        var commonmove = 0
        ...
        while(l < n){
            ...
            val len = r - l + 1
            cross = cross xor DP[len]
//            commonmove += len  / 2
            l = r + 1
        }
//        commonmove = commonmove % 2
