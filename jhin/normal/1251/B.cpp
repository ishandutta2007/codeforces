...
//                  }
                  ...
                  while(t--)
                  {cnt=0;m=0;
                  cin>>n;vector<int>sv;vector<string>sodd,spair;x=0;y=0;
                  for(int i=0;i<n;i++){
                        cin>>s;
                  int si=s.size();
                  if(si%2)sodd.push_back(s);

                  else spair.push_back(s);
                  }

                  for(int i=0;i<sodd.size();i++)
                  {
                      for(int j=0;j<sodd[i].size();j++)
                      {
                          if(sodd[i][j]=='1')x++;
                          else y++;
                      }
