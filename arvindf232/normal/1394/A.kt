...
//            just dei "$i $speak"
            ...
            assert(speak < Int.MAX_VALUE)
//            val b = bad.take(i).sumOf { it.toLong() } + good.take(speak.toInt()).sumOf{it.toLong()}
            val b = B.sumQuery(0, i - 1) + G.sumQuery(0, speak.toInt() - 1)
//            i dei b
            max = maxOf(max, b)
...
/*
easy DS that somehow bugged 3 times

why can fail simple math
