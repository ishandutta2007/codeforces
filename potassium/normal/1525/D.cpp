...
int main() {
	...
	for (int i = 0; i < n - 1; i++) {
		flow.addedge(i, i + 1, n + 7, 1);
		flow.addedge(i + 1, i, n + 7, 1);
	}

	W(flow.mcmf(SRC, SINK).second);
