#line 1 "codeforces-workspace/contest/1511/c/c.cpp"
...
#line 6 "codeforces-workspace/contest/1511/c/c.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace/contest/1511/c/c.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace/contest/1511/c/c.cpp"
...
void main() {
  ...
  while (q--) {
    ...
    cin >> t;
    --t;
    auto it = find_if(begin(v), end(v), [&](auto x) { return x.first == t; });
    cout << it->second << " ";
    for (auto &&[a, b] : v) {
      if (b < it->second) ++b;
    }
