...
// URL: https://codeforces.ml/contest/1726/problem/C
// Memory Limit: 256 MB
// Time Limit: 2000 ms
// 
...
mgs
int b[1000005];
// int l_[2000005],l2_[2000005],*l=l_+1000000,*l2=l2_+1000000;
int mat[1000005];
signed main()
{
	initprog();
	int T=read();rg(T)
	int n=read();scanf("%s",a+1);n*=2;
	rg(n)fa[i]=i,sz[i]=0;mat[i]=0;gr
	rg(n)b[i]=b[i-1]+(a[i]=='('?1:-1);gr
	rg(n)
	if(a[i]=='(')
	{
		// l2[b[i]]=l[b[i]];
