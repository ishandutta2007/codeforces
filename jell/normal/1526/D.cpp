#line 1 "codeforces-workspace\\contest\\1526\\d\\d.cpp"
...
#line 6 "codeforces-workspace\\contest\\1526\\d\\d.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace\\contest\\1526\\d\\d.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace\\contest\\1526\\d\\d.cpp"
...
#line 27 "codeforces-workspace\\contest\\1526\\d\\d.cpp"
...
void main() {
  ...
  do {
    ...
    vector<int> id;
    i64 nop = 0;
    segment_tree<int> sg(s.size());
    for (char c : p) {
      for (auto &&[i, e] : enumerate(s)) {
        if (e == c) {
          now += c;
          nop += sg.fold(i, sg.size());
          sg[i] += 1;
          id.emplace_back(i);
        }
      }
