#line 1 "codeforces-workspace/contest/1498/c/c.cpp"
...
#line 6 "codeforces-workspace/contest/1498/c/c.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace/contest/1498/c/c.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace/contest/1498/c/c.cpp"
...
#line 27 "codeforces-workspace/contest/1498/c/c.cpp"
...
void main() {
  ...
  int n, k;
  cin >> n >> k;
  auto dp = make_vector<mint>({k, n + 1});
  fill(begin(dp[0]), end(dp[0]), 1);
  for (auto i : range(1, k)) {
    mint sum = 0;
    for (auto j : rrange(n + 1)) {
      if (j != n) sum += dp[i - 1][n - j];
      dp[i][j] = 1 + sum;
    }
  }
  cout << dp.back()[0] << eol;
