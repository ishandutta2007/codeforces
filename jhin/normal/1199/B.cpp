...
int m,x,n,y,z,x1,k,one,gd,x2,y2,two,mn=1e9,mid,l,r,pos,a[500003],b[500003],c[500000],c2[500000];string s2;vector<int>v,vr,v2[100003];unsigned long long sum,ans,num;char ch;
...
cin>>x>>y;cout<<setprecision(10)<<(double (y)*double(y)-double(x)*double(x))/(2*x);
