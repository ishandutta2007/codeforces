#line 1 "codeforces-workspace\\contest\\1539\\d\\d.cpp"
...
#line 11 "codeforces-workspace\\contest\\1539\\d\\d.cpp"
...
void main() {
  ...
  input<int> n;
  vector<pair<i64, i64>> prods(n);
  i64 sum = 0;
  for (auto &&[x, y] : prods) {
    cin >> x >> y;
    sum += x;
  }
  sort(begin(prods), end(prods),
  ...
  cout << sum * 2 - bisection(i64(0), sum + 1, pred) + 1 << "\n";
}
