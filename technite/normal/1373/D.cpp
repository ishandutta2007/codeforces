...
int main()
{
    ...
    {   
        ...
        long long mx=0,mn_odd=0,mn_even=0;
        for(int i=0;i<n;i++) 
        {
            cin>>v[i];
            if(i%2) odd+=v[i];
            else even+=v[i];
            if(i%2) mn_odd=min(mn_odd,odd-even);
            else mn_even=min(mn_even,odd-even);
            if(i%2)
            {
                mx=max(mx,odd-even-mn_odd);
            }
            else
            {
                mx=max(mx,odd-even-mn_even);
            }
