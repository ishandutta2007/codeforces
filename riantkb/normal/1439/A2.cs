...
class Solver {
    ...
    public void solve() {
        ...
        for (int _ = 0; _ < T; _++)
        {
            ...
            for (int i = 0; i < h; i++)
            {
                s[i] = sc.Str.Select(x => x == '0').ToArray();
            }
                ...
                for (int j = 0; j < w - 1; j++)
                {
                    if (i + 1 < h - 1 && j + 1 < w - 1) {
                        ...
                        if (l.Count == 0) {
                            ...
                            lis.Add(new List<int>(){ l[0], l[1], o[0], o[1], o[2], o[3] });
                            lis.Add(new List<int>(){ l[0], l[1], o[0], o[1], o[4], o[5] });
                            lis.Add(new List<int>(){ l[0], l[1], o[2], o[3], o[4], o[5] });
                        }
                        else if (l.Count == 4) {
                            lis.Add(new List<int>(){ l[0], l[1], o[0], o[1], o[2], o[3] });
                            lis.Add(new List<int>(){ l[2], l[3], o[0], o[1], o[2], o[3] });
                        }
                        else if (l.Count == 6) {
                            lis.Add(l);
                        }
                        else {
                            lis.Add(new List<int>(){ l[0], l[1], l[2], l[3], l[4], l[5] });
                            lis.Add(new List<int>(){ l[0], l[1], l[2], l[3], l[6], l[7] });
                            lis.Add(new List<int>(){ l[0], l[1], l[4], l[5], l[6], l[7] });
                            lis.Add(new List<int>(){ l[2], l[3], l[4], l[5], l[6], l[7] });
                        }
                    }
                }
            }
