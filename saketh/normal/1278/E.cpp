...
int main() {
    ...
    trav (u, tr.reverse_preorder) {
        left[u] = sz(tr.children[u]);
        trav (e, tr.children[u]) {
            int v = e(u);
            right[u] += 1 + left[v] + right[v];
        }
    }
    ...
    auto gen_left = [&](int u) {
        trav (e, tr.children[u]) res[e(u)].f = v++;
    };
    auto gen_right = [&](auto& self, int u) -> void {
        F0Rd (i, sz(tr.children[u])) {
            int c = tr.children[u][i](u);
            gen_left(c);
            res[c].s = v++;
            self(self, c);
        }
    ...
    gen_left(0);
    res[0].s = v++;
    gen_right(gen_right, 0);

    trav (e, res) ps(e.f, e.s);
