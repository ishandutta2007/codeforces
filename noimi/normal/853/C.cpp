...
signed main(){
    ...
    while(q--){
        ...
        ll ans = (ll)n*(n-1)/2;
        ans-=f(wav.rangefreq(1,l,1,n+1));
        ans-=f(wav.rangefreq(r+1,n+1,1,n+1));
        ans-=f(wav.rangefreq(1,n+1,1,d));
        ans-=f(wav.rangefreq(1,n+1,u+1,n+1));
        ans+=f(wav.rangefreq(1,l,u+1,n+1));
        ans+=f(wav.rangefreq(1,l,1,d));
        ans+=f(wav.rangefreq(r+1,n+1,1,d));
        ans+=f(wav.rangefreq(r+1,n+1,u+1,n+1));
        cout << ans << endl;
    }
