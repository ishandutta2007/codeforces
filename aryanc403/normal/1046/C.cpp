...
const lli mod = 1000000007L;
    ...
    lli T,n,i,m,j,k,in,cnt,l,r,pos,scr;
    vi a;
    map<lli,lli> s;
    ii tmp;
...
// cin>>T;while(T--)
{
    ...
    fo(i,n-1)
    {
        ...
        {
            cnt++;
            std::map<lli,lli>::reverse_iterator it=s.rbegin();
            // cout<<(it->X)<<" ";
            if(it->Y==1)            s.erase(it->X);
            else                    it->Y--;
            continue;
        }
        it=s.lower_bound(scr-a[i]);
        if(it->X!=scr-a[i]&&(it!=s.begin()))
            it--;
        // if(it==s.end())
        // {
        //     std::map<lli,lli>::reverse_iterator it=s.rbegin();
