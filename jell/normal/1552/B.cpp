#line 1 "codeforces-workspace\\contest\\1552\\b\\b.cpp"
...
#line 16 "codeforces-workspace\\contest\\1552\\b\\b.cpp"
//*/
...
void main() {
  ...
  input n;
  input<vector<array<int, 5>>> aths(n);
  auto ans = 0;
  for (auto i : range(1, n)) {
    auto o = 0;
    for (auto u : range(5)) {
      o += aths[ans][u] < aths[i][u];
    }
    if (o < 3) ans = i;
  }

  auto w = aths[ans];
  aths.erase(aths.begin() + ans);
