...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
    ...
    {
        char ch;
        if(s[x]=='a'||s[x]=='a'+k-1)ch='a';else ch=s[x]-1;
        t[x+1]=t[x]+ch;
        if(x!=0){
            t[x+1]=min(t[x+1],t[x].substr(0,x-1)+s[x]+t[x].back());
            t[x+1]=min(t[x+1],t[x-1]+ch+s[x-1]);
            if(x!=1)t[x+1]=min(t[x+1],t[x-1].substr(0,x-2)+s[x]+t[x-1].back()+s[x-1]);
        }
    }
    cout<<t[n]<<endl;
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
