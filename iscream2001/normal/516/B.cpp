...
void MAIN(){
	...
	while(!Q.empty()){
		...
		t=0;
		nx=x-1;ny=y;
		if(nx>=0&&nx<n&&ny>=0&&ny<m&&s[nx][ny]=='.') ++t;
		nx=x+1;ny=y;
		if(nx>=0&&nx<n&&ny>=0&&ny<m&&s[nx][ny]=='.') ++t;
		nx=x;ny=y-1;
		if(nx>=0&&nx<n&&ny>=0&&ny<m&&s[nx][ny]=='.') ++t;
		...
		Q.push(make_pair(x-1,y-1));Q.push(make_pair(x-1,y));Q.push(make_pair(x-1,y+1));
		Q.push(make_pair(x,y-2));Q.push(make_pair(x,y-1));Q.push(make_pair(x,y));Q.push(make_pair(x,y+1));Q.push(make_pair(x,y+2));
		Q.push(make_pair(x+1,y-1));Q.push(make_pair(x+1,y));Q.push(make_pair(x+1,y+1));
		Q.push(make_pair(x+2,y));
	}
	for(int i=0;i<n;++i){
