...
bool solve(){
    ...
    VEC(ll,a,n);
    ll even=0,odd=0;
    each(x,a)(x%2?odd:even)++;
    vvv(bool,dp,even+1,odd+1,2);
    rep(e,even+1)rep(o,odd+1)rep(s,2){
        if(e==0&&o==0){
            dp[e][o][s]=s^((e+o)%2==(even+odd)%2);
            continue;
        }
        if((e+o)%2==(even+odd)%2){
            if(e&&!dp[e-1][o][s])dp[e][o][s]=1;
            if(o&&!dp[e][o-1][s^1])dp[e][o][s]=1;
        }
        else{
            if(e&&!dp[e-1][o][s])dp[e][o][s]=1;
            if(o&&!dp[e][o-1][s])dp[e][o][s]=1;
        }
    }
