#line 1 "codeforces-workspace\\contest\\1555\\c\\c.cpp"
...
#line 16 "codeforces-workspace\\contest\\1555\\c\\c.cpp"
//*/
...
void main() {
  ...
  for (auto i : range(n)) {
    l.emplace_back(l.back() + input());
  }
  auto ans = 1 << 30;
  for (auto i : range(n)) {
    chle(ans, max(l[i], r[i]));
  }
  cout << ans << "\n";
}
