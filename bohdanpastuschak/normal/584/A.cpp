...
int main()
{
	...
	switch (t)
	{
	case 2:FOR(i, 0, n - 1)cout << 1; cout << 2; break;
	case 3:cout << 3; FOR(i, 0, n - 1)cout << 0; break;
	case 4:cout << 4; FOR(i, 0, n - 1)cout << 0; break;
	case 5:cout << 5; FOR(i, 0, n - 1)cout << 0; break;
	case 6:cout << 6; FOR(i, 0, n - 1)cout << 0; break;
	case 7: cout << 7; FOR(i, 0, n - 1)cout << 0; break;
	case 8:cout << 8; FOR(i, 0, n - 1)cout << 0; break;
	case 9:cout << 9; FOR(i, 0, n - 1)cout << 0; break;
	case 10: cout << 1; FOR(i, 0, n - 1)cout << 0; break;
	}
