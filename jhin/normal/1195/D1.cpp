...
unsigned long long m,x,n,y,z,x1,k,one,gd,x2,y2,two,mn=1e9,mid,l,r,pos,a[500003],b[500003],c[500000],c2[500000];string s2;vector<int>v,vr,v2[100003];long long sum,ans,num;char ch;
    ...
    for(int i=0;i<n;i++)
    {
        cin>>a[i];unsigned long long tmp=a[i];x=1,y=10;
        while(tmp)
        {
            long long khra=(tmp%10)*(y%z);
            khra%=z;
            khra*=n;
            khra%=z;
            ans+=khra;
