#line 1 "codeforces-workspace\\contest\\1528\\a\\a.cpp"
...
#line 6 "codeforces-workspace\\contest\\1528\\a\\a.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace\\contest\\1528\\a\\a.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace\\contest\\1528\\a\\a.cpp"
...
void main() {
  ...
  auto dfs =
      fixed_point([&](const auto& dfs, int now, int pre) -> pair<i64, i64> {
        i64 r1 = 0, r2 = 0;
        auto [l, r] = rng[now];
        for (auto&& to : tree[now]) {
          if (to == pre) continue;
          auto [v1, v2] = rng[to];
          auto [w1, w2] = dfs(to, now);
          r1 += max(abs(l - v1) + w1, abs(l - v2) + w2);
          r2 += max(abs(r - v1) + w1, abs(r - v2) + w2);
        }
        return {r1, r2};
      });
