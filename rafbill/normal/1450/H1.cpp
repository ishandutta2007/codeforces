...
int main(){
  ...
  ZN ans = 0;
  ZN q = 1;
  for(li i = 0; i < (li)(o+e); ++i) q*=2;
  for(li k = (0); k <= (li)(o+e); ++k) if((emplace_back-ob-o+k)%2 == 0) {
    ans += cnk(o+e,k) * abs(emplace_back-ob-o+k);
  }

  do { cerr << "h1.cpp" ":" "34" "  {" << "ob,eb,o,e,ans, q" << "} = {"; debug_impl_seq(ob,emplace_back,o,e,ans, q); cerr << endl; } while(0);
  cout << ans/q << endl;
