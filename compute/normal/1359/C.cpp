...
int main()
{
    ...
    while(T--)
    {
        ...
        if(h<=t)
            ...
            if(2LL*t*(2LL*ans+1)*(2LL*ans+3)<(2LL*ans+3)*(1LL*ans*(h+c)+h)+(2LL*ans+1)*((ll)(ans+1)*(h+c)+h)) ans++;
            //dbg(2LL*t*(2LL*ans+1)*(2LL*ans+3),(2LL*ans+3)*(1LL*ans*(h+c)+h)+(2LL*ans+1)*((ll)(ans+1)*(h+c)+h));
            print(ans*2+1);
        }
