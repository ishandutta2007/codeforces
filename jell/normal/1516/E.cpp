#line 1 "codeforces-workspace/contest/1516/e/e.cpp"
...
#line 6 "codeforces-workspace/contest/1516/e/e.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace/contest/1516/e/e.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace/contest/1516/e/e.cpp"
...
#line 28 "codeforces-workspace/contest/1516/e/e.cpp"
...
void main() {
  ...
  vector<mint> bi(k * 2 + 1);
  bi[0] = 1;
  for (auto i : range(bi.size() - 1)) {
    bi[i + 1] = bi[i] / (i + 1) * (n - i);
  }
  for (auto c : range(k + 1)) {
    for (auto m : range(bi.size())) {
      auto invs = m - c;
      if (k < invs) continue;
      ways[invs] += dp[c][m] * fact(m) * bi[m];
    }
  }
  for (auto i : range(2, 1 + k)) {
    ways[i] += ways[i - 2];
  }
