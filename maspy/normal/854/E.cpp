...
#line 2 "/home/maspy/compro/library/other/rectanglesums.hpp"
...
void solve() {
  ...
  RectangleSums<ll, 1> RS(N);
  FOR(i, N) { RS.add_pt(i + 1, A[i], 1); }

  auto C = [&](ll n) -> ll { return n * (n - 1) / 2; };
  ...
  FOR_(Q) {
    LL(l, d, r, u);
    ll ANS = C(N);
    RS.add_rect(0, 0, l, N + 1);
    RS.add_rect(r + 1, 0, N + 1, N + 1);
    RS.add_rect(0, 0, N + 1, d);
    RS.add_rect(0, u + 1, N + 1, N + 1);
    RS.add_rect(0, 0, l, d);
    RS.add_rect(r + 1, 0, N + 1, d);
    RS.add_rect(0, u + 1, l, N + 1);
    RS.add_rect(r + 1, u + 1, N + 1, N + 1);
  }
  auto res = RS.calc();
