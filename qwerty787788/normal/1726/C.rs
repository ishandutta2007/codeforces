pub mod solution {
//{"name":"C.    Jatayu","group":"Codeforces - Codeforces Round #819 (Div. 1 + Div. 2) and Grimoire of Code Annual Contest 2022","url":"https://codeforces.com/contest/1726/problem/C","interactive":false,"timeLimit":2000,"tests":[{"input":"4\n1\n()\n3\n()(())\n3\n((()))\n4\n(())(())\n","output":"1\n2\n3\n3\n"}],"testType":"multiNumber","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null},"languages":{"java":{"taskClass":"CPravilnayaSkobochnayaPosledovatelnostJatayu"}}}
