...
static const ll N=505;
static ll n,a[N],dp[N][N],dp2[N][N];
...
ll xd(ll l,ll r)
{
    ...
    REP(i,l+1,r)
    {
        if(xd(l,i)!=-1&&xd(l,i)==xd(i,r))
        {
            return dp[l][r]=xd(l,i)+1;
        }
    }
    return dp[l][r]=-1;
}
...
ll xd2(ll l,ll r)
{
    if(dp2[l][r]!=-2) return dp2[l][r];
    if(r==l) return dp2[l][r]=0;
    if(xd(l,r)!=-1) return dp2[l][r]=1;
    dp2[l][r]=N;
    REP(i,l+1,r)
    {
        dp2[l][r]=min(dp2[l][r],xd2(l,i)+xd2(i,r));
    }
    return dp2[l][r];
}
