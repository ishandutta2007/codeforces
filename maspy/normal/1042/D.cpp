...
void yes(bool t = 1) { print(t ? "yes" : "no"); }
void no(bool t = 1) { yes(!t); }
#line 2 "/home/maspy/compro/library/ds/dynamic_segtree.hpp"

/*

L, Rroot node 
function<X(ll,ll)> defulat_fn(l,r) [l,r) 
*/
...
void solve() {
  LL(N, t);
  ll LIM = 1LL << 48;
  Dynamic_SegTree<Group_Add<int>, 10'000'000> seg(-LIM, LIM);
  ll ANS = 0;
  ll sm = 0;
  seg.multiply(0, 1);
  FOR(N) {
