...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
    pair<int,int>po[4],d[4];
    int id[4];
    for(int x=0;x<4;x++)
    cin>>po[x].first>>po[x].second,id[x]=x;
    int ans=1145141919810;
    do{
        for(int x=0;x<4;x++)
        d[x]=po[id[x]];
        ans=min(ans,abs(d[0].first-d[2].first)+abs(d[1].first-d[3].first)+abs(d[0].second-d[1].second)+abs(d[2].second-d[3].second)
                   +2*max(0,min(d[2].second,d[3].second)+min(d[0].first,d[2].first)-max(d[0].second,d[1].second)-max(d[1].first,d[3].first))
                   +2*max(0,min(d[0].second,d[1].second)+min(d[1].first,d[3].first)-max(d[2].second,d[3].second)-max(d[0].first,d[2].first)));
