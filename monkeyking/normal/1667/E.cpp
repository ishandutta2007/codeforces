...
//	if(x==1)
//	{
//		return 1LL*fac[n-x-y]*(C(n-1,y)-C(b-1,y)+mod)%mod;
//	}
//	if(y==1)
//	{
//		return 1LL*fac[n-x-y]*C(n-b,x)%mod;
//	}
//}
//
//int res[500005];
...
//	cin>>n;
//	combinatorics::init(n+1,mod);
//	b=(n-1)/2+1;
//	int suf=0;
//	for(int i=n-1;i>=0;i--)
//	{
//		int res=fac[n-1];
//		chadd(res,mod-1LL*calc(1,i)*fac[i]%mod);
//		chadd(res,mod-suf);
//		suf=(1LL*calc(i,1)*fac[i-1]+suf)%mod;
//		::res[i]=res;
//	}
//	for(int i=0;i<n;i++)
//	{
