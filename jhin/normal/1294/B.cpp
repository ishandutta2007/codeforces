                          ...
                          int m,x,n,y,z,x1,k,one,gd,x2,y2,two,mn=1e9,mid,l,r,pos,a[500003],b[500003],c[500003],d[500003];vector<long long>vr,v2[100003];long long sum,ans,num;char ch;
...
//                                }
                                  ...
                                  while(t--)
                                  {
                                      cin>>n;vector<pair<int,int> >my;int mxx=0,mxy=0;string tmp="";
                                      for(int i=0;i<n;i++)
                                      {
                                          cin>>x>>y;
                                          my.push_back({x,y});mxx=max(mxx,x);mxy=max(mxy,y);

                                      }

                                      sort(my.begin(),my.end());yes=true;x=0;y=0;
                                      ...
                                      for(int i=0;i<my.size();i++)
                                      {
                                          ...
                                          myx-=x;
                                          myy-=y;
                                          if(myx<0||myy<0){yes=false;break;}
                                          while(myx--)tmp+='R',x++;while(myy--)tmp+='U',y++;
                                      }
                                      if(yes)
                                      {
                                          cout<<"YES\n"<<tmp<<endl;
