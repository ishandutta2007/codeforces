...
main() {
    ...
    double a = 0,b = 0,c,d,e,f,g,h = 1,x,y,z;
    ...
    double rad = PI * c / 180.0;

    p1r = p1.rotate(point(0, 0), rad);
    p2r = p2.rotate(point(0, 0), rad);
    p3r = p3.rotate(point(0, 0), rad);
    p4r = p4.rotate(point(0, 0), rad);
    ...
    cout << fixed << setprecision(10) << pd.polyareaunion() << endl;
}