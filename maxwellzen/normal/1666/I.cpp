...
void solve() {
    ...
    b -= 2*n-2;
    int xsum = (a-b)/2, ysum = (a+b)/2;
    int xmid = xsum/2, ymid = ysum/2;
    int c = scan(xmid, 0), d = scan(0, ymid);
    int xdiff = c - ysum, ydiff = d - xsum;
    int x1 = (xsum-xdiff)/2, x2 = (xsum+xdiff)/2;
    int y1 = (ysum-ydiff)/2, y2 = (ysum+ydiff)/2;
