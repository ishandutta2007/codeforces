...
// Problem: E: Height All the Same (https://codeforces.com/contest/1332/problem/E)
...
using Mat = arr<MI, 2, 2>;
Mat id = {arr<MI,2>{1, 0}, arr<MI,2>{0, 1}};
...
int main() {
    ...
    if ((ll)n * m % 2 == 1)
        cout << MI(r - l + 1).pow((ll)n * m) << '\n', exit(0);

    int e = (r - l + 1) / 2 + (l % 2 == 0 && r % 2 == 0);
    int o = (r - l + 1) / 2 + (l % 2 == 1 && r % 2 == 1);
    Mat mat;
    mat[0][0] = mat[1][1] = e;
    mat[1][0] = mat[0][1] = o;
    mat = exp(mat, (ll)n * m);
