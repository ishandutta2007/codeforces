...
inline bool judge() {
    for (int i = 2;i * i <= p;++ i) {if(p % i == 0) return 1; }
    return 0;
}
...
signed main(){
    read(p);
    if(p == 1) return print("YES\n1"), 0;
    if(p == 2) return print("YES\n1\n2"), 0;
    if(p == 3) return print("YES\n1\n2\n3"), 0;
    if(p == 4) return print("YES\n1\n3\n2\n4"), 0;
    if(judge()) return print("NO"), 0;
    print("YES\n1");
    REP(i, 2, p) print(1ll * i * ksm(i - 1, p - 2) % p);
    print(p);
}
/*
