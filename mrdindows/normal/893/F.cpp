...
//
//int solve() {
//    cv::Mat image(500, 1504, CV_8UC3);
//    memset(image.data, 0, image.rows * image.cols * 3);
//    for (int i = 1; i <= 30; ++i) {
//        char filename[100] = {};
//        sprintf(filename, "1/input%03d.txt", i);
////        DBN(filename);
////        return 0;
...
//            fin >> r >> g >> b;
////            DBN(r, g, b);
//            image.at<cv::Vec3b>(i / 500, i % 500) = cv::Vec3b(b, g, r);
//        }
//        FI(500 * 500) {
//            int r, g, b;
//            fin >> r >> g >> b;
...
//            //            DBN(r, g, b);
//            image.at<cv::Vec3b>(i / 500, 502 + i % 500) = cv::Vec3b(b, g, r);
//        }
//        sprintf(filename, "1/output%03d.txt", i);
...
//            assert(r < 256 && g < 256 && b < 256);
//            //            DBN(r, g, b);
//            image.at<cv::Vec3b>(i / 500, 1004 + i % 500) = cv::Vec3b(b, g, r);
//        }
////        cv::imshow(filename, image);
////        cv::waitKey(0);
//        sprintf(filename, "1/image%03d.png", i);
...
void go(int v, int sz = -1, int hh = 0, int p = -1){
    ...
    //cout<<v+1<<": "; for(int k=0;k<h[v];++k) cout<<res[hh+k]<<' '; cout<<endl;
    tt[v].swap(res);
