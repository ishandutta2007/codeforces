...
int main () 
{
	ios_base::sync_with_stdio(false);
            ...
            ll c=0,x=0,r=n-1,cut=0;
            for(ll i=a[n-1];i>=a[0];i--)
            {
            	//x++;
            	r=binarySearchCount(a,n,i);
            	//debug(r);
            	//debug(i);
            	if(i>=a[r])
            	{
            	...
            	{
            		if((ar[r]-i*(n-r)-cut)<=k&&(ar[r]-i*(n-r)-cut)!=0)
            		{
            			c++;
            		//	debug(r);
            		//debug(i);
            	...
            	{
            		ll r1=binarySearchCount(a,n,i-1);
            		//debug(r1);
            		if((ar[r]-i*(n-r)-cut)<=k&&(ar[r1]-(i-1)*(n-r1)-cut)>k)
            		{
            			cut+=ar[r]-i*(n-r)-cut;
            			c++;
            		//	debug(r);
