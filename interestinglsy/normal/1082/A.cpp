...
////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////
ll Solve1( ll n , ll st , ll ed , ll d ){
	ll ans = 0;
	fOR0(i,32){
		ll step = d * (1LL<<(ll)i);
		if( st-step >= 1 ){
...
ll Solve2( ll n , ll st , ll ed , ll d ){
	ll ans = 0;
	fOR0(i,32){
		ll step = d * (1LL<<(ll)i);
		if( st+step <= n ){
...
int main(){
	...
	For(TwT,Testcase){
		lRead4(n,st,ed,d);
		if( (ed-st)%d == 0 || (st-ed)%d == 0 ){ printf("%lld\n",abs(ed-st)/d); continue; }
		ll ans1 = Solve1(n,st,ed,d);
		ll ans2 = Solve2(n,st,ed,d);
