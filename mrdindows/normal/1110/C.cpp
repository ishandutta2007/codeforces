...
int mem[30] = {0, 2, 6, 10, 30, 42, 126, 170, 438, 682, 1958, 2730, 8190, 10922, 28086, 43690, 131070, 174762, 524286, 699050, 1797558, 2796202, 8210126, 11184810, 32472030, 44739242};
int solve(int x) {
    int p = 0;
    for (int i = 0; i < 30; ++i) {
        if (checkbit(x, i)) {
...
int solve() {
    ...
    while (n--) {
        ...
        cin >> x;
        int y = solve(x);
        cout << gcd(y ^ x, y & x) << endl;
    }
    return 0;
//    for (int i = (1 << 25) - 1; i >= 1; --i) {
////        assert(get(i) == solve(i));
//        DBN(i, get(i), solve(i));
//    }
