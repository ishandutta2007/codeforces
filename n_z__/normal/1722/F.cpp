...
if(mp[x][y]==1)
{
	if(mp[x-1][y-1]+mp[x-1][y]+mp[x-1][y+1]+mp[x][y-1]+mp[x][y+1]+mp[x+1][y-1]+mp[x+1][y]+mp[x+1][y+1]!=2)ex("NO");
	if(mp[x-1][y-1]+mp[x-1][y  ]!=2&&mp[x-1][y  ]+mp[x-1][y+1]!=2&&mp[x-1][y+1]+mp[x  ][y+1]!=2
	 &&mp[x  ][y+1]+mp[x+1][y+1]!=2&&mp[x+1][y+1]+mp[x+1][y  ]!=2&&mp[x+1][y  ]+mp[x+1][y-1]!=2
	 &&mp[x+1][y-1]+mp[x  ][y-1]!=2&&mp[x  ][y-1]+mp[x-1][y-1]!=2&&(mp[x][y-1]+mp[x][y+1]!=1||mp[x-1][y]+mp[x+1][y]!=1))ex("NO"); 
}
ex("YES");
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
/*Main-end----------------------------------------------------------------------------------------*/
