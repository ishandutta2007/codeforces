...
while(1)
{
    if(prime[i+1]&&a[1]>0)v.push_back(1),a[1]--,i++;
    else if(prime[i+2]&&a[2]>0)v.push_back(2),a[2]--,i+=2;
    else if(a[2]>0)v.push_back(2),a[2]--,i+=2;
    else if(a[1]>0)v.push_back(1),a[1]--,i++;
    else break;
}
