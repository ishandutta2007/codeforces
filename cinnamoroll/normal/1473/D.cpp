...
void solve(){
  ...
  SegmentTree<int,f1,E1> mn(a);
  SegmentTree<int,f2,E2> mx(a);
  ...
  REP(_,Q){
    ...
    int mn_1 = mn.query(0,l), mx1 = mx.query(0,l);
    int mn_2 = mn.query(r,a.size()), mx2 = mx.query(r,a.size());
    int x = a[r-1]-a[l-1]; mn_2 -= x; mx2 -= x;
    cout << max(mx1,mx2) - min(mn_1,mn_2) + 1 << "\n";
  }
}
