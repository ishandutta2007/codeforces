...
bool check1(vpii v)
{
    ...
    while (cnt--)
    {
        ...
        if (!dot(v[0]-v[1],v[1]-v[2]) && !dot(v[1]-v[2],v[2]-v[3]) && !dot(v[2]-v[3],v[3]-v[0]) && !dot(v[3]-v[0],v[0]-v[1])) return true;
    }
    return false;
}
...
bool check2(vpii v)
{
    ...
    {
        random_shuffle(ALL(v));
        if (!dot(v[0]-v[1],v[1]-v[2]) && !dot(v[1]-v[2],v[2]-v[3]) && !dot(v[2]-v[3],v[3]-v[0]) && !dot(v[3]-v[0],v[0]-v[1]))
        {
            if (dot(v[0]-v[1],v[0]-v[1]) == dot(v[1]-v[2],v[1]-v[2]) &&dot(v[1]-v[2],v[1]-v[2]) == dot(v[2]-v[3],v[2]-v[3]) && dot(v[3]-v[0],v[3]-v[0]) == dot(v[2]-v[3],v[2]-v[3])) return true;
        }
    }
    return false;
}
...
int main () {
    ...
    REP0(mask,(1<<n))
    {
        ...
        if (SZ(v1) != SZ(v0)) continue;
        if (check1(v1) && check2(v0))
        {
            puts("YES");
            Pvec(_);
            Pvec(__);
