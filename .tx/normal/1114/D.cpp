...
int main(int argc, char** argv) {
    ...
    auto rel = [](int& x, int y) { x = min(x, y); };
    ...
    for (int len = 2; len <= n; len++) {
        for (int l = 0; l + len <= n; l++) {
            ...
            d[l][r][1] = 1e9;
            d[l][r][0] = 1e9;
            rel(d[l][r][1], d[l][r - 1][0] + (a[l] != a[r]));
            rel(d[l][r][1], d[l][r - 1][1] + (a[r - 1] != a[r]));
            rel(d[l][r][0], d[l + 1][r][0] + (a[l] != a[l + 1]));
            rel(d[l][r][0], d[l + 1][r][1] + (a[l] != a[r]));
        }
    }

    cout << min(d[0][n - 1][0], d[0][n - 1][1]);
