...
public class E {
	...
	public void solve() {
		...
		long l10 = in.nextInt();
		System.out.println("? " + min + " " + (min + l00 + (max - l01)) / 2);
		long x1 = min + in.nextLong();
		System.out.println("? " + (min + l00 + (max - l10)) / 2 + " " + min);
		long y1 = min + in.nextLong();
		System.out.println("? " + max + " " + (min + l00 + (max - l01)) / 2);
		long x2 = max - in.nextLong();
		System.out.println("? " + (min + l00 + (max - l10)) / 2 + " " + max);
		long y2 = max - in.nextLong();
