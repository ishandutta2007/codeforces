...
int main() {
  ...
  ModInt a000085[N + 1]{};
  a000085[0] = a000085[1] = 1;
  FOR(i, 2, N + 1) a000085[i] = a000085[i - 1] + a000085[i - 2] * (i - 1);
  ...
  while (t--) {
    ...
    ModInt ans = 0;
    for (int i = 0; i * 4 <= n; ++i) {
      ans += a000085[n - i * 4] * ModInt::fact(2 * i) * ModInt::fact_inv(i) * ModInt::nCk(n - i * 4 + i * 2, i * 2);
    }
    cout << ans << '\n';
  }
  return 0;
