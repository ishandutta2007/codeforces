...
inline PII calc_h(int z, int l, int r)
{
	PII ans;
...
inline int calc(int k, int l, int len, PII hh)
{
	return hfind(k, hh);
//	return y[k][hh];
/*	int ans = 0;
