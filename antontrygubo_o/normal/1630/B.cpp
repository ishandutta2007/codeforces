...
void solve()
{
    ...
    //need to select smallest segment containing need numbers;
    ...
    for (int i = 0; i<k; i++) cout<<breakpoints[i]+2<<' '<<breakpoints[i+1]+1<<endl;
}
