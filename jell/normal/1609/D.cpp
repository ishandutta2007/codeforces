#line 1 "codeforces-workspace\\contest\\1609\\d\\d.cpp"
...
#line 13 "codeforces-workspace\\contest\\1609\\d\\d.cpp"
...
#line 29 "codeforces-workspace\\contest\\1609\\d\\d.cpp"
...
void main() {
  ...
  while (m--) {
    ...
    for (auto i : range(n)) {
      if (uf.find(i) == i) {
        s.emplace_back(uf.size(i));
      }
    }
    nth_element(begin(s), end(s) - k, end(s));
    auto ans = 0;
    for (auto t : range(k)) {
      ans += s.back();
      s.pop_back();
