#line 1 "codeforces-workspace/contest/1515/e/e.cpp"
...
#line 6 "codeforces-workspace/contest/1515/e/e.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace/contest/1515/e/e.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace/contest/1515/e/e.cpp"
...
#line 27 "codeforces-workspace/contest/1515/e/e.cpp"
...
void main() {
  ...
  auto dp = make_vector<mint>({n + 1, 2, n + 1}, 0);
  dp[0][0][0] = 1;

  for (auto t : range(1, n + 1)) {
    auto tmp = make_vector<mint>({n + 1, 2, n + 1}, 0);

    for (auto j : range(t + 1)) {  // count
      // not choose
      {
        auto &nx = tmp[j][0][0];
        for (auto &&v : dp[j]) {
  ...
  for (auto &&vv : dp) {
    for (auto &&v : vv) {
      for (auto i : range(n)) {  // must put last
        ans += v[i + 1];
      }
    }
  }
