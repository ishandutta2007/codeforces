...
void solve()
{
	...
	{
		int L, R;
		int l0, l1, r0, r1, l01, l10, r01, r10, m01, m10, rev;
	};
	auto initialize = [](node& it, int id) -> void
	{
		...
		it.l01 = it.l10 = it.r01 = it.r10 = it.m01 = it.m10 = 1;
		it.rev = 0;
	};
	auto merge = [&](node& it, const node& Lc, const node& Rc) -> void
	{
		...
		it.R = Rc.R;
		it.l0 = Lc.l0;
		if (Lc.l0 == Lc.R - Lc.L + 1) it.l0 = Lc.l0 + Rc.l0;
		it.r0 = Rc.r0;
		if (Rc.r0 == Rc.R - Rc.L + 1) it.r0 = Rc.r0 + Lc.r0;
		it.l1 = Lc.l1;
		if (Lc.l1 == Lc.R - Lc.L + 1) it.l1 = Lc.l1 + Rc.l1;
		it.r1 = Rc.r1;
		if (Rc.r1 == Rc.R - Rc.L + 1) it.r1 = Rc.r1 + Lc.r1;

		it.l01 = Lc.l01;
		if (Lc.l0 == Lc.R - Lc.L + 1) it.l01 = Lc.l0 + Rc.l01;
		else if (Lc.l01 == Lc.R - Lc.L + 1) it.l01 = Lc.l01 + Rc.l1;
		it.l10 = Lc.l10;
		if (Lc.l1 == Lc.R - Lc.L + 1) it.l10 = Lc.l1 + Rc.l10;
		else if (Lc.l10 == Lc.R - Lc.L + 1) it.l10 = Lc.l10 + Rc.l0;

		it.r01 = Rc.r01;
		if (Rc.r1 == Rc.R - Rc.L + 1) it.r01 = Rc.r1 + Lc.r01;
		else if (Rc.r01 == Rc.R - Rc.L + 1) it.r01 = Rc.r01 + Lc.r0;
		it.r10 = Rc.r10;
		if (Rc.r0 == Rc.R - Rc.L + 1) it.r10 = Rc.r0 + Lc.r10;
		else if (Rc.r10 == Rc.R - Rc.L + 1) it.r10 = Rc.r10 + Lc.r1;

		it.m01 = max({ Lc.m01, Rc.m01, Lc.r0 + Rc.l01, Lc.r01 + Rc.l1 });
		it.m10 = max({ Lc.m10, Rc.m10, Lc.r1 + Rc.l10, Lc.r10 + Rc.l0 });
	};
