...
LL bzhash[maxn][18],powc[maxn],hasha[maxn];
int bzfa[maxn][18],dis1[maxn],dis2[maxn],sa[maxn],bak[maxn],f1[maxn],f2[maxn],flag[maxn],which[maxn],fa1[maxn],fa2[maxn],fac1[maxn],fac2[maxn];
PII qj[maxn];
