...
long long n,m,d,nn=0,nm,pc[100069],pst[1ll<<4],tmp[1ll<<4];
array<long long,1ll<<4> a0,ca[2];
pair<long long,array<long long,1ll<<4>> as[2][100069];

void bd(long long mk)
{
	long long i,j,sz,e;
