...
const int maxn = 3e5 + 100, maxw = 1e6 + 100, inf = 1e9 + 100, sq = 450, LG = 18, mod = 1e9 + 933, mod1 = 1e9 + 993;

int q[4 * maxn], up[4 * maxn], mas[maxn], fen[maxn], n;
