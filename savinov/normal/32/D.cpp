...
{
    int r, x, y;
    inline bool operator<(const star & rh) const
    {
        return r < rh.r || (r == rh.r && x < rh.x) || (r == rh.r && x == rh.x && y < rh.y);
    }
};
...
int main()
{
    ...
    {
        --kk;
        nth_element(v.begin(), v.begin() + kk, v.end());
        cout << v[kk].x << " " << v[kk].y << endl;
        cout << v[kk].x - v[kk].r << " " << v[kk].y << endl;
        cout << v[kk].x + v[kk].r << " " << v[kk].y << endl;
        cout << v[kk].x << " " << v[kk].y - v[kk].r << endl;
        cout << v[kk].x << " " << v[kk].y + v[kk].r << endl;
    }
    return 0;
}