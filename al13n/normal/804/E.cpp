...
vector<pii> solve(int n){
  vector<pii> pre4={{0,1},{0,2},{1,3},{0,3},{1,2},{2,3}};
  vector<pii> pre5={{0,1},{0,2},{0,3},{1,2},{1,4},{2,4},{0,4},{2,3},{1,3},{3,4}};

  vector<pii> R=n%4?pre5:pre4;
  for(int k=4+n%4;k<n;k+=2){
    if(n%2)
      R.pb(mp(0,k));
    R.pb(mp(k,k+1));
    if(n%2)
