...
fun main(){
//    val a = intArrayOf(3,5,7)
//    for(o in 0 until 10){
//        o dei( BinarySearchLastTrue(0,2){a[it] <= o} ?: -7)
//    }
    ...
    solve.cases{
        ...
        put(BinarySearchLastTrue(0,n){
            v ->
            var taken = 0
            for(i in 0 until n){
                if(B[i] >= taken && A[i] >= (v - 1 - taken)){
                    taken ++
                    if(taken == v) return@BinarySearchLastTrue true
                }
            }
