...
//            }
//        }
//        val base = leaf.count {!it }
//        val DPtake = IntArray(n)
//        val DPnottake = IntArray(n)
//
//        var ret = 0
//
//        G.leafFirst { v ->
//            if(leaf[v]) return@leafFirst
//            var take = if(!hasleaf[v]) 1 else 0
//            var nottake = 0
//            G.subs(v){
//                w->
//                if(leaf[w]) return@subs
//                nottake += maxOf(DPtake[w],DPnottake[w])
//                take += DPnottake[w]
//            }
//            DPtake[v] = take
//            DPnottake[v] = nottake
//            ret= maxOf(ret, take, nottake)
//        }
//
//        put(base - ret - 1)
...
obseravtion: no need leaf
so has leaf/ no leaf is enough \
