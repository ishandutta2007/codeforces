    ...
    */
    ...
    REP(tc,1,ntc+1)
    {
        ...
        while(pr.size()>0)
        {
            ...
            if(t.F!=0)
            {
                if(a[t.F-1][t.S]==a[t.F][t.S]&&ans[t.F-1][t.S]=='0')
                {
                    pr.push(MP(t.F-1,t.S));
                    ans[t.F-1][t.S]='D';
                }
            }
            if(t.F!=n-1)
            ...
            if(t.S!=0)
            {
                if(a[t.F][t.S-1]==a[t.F][t.S]&&ans[t.F][t.S-1]=='0')
                {
                    pr.push(MP(t.F,t.S-1));
                    ans[t.F][t.S-1]='R';
                }
            }
            if(t.S!=n-1)
