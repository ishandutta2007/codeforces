                        ...
                        rep(gy, 2) {
                            rep(gz, 2) {
                                rep(bit, (1<<3)) {
                                    ...
                                    int b = kth_bit(bit, 1);
                                    int c = kth_bit(bit, 2);
                                    if(!fa && val < a) continue;
                                    if(!fb && val < b) continue;
                                    if(!fc && val < c) continue;
                                    int na = fa | (a < val);
                                    int nb = fb | (b < val);
                                    int nc = fc | (c < val);
                                    int x = (a ^ b);
                                    ...
                                    int ny = gy | (y & z);
                                    int nz = gz | (z & x);
                                    dp[i + 1][na][nb][nc][nx][ny][nz] += dp[i][fa][fb][fc][gx][gy][gz];
                                }
                            }
                        }  
                    }
