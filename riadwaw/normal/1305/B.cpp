...
public:
	...
	void solve(std::istream& in, std::ostream& out) {
		...
		in >> s;
		int bestAns = 0;
		for (int mid: range(s.size())) {
			updateMax(bestAns, (int) min(count(s.begin(), s.begin() + mid, '('), count(s.begin() + mid, s.end(), ')')));
		}
