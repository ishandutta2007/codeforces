#line 1 "codeforces-workspace\\contest\\1161\\b\\b.cpp"
...
#line 11 "codeforces-workspace\\contest\\1161\\b\\b.cpp"
...
void main() {
  ...
  input<int> n, m;
  input<vector<pair<i32, i32>>> segs(m);
  ...
  for (auto k : range(1, n)) {
    ...
    for (auto [a, b] : segs) {
      a = (a + k) % n;
      b = (b + k) % n;
      if (us.count({a, b}) == 0 && us.count({b, a}) == 0) {
        fail = 1;
        break;
      }
    }
