#line 1 "codeforces-workspace\\contest\\1408\\b\\b.cpp"
...
#line 6 "codeforces-workspace\\contest\\1408\\b\\b.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace\\contest\\1408\\b\\b.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace\\contest\\1408\\b\\b.cpp"
...
void main() {
  ...
  vector<int> a(n);
  cin >> a;
  auto m = unique(begin(a), end(a)) - begin(a);
  if (k == 1) {
    eject((m == 1 ? "1" : "-1"));
  }
  if (m == 1) eject(1);
  cout << ceil_div(m - 1, k - 1) << eol;
}
