#line 1 "codeforces-workspace\\contest\\1667\\e\\e.cpp"
...
#line 9 "Library\\src\\algebra\\fft.hpp"
...
#line 15 "Library\\src\\algebra\\fft.hpp"
...
#line 11 "codeforces-workspace\\contest\\1667\\e\\e.cpp"
namespace workspace {
...
void main() {
  ...
  e *= f;
  e.erase(e.begin(), e.begin() + f.size() - 1);
  e.resize(N - 1);
  e.emplace(e.begin(), 0);

  for (auto i = f.size(); i < N; ++i) {
    f.emplace_back(f.back() * i);
  }
