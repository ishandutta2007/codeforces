...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
    int k,l,r,p;
    cin>>k>>l>>r>>p;
    auto f=[=](int x)->int{if(k%p)return qp(k,qp(2,x,p-1),p);else return 0;};
    if(p<3)cout<<1-k%2<<endl;
    else cout<<((f(l)-1?(f(r+1)-1)*qp(f(l)-1,p-2,p)%p:qp(2,r-l+1,p))*(k&1?qp(qp(2,r-l,p),p-2,p):1)%p+p)%p<<endl;
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
/*Main-end----------------------------------------------------------------------------------------*/
}
/*Main-end----------------------------------------------------------------------------------------*/
