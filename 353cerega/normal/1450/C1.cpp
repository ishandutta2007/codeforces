...
int main() {
    ...
    while (t--)
    {
        ...
        if (cnt0[0]<=cnt0[1] and cnt0[0]<=cnt0[2])
        {
            for (int i=0;i<n;i++) {
                for (int j = 0; j < n; j++) {
                    if ((i+j)%3==0 and kek[i][j]=='X')
                    {
                        kek[i][j] = 'O';
                    }
                }
        ...
        if (cnt0[1]<=cnt0[0] and cnt0[1]<=cnt0[2])
        {
            for (int i=0;i<n;i++) {
                for (int j = 0; j < n; j++) {
                    if ((i+j)%3==1 and kek[i][j]=='X')
                    {
                        kek[i][j] = 'O';
                    }
                }
        ...
        if (cnt0[2]<=cnt0[1] and cnt0[2]<=cnt0[0])
        {
            for (int i=0;i<n;i++) {
                for (int j = 0; j < n; j++) {
                    if ((i+j)%3==2 and kek[i][j]=='X')
                    {
                        kek[i][j] = 'O';
                    }
                }
