    ...
    //                        }
                        ...
                        while(t--)
                        {
                            cin>>s;vector<int>v;int siz=s.size();
                            for(int i=0;i<siz-2;i++)
                            {
                                if(i<siz-4)
                                {if(s[i]=='t'&&s[i+1]=='w'&&s[i+2]=='o'&&s[i+3]=='n'&&s[i+4]=='e')v.push_back(i+3),i+=4;
                                else {
                                if(s[i]=='o'&&s[i+1]=='n'&&s[i+2]=='e')v.push_back(i+2);


                                else if(s[i]=='t'&&s[i+1]=='w'&&s[i+2]=='o')v.push_back(i+2);
                                }}
                                else
                                {
                                   if(s[i]=='o'&&s[i+1]=='n'&&s[i+2]=='e')v.push_back(i+2);
