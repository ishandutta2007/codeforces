...
signed main() {
  ...
  bool ok = false;
  do {
    if (S[0] == W[0] && S[1] == W[1]) continue;
    if (S[0] == W[1] && S[1] == W[2]) continue;
    if (S[0] == W[2] && S[1] == W[0]) continue;
    if (T[0] == W[0] && T[1] == W[1]) continue;
    if (T[0] == W[1] && T[1] == W[2]) continue;
    if (T[0] == W[2] && T[1] == W[0]) continue;
    ok = true;
    break;
