pub mod solution {
//{"name":"A.  ","group":"Codeforces - CodeTON Round 1 (Div. 1 + Div. 2, Rated, Prizes!)","url":"https://codeforces.com/contest/1656/problem/0","interactive":false,"timeLimit":1000,"tests":[{"input":"3\n3\n5 2 7\n5\n1 4 2 2 3\n1\n2\n","output":"2 3\n1 2\n1 1\n"}],"testType":"multiNumber","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null},"languages":{"java":{"taskClass":"AKhoroshiePari"}}}
