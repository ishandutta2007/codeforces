...
ll root(ll a,ll b)
{
//	return floor(pow((long double) a, 1.L / b));
...
int main()
{
	//cout<<fixed<<setprecision(100)<<pow(pow(2.L, 59) - 1, 1.L / 59)<<endl;
	...
	//for (int i=2;i<=59;++i) cout<<i<<' '<<hiu[i]<<' '<<naj[i]<<endl;
	cin.tie(0);
	cin>>n;
