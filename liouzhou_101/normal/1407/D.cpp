...
void solve()
{
...

	{
		...
		for (int i = 2; i <= n; ++i)
		{
			...
			{
				G.addedge(q1.back(), i, 1);
				q1.pop_back();
			}
			q1.push_back(i);
			while (!q2.empty() && a[q2.back()] <= a[i])
			{
				G.addedge(q2.back(), i, 1);
				q2.pop_back();
			}
			q2.push_back(i);
		}
...

	{
		...
		for (int i = 2; i <= n; ++i)
		{
			...
			while (!q1.empty() && a[q1.back()] >= a[i])
			{
				G.addedge(n - i + 1, n - q1.back() + 1, 1);
				q1.pop_back();
			}
			q1.push_back(i);
			while (!q2.empty() && a[q2.back()] <= a[i])
			{
				G.addedge(n - i + 1, n - q2.back() + 1, 1);
				q2.pop_back();
			}
			q2.push_back(i);
		}
