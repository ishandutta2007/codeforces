#line 1 "codeforces-workspace/contest/1466/d/d.cpp"
/**
 * @file template.cpp
 * @brief Template
 */
...
#line 16 "codeforces-workspace/contest/1466/d/d.cpp"
...
void main() {
  ...
  for (auto i = 1; i < n; ++i) {
    if (i > 1) {
      while (vs.back().second == 1) vs.pop_back();
      auto &[x, y] = vs.back();
      --y;
      ans += x;
    }
