#line 1 "codeforces-workspace\\contest\\1586\\a\\a.cpp"
...
#line 13 "codeforces-workspace\\contest\\1586\\a\\a.cpp"
...
#line 29 "codeforces-workspace\\contest\\1586\\a\\a.cpp"

namespace workspace {

least_factor<300300> lpf;
...
void main() {
  ...
  if (lpf(s) == s) {
    auto pos =
        find_if(begin(a), end(a), [](auto x) { return x & 1; }) - begin(a);
    print(n - 1);
    ans.erase(pos + 1);
    print(ans);
  } else {
