...
void DOIT()
{
    ...
    if (n%2==1 && m%2==1)
    {
        for (int j=1;j<=m;j++) cout<<j%2;cout<<"\n";
        for (int i=2;i<=n-1;i++)
        {
            cout<<i%2;
    ...
    if (n%2==0 && m%2==0)
    {
        for (int j=1;j<m;j++) cout<<(j+1)%2;cout<<"0\n";
        for (int i=2;i<=n-1;i++)
        {
            cout<<i%2;
            for (int j=2;j<m;j++) cout<<0;
        ...
        cout<<0;
        for (int j=2;j<=m;j++) cout<<j%2;cout<<"\n";
    }
    if (n%2==1 && m%2==0)
    {
        for (int j=1;j<=m;j++) cout<<(j+1)%2;cout<<"\n";
        for (int i=2;i<=n-1;i++)
        {
            cout<<i%2;
            for (int j=2;j<m;j++) cout<<0;
