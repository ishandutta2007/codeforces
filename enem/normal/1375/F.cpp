    ...
    REP(tc,1,ntc+1)
    {
        ...
        while(true)
        {
            ...
            else if(f==1)
            {
                if(a>b&&a>c)
                {
                    if(abs(b-c)+max(b,c)==a)
                    {
                        cout<<abs(b-c)<<endl;
                        cin>>f;
                        if(f==1) a+=abs(b-c);
                        else if(f==2) b+=abs(b-c);
                        else if(f==3) c+=abs(b-c);
                        else return 0;
                    }
                    else
                    {
                        ...
                        cin>>f;
                        if(f==1) a+=2*a-b-c;
                        else if(f==2) b+=2*a-b-c;
                        else if(f==3) c+=2*a-b-c;
                        else return 0;
                    }
                }
                else
            ...
            else if(f==2)
            {
                if(b>a&&b>c)
                {
                    if(abs(a-c)+max(a,c)==b)
                    {
                        cout<<abs(a-c)<<endl;
                        cin>>f;
                        if(f==1) a+=abs(a-c);
                        else if(f==2) b+=abs(a-c);
                        else if(f==3) c+=abs(a-c);
                        else return 0;
                    }
                    else
                    {
                        ...
                        cin>>f;
                        if(f==1) a+=2*b-a-c;
                        else if(f==2) b+=2*b-a-c;
                        else if(f==3) c+=2*b-a-c;
                        else return 0;
                    }
                }
                else
            ...
            else if(f==3)
            {
                if(c>b&&c>a)
                {
                    if(abs(b-a)+max(b,a)==c)
                    {
                        cout<<abs(b-a)<<endl;
                        cin>>f;
                        if(f==1) a+=abs(b-a);
                        else if(f==2) b+=abs(b-a);
                        else if(f==3) c+=abs(b-a);
                        else return 0;
                    }
                    else
                    {
                        ...
                        cin>>f;
                        if(f==1) a+=2*c-b-a;
                        else if(f==2) b+=2*c-b-a;
                        else if(f==3) c+=2*c-b-a;
                        else return 0;
                    }
                }
                else
