#line 1 "codeforces-workspace\\contest\\634\\a\\a.cpp"
#include <bits/extc++.h>
...
#line 7 "codeforces-workspace\\contest\\634\\a\\a.cpp"
namespace workspace {
struct solver;
}  // namespace workspace
...
struct workspace::solver {
  solver() {
    ...
    vector<int> a(n), b(n);
    cin >> a >> b;
    auto pos = find(begin(a), end(a), 0);
    a.erase(pos);
    pos = find(begin(b), end(b), 0);
    b.erase(pos);
    pos = find(begin(b), end(b), a.front());
    rotate(begin(b), pos, end(b));
    if (a == b)
      cout << "YES\n";
    else
      cout << "NO\n";
