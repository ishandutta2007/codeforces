...
#endif
#line 2 "Contests/Codeforces_1628/D2/main.cpp"
using namespace std;
...
#line 17 "Contests/Codeforces_1628/D2/main.cpp"
...
void init()
{
  ...
  for (int i = 1; i < 3000000; ++i)
  {
    ...
    if (i != 1)
    {
      two_back[i] = two_back[i - 1] * two_back[1];
    }
  }
}
void solve()
{
  ...
  for (int i = m; i >= 1; --i)
  {
    mint tmp = comb(n - i, m - i);
    ans += i * (tmp - back_memo) * two_back[n - i];
    back_memo = tmp;
  }
  ans *= k;
