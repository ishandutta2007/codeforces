#line 1 "codeforces-workspace/contest/1469/d/d.cpp"
/**
 * @file template.cpp
 * @brief Template
 */
...
#line 16 "codeforces-workspace/contest/1469/d/d.cpp"
...
void main() {
  ...
  vector<pair<int, int>> ans;
  {
    ...
    if (n > 2) {
      ans.emplace_back(n, q);
      ans.emplace_back(n, q);
    }
    for (auto i = 2; i < n; ++i) {
      if (i != p and i != q) ans.emplace_back(i, n);
    }
  }
