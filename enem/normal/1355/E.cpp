        ...
        while(l<=r)
        {
            if(r-l<=10)
            {
                REP(t,l,r+1)
                {
                    ...
                    ll tt=min(x*rr+y*a,min(x,y)*m+(x-min(x,y))*rr+(y-min(x,y))*a);
                    ans=min(tt,ans);
                }
                break;
            }
            else
            {
                ...
                ll tt1=min(x*rr+y*a,min(x,y)*m+(x-min(x,y))*rr+(y-min(x,y))*a);
                x=0,y=0;
                REP(i,0,n)
                {
                    x+=max(0LL,h[i]-t2);
                ...
                ll tt2=min(x*rr+y*a,min(x,y)*m+(x-min(x,y))*rr+(y-min(x,y))*a);
                if(tt1<=tt2)
                {
                    r=t2;
                }
