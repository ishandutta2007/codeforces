...
int main() {
    ...
    if (x[0]==x[1] && x[1]==x[2]) {cout<<1; return 0;}
    if (y[0]==y[1] && y[1]==y[2]) {cout<<1; return 0;}
    ...
    do{
        if(a[b[0]].first == a[b[1]].first && a[b[2]].second >= a[b[1]].second && a[b[2]].second >= a[b[0]].second) {cout<<2; return 0;}
        if(a[b[0]].first == a[b[1]].first && a[b[2]].second <= a[b[1]].second && a[b[2]].second <= a[b[0]].second) {cout<<2; return 0;}
        if (a[b[0]].second == a[b[1]].second && a[b[2]].first >= a[b[1]].first && a[b[2]].first >= a[b[0]].first) {cout<<2; return 0;}
        if (a[b[0]].second == a[b[1]].second && a[b[2]].first <= a[b[1]].first && a[b[2]].first <= a[b[0]].first) {cout<<2; return 0;}
