...
static ll n,q,l,r,t,a[N],ans[N],sqr;
static tuple<ll,ll,ll> b[N];
static unordered_map<ll,ll> mp;

bool xd(tuple<ll,ll,ll> &t1,tuple<ll,ll,ll> &t2)
{
    if((G(0,t1)/sqr)==(G(0,t2)/sqr)) return G(1,t1)<G(1,t2);
    else return G(0,t1)<G(0,t2);
}
