 ...
 * created: 24.04.2022 13:05
 * problem: D. Evolution of Weasels
 * url:     https://codeforces.com/contest/1662/problem/D
 */
// <impyster.hpp>
...
std::string ac_stack(const std::string &s) {
  std::string res;
...
int main() {
  ...
  while (T--) {
    ...
    if (a % 2 || b % 2 || c % 2 || ac_stack(s) != ac_stack(t))
      print("NO");
    else
      print("YES");
  }
