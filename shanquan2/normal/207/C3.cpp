...
const long long B=987654323LL;
vector<int> tt[100100],tc[100100];
vector<pair<long long,int> > hp;
long long hsh[100100],pw[100100],rv[100100],tr[400400],tg[400400],ct[100100],ans[100100];
int sz[100100],fd[100100],fa[100100][17],fa1[100100],tot=0,lst[100100],rt[100100];
...
//			}
		...
		for(int j=16;j>=0;j--){
			int t=fa[y][j];
			long long tmp=hsh[i]-hsh[t]*pw[dep[i]-dep[t]];
