...
bool win_e(int e, int o);

map<pair<int, int>, bool> memo_o, memo_e;

bool win_o(int e, int o) {
    if (e == 0 && o == 0) {
        return false;
    }
    auto key = make_pair(e, o);
    if (memo_o.count({key})) return memo_o[key];
    int s = o % 2;
    if (e) {
        if (s && !win_o(e - 1, o)) {
            return memo_o[key] = true;
        }
        if (!s && !win_e(e - 1, o)) {
            return memo_o[key] = true;
        }
...
bool win_e(int e, int o) {
    ...
    auto key = make_pair(e, o);
    if (memo_e.count({key})) return memo_e[key];
    int s = o % 2;
    if (e) {
        if (s && !win_e(e - 1, o)) {
            return memo_e[key] = true;
        }
        if (!s && !win_o(e - 1, o)) {
            return memo_e[key] = true;
        }
