...
/*link https://codeforces.com/contest/1034/problem/0 */
/*input
3
1 2 4
*/
...
int main () {
	...
	vi primes;
	{
		const int rib = sqrt(15000040) + 10;
		bool lent[rib] = {};
	...
	for (auto && i : mii) {
		mini(reikia, n - i.second);
	}

	if (reikia >= n or reikia == 0) {
		cout << "-1\n";
	}
	else
		cout << reikia << endl;
