...
int main()
{
    ...
    REP(tc,1,ntc+1)
    {
        ...
        REP(i,0,m)
        {
            ...
            t1--;t2--;
            ad[t1].PB(MP(t2,t3));
            ad[t1].PB(MP(n+t2,0LL));
            ad[t1].PB(MP(2*n+t2,2*t3));
            ad[t1].PB(MP(3*n+t2,t3));
            ad[n+t1].PB(MP(n+t2,t3));
            ad[n+t1].PB(MP(3*n+t2,2*t3));
            ad[2*n+t1].PB(MP(2*n+t2,t3));
            ad[2*n+t1].PB(MP(3*n+t2,0LL));
            ad[3*n+t1].PB(MP(3*n+t2,t3));
            swap(t1,t2);
            ad[t1].PB(MP(t2,t3));
            ad[t1].PB(MP(n+t2,0LL));
            ad[t1].PB(MP(2*n+t2,2*t3));
        ...
        while(!pr.empty())
        {
            ...
            if(!vis[t.S])
            {
                ...
                for(auto it:ad[t.S])
                {
                    if(!vis[it.F]) pr.push(MP(t.F-it.S,it.F));
                }
            }
        }
