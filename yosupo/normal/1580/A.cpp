...
void solve() {
    ...
    VV<int> g(h, V<int>(w));
    VV<int> gs0(h + 1, V<int>(w + 1));
    VV<int> gs1(h + 1, V<int>(w + 1));
    for (int r = 0; r < h; r++) {
        string s;
        sc.read(s);
        for (int c = 0; c < w; c++) {
    ...
    for (int r = 0; r <= h; r++) {
        for (int c = 0; c <= w; c++) {
            ...
            if (r && c) {
                gs0[r][c] -= gs0[r - 1][c - 1];
                if (g[r - 1][c - 1] == 0) gs0[r][c]++;

                gs1[r][c] -= gs1[r - 1][c - 1];
                if (g[r - 1][c - 1] == 1) gs1[r][c]++;
            }
        }
    }
        ...
        for (int r1 = r0 + 5; r1 <= h; r1++) {
            ...
            for (int c = 4; c <= w; c++) {
                // add c - 4
                {
                    int c0 = c - 4;
                    int now = 0;
                    now += (gs0[r1 - 1][c0 + 1] - gs0[r1 - 1][c0] - gs0[r0 + 1][c0 + 1] + gs0[r0 + 1][c0]);                    
                    now -= (gs0[r1][c0 + 1] - gs0[r1 - 1][c0 + 1]);
                    now -= (gs0[r0 + 1][c0 + 1] - gs0[r0][c0 + 1]);
                    now -= (gs1[r1 - 1][c0 + 1] - gs1[r0 + 1][c0 + 1]);
                    mi = min(mi, now);
                }
                int now = 0;
                now += (gs0[r1 - 1][c] - gs0[r1 - 1][c - 1] - gs0[r0 + 1][c] + gs0[r0 + 1][c - 1]);
                now += (gs0[r1][c - 1] - gs0[r1 - 1][c - 1]);
                now += (gs0[r0 + 1][c - 1] - gs0[r0][c - 1]);
                now += (gs1[r1 - 1][c - 1] - gs1[r0 + 1][c - 1]);
