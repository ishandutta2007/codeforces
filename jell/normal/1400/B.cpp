...
#line 3 "codeforces-workspace\\contest\\1400\\b\\b.cpp"
#include <bits/extc++.h>
...
#line 12 "codeforces-workspace\\contest\\1400\\b\\b.cpp"
namespace workspace {
    constexpr char eol = '\n';
...
solver()
{
    i64 p,f,cs,cw,s,w; cin>>p>>f>>cs>>cw>>s>>w;
    if(s>w)
    {
        swap(s,w);
        swap(cs,cw);
