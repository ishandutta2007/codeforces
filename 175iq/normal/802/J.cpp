...
//Input
//The first line of the input contains the number of friends n (3n100). 
//The next n-1 lines each contain three space-separated integers u, v and c (0u,vn-1, 1c104),
//meaning that u and v are friends (know each other directly) and the cost for travelling between u and v is c.
//
