...
void solve(int test_case = 0) {
	// lets say you have some bit and you wanna fix this
	// then you take all elements containing the bit meaning you take 1<<bit-1 + 1 .. 1<<bit
	int l, r;
	cin >> l >> r;
	int ans = r - l;
	for(int i = 0; i < 20; i++) {
		ans = min(ans, (r - l + 1) - (bit[r][i] - bit[l - 1][i]));
	}
	cout << ans << "\n";
}
void precalc() {
