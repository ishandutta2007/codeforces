    ...
    REP(tc,1,ntc+1)
    {
        ...
        REP(i,0,n)
        {
            REP(j,0,m)
            {
                ...
                {
                    a[i][j]=1;
                    if((i==0||i==n-1)&&(j==0||j==m-1)) ans=min(ans,(ll)2);
                    if(i==0||i==n-1||j==0||j==m-1) ans=min(ans,(ll)3);
                    ans=min(ans,(ll)4);
                }
            }
        }
        ...
        if(flag==0) ans=min(ans,(ll)0);
        flag=0;
        REP(i,0,n)
        {
            if(a[i][0]==0) flag=1;
        }
        if(flag==0) ans=min(ans,(ll)1);
        flag=0;
        REP(i,0,n)
        {
            if(a[i][m-1]==0) flag=1;
