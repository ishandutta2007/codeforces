...
fun main(){
    solve.cases{
        ...
        fun solve():Int {
            val new = Array(n){board[it].copyOf()}
//            for(i in 0 until n) {
//                for(j in 0 until m) {
//                    if(negate){
//                        new[i][j] = !new[i][j]
...
//            }
            ...
            val hp = HopcroftKarp(n-1,m-1,n * m)
            for(i in 0 until n-1) {
                for(j in 0 until m-1){
                    if(need[i][j] == 1 && need[n-1][j] == 1 && need[i][m-1] == 1){
                        hp.addEdge(i,j)
                    }
                }
            }
            val mm = hp.maxMatching()
            var best = total
            var now = total
            repeat(mm){
                now -= 3
...
//                for(j in 0 until m-1){
//                    var alternate = total
//                    for(ii in listOf(i,n-1)){
//                        for(jj in listOf(j,m-1)) {
//                            alternate -= need[ii][jj]
//                            alternate += 1 - need[ii][jj]
//                        }
//                    }
//                    best = minOf(alternate + 3, best)
//
//                }
//            }
