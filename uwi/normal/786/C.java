...
public class Round406C {
	...
	void solve()
	{
		...
		while(!pq.isEmpty()){
			...
			int ind = firstGEFenwick(ft, cur[1]+1);
			anss[cur[1]]++;
			if(ind < n) {
				cur[0] = ind;
				pq.add(cur);
	...
	public static int[] makeNext(int[] a, int sup)
	{
		int n = a.length;
	...
	public static void main(String[] args) throws Exception { new Round406C().run(); }
