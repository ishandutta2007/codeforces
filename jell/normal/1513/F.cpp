#line 1 "codeforces-workspace/contest/1513/f/f.cpp"
...
#line 6 "codeforces-workspace/contest/1513/f/f.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace/contest/1513/f/f.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace/contest/1513/f/f.cpp"
...
#line 28 "codeforces-workspace/contest/1513/f/f.cpp"
...
void main() {
  ...
  auto solve = [&]() -> auto {
    ...
    compression<i64> cprs;
    for (auto &&x : vp) {
      cprs.emplace(x.first);
    }
    segment_tree<mono> sgt(n);
    for (auto &&[a, b] : vp) {
      chgr(ans, min(a, sgt.fold(0, cprs.upper_bound(b)).v) - b);
      chgr(sgt[cprs.lower_bound(a)].v, b);
    }
  };
