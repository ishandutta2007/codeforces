#line 1 "codeforces-workspace/contest/1451/c/c.cpp"
/*
 * @file template.cpp
 * @brief Template
 */
...
#line 12 "codeforces-workspace/contest/1451/c/c.cpp"
...
void main() {
  ...
  for (auto i = 0; i < size(ac); ++i) {
    if (ac[i] > bc[i]) {
      auto red = (ac[i] - bc[i] + k - 1) / k * k;
      ac[i] -= red;
      ac[i + 1] += red;
    }
