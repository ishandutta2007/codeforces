...
int main()
{
    ...
    */
    ...
    REP(tc,1,ntc+1)
    {
        ...
        REP(i,0,n)
        {
            if(d1[i]>d1[mxi1]&&(d1[i]==i+1||d1[i]==n-i)) 
            {
                mxi1=i;
            }
            if(d2[i]>d2[mxi2]&&(d2[i]==i||d2[i]==n-i))
            {
                mxi2=i;
            }
        }
        ...
        if(d1[mxi1]>d2[mxi2])
        {
            ans+=s.substr(mxi1-d1[mxi1]+1,d1[mxi1]*2-1);
        }
        else
        {
            ans+=s.substr(mxi2-d2[mxi2],d2[mxi2]*2);
        }
        REPI(i,0,mxp)
        {
            ans+=s0[i];
