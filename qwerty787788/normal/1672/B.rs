pub mod solution {
//{"name":"B.   AAAB","group":"Codeforces - Codeforces Global Round 20","url":"https://codeforces.com/contest/1672/problem/B","interactive":false,"timeLimit":1000,"tests":[{"input":"4\nAABAB\nABB\nAAAAAAAAB\nA\n","output":"YES\nNO\nYES\nNO\n"}],"testType":"multiNumber","input":{"type":"stdin","fileName":null,"pattern":null},"output":{"type":"stdout","fileName":null,"pattern":null},"languages":{"java":{"taskClass":"BYaLyublyuAAAB"}}}
