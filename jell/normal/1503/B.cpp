#line 1 "codeforces-workspace/contest/1503/b/b.cpp"
...
#line 6 "codeforces-workspace/contest/1503/b/b.cpp"
...
#endif
#line 9 "codeforces-workspace/contest/1503/b/b.cpp"
// #include "lib/opt"
...
#line 12 "codeforces-workspace/contest/1503/b/b.cpp"
...
void main() {
  ...
  bool flag = 0;
  int c = -1;
  for (auto _t : range(n * n)) {
    int a;
    cin >> a;
    a--;
    int b = !a;
    if (flag) {
      auto [x, y] = cells[c].back();
      if (a == !c)
        b = c;
      else
        b = a ^ !c ^ 3;
