...
char s[5005];
int pn[5005], cn[5005];
int p[5005], cnt[5005], c[5005];
int cs[30][5005];
int compare (int i, int j, int l, int k) {
    pair<int,int> a = make_pair (cs[k][i], cs[k][i+l-(1<<k)]);
    pair<int,int> b = make_pair (cs[k][j], cs[k][j+l-(1<<k)]);
//    if (i == 0 && j == 4) {
//        DBN(a, b, k);
//    }
