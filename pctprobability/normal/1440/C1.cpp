...
void f(ll a,ll b){
  cout<<a<<" "<<b<<" "<<a+1<<" "<<b<<" "<<a<<" "<<b+1<<endl;
  cout<<a<<" "<<b<<" "<<a+1<<" "<<b<<" "<<a+1<<" "<<b+1<<endl;
  cout<<a<<" "<<b<<" "<<a<<" "<<b+1<<" "<<a+1<<" "<<b+1<<endl;
}
void p(ll a,ll b){
  cout<<a<<" "<<b<<" "<<a+1<<" "<<b<<" "<<a+1<<" "<<b+1<<endl;
  cout<<a+1<<" "<<b<<" "<<a<<" "<<b+1<<" "<<a+1<<" "<<b+1<<endl;
  cout<<a<<" "<<b<<" "<<a<<" "<<b+1<<" "<<a+1<<" "<<b+1<<endl;
}
void solve(){
  ll a,b;
  ...
  vcin(n);
  ll ans=0;
  vector<vector<ll>> k(a,vector<ll>(b));
  for(int i=0;i<a;i++){
    for(int j=0;j<b;j++){
      k.at(i).at(j)=ctoi(n.at(i).at(j));
      if(k.at(i).at(j)==1){
        ans++;
      }
    }
  ...
  if(k.at(a-1).at(0)==1){
  cout<<a-1<<" "<<1<<" "<<a<<" "<<1<<" "<<a-1<<" "<<2<<endl;
  cout<<a-1<<" "<<1<<" "<<a<<" "<<1<<" "<<a<<" "<<2<<endl;
  cout<<a<<" "<<1<<" "<<a<<" "<<2<<" "<<a-1<<" "<<2<<endl;
  }
  if(k.at(0).at(b-1)==1){    
  cout<<1<<" "<<b-1<<" "<<1<<" "<<b<<" "<<2<<" "<<b<<endl;
  cout<<1<<" "<<b-1<<" "<<1<<" "<<b<<" "<<2<<" "<<b-1<<endl;
  cout<<1<<" "<<b<<" "<<2<<" "<<b<<" "<<2<<" "<<b-1<<endl;
  }
}
int main() {
