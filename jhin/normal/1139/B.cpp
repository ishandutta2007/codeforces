...
long long m,x,n,y,z,x1,k,one,gd,mx,x2,y2,two,mn=1e9,mid,l,r,pos,a[500003],b[500003],c[500000],c2[500000];string s2;vector<int>v,v2[100003];long long sum,ans,num;char ch;
...
int post[10000000][2];
int t,sum2,y3,z3,mx2;bool used;//))(())))
bool hast[200001];
int prevx,prevy;
