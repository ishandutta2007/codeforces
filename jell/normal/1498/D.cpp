#line 1 "codeforces-workspace/contest/1498/d/d.cpp"
...
#line 11 "codeforces-workspace/contest/1498/d/d.cpp"
...
void main() {
  ...
  for (auto t : range(1, n + 1)) {
    ...
    for (auto i : range(m + 1)) {
      ...
      switch (tp) {
        case 1: {
          ii = ceil_div(ii * ten + x, ten);
        } break;

        case 2: {
          ii = ceil_div(ii * x, ten);
        } break;
      ...
      if (~dist[i] && ii < dist.size()) {
        chle(dist[ii], dist[i] + 1);
      }
    }
  }
