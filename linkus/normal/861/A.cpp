...
int main(){
    ...
    ll ans1 = (ll)n*(ll)pow(10,k);
    cout << ans1 << '\n';
    /* string sans1 = to_string(ans1); */
    /* int zcnt = 0; */
    /* for(int i = sans1.size()-1; i; --i){ */
    /*     if(sans1[i] == '0'){ */
    /*         ++zcnt; */
    /*     } */
    /*     else{ */
    ...
    /*         sans1 += '0'; */
    /* } */
    /* ll ans2 = (ll)norig*(ll)pow(10,k); */
    /* whatis(norig) */
    /* whatis(k) */
    /* whatis(10*k) */
    /* whatis(ans2) */
    /* cout << min(stoll(sans1),ans2); */
