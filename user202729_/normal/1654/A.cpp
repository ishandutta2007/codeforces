// time-limit: 2000
// problem-url: https://codeforces.com/contest/1654/problem/A

/*
 
somehow I've been participating at sub-2400 the last 2 virtual contests. This is not acceptable.
it is already a(n) year since my last rated contest...

okay, this is combined div 1+2 contest, I'd have more easy problems to burn time on...
*/
...
void up(){
	...
	std::partial_sort(a.begin(), a.end()-2, a.end());
	std::cout<<a.back()+a.end()[-2]<<'\n';
}