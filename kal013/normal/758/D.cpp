...
void solve(){
	...
	while(t.size() > 0){
		...
		else if (tmp.size() >= s.size() && tmp.back() == '0'){
			string res;	
	...
	// 	if (tmp.size() >= s.size() && t[i] == '0'){
	// 		ans += cur * mul;
	// 		cur = 0;
	// 		// tmp = '0';
	// 		m2 = 10;

	// 		// while(tmp.size() > 0 && tmp.back() == '0'){
	// 			// mul *= x1;
	// 			// tmp.pop_back();
