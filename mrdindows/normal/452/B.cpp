...
int main()
{
    ...
    v.push_back({ 0, m });
    v.push_back({ n, 0 });
    if (n > 0) v.push_back({ n - 1, m }), v.push_back({ n - 1, 0 }), v.push_back({ 1, m }), v.push_back({ 1, 0 });
    if (m > 0) v.push_back({ 0, m - 1 }), v.push_back({ n, m - 1 }), v.push_back({ n, 1 }), v.push_back({ 0, 1 });
    if (n > 0 && m > 0) v.push_back({ n - 1, m - 1 }), v.push_back({ 1, 1 });
