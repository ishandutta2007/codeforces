#line 1 "codeforces-workspace/contest/1494/c/c.cpp"
...
#line 11 "codeforces-workspace/contest/1494/c/c.cpp"
...
int solve(vector<int> a, vector<int> b) {
  ...
  for (int i : range(n)) {
    while (pos != b.end() && *pos < a[i + 1]) {
      if (*pos == a[i]) {
        ++ret;
      }

      while (pos2 != pos && *pos - *pos2 > i) {
        ++pos2;
      }

      chge<int>(ret, pos - pos2 + 1);
      ++pos;
    }
  }
