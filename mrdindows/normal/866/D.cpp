...
//    }
//}
//pii getMax(int cur, int l, int r, int x, int y) {
...
//}
//void del(int cur, int l, int r, int x) {
//    if (l == r) {
//        tr[cur] = {0, l};
//    } else {
//        int m = (l + r) / 2;
...
//        p[i] = {a[i], i};
    ...
    ll ans = 0;
    FI(n) {
        auto dif1 = a[i] - *canBuy.begin();
        auto dif2 = a[i] - *sold.begin();
        if (dif1 <= 0 && dif2 <= 0) {
            canBuy.insert(a[i]);
        } else if (dif1 >= dif2) {
            auto it = canBuy.begin();
            ans += a[i] - *it;
            canBuy.erase(it);
            sold.insert(a[i]);
        } else {
...
//        int x = p[i].first;
//        auto p = getMax(1, 0, n - 1, pos + 1, n);
//        if (p.first <= x) {
//            continue;
//        }
//        ans += p.first - x;
//        del(1, 0, n - 1, p.second);
//        used[p.second] = true;
//    }
//
//
//    multiset<int> wantBuy;
//    multiset<int> wantSell;
//    FI(n) {
//
//    }
//
