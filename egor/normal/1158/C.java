...
public class Main {
    ...
    static class TaskC {
        public void solve(int testNumber, InputReader in, OutputWriter out) {
            int n = in.readInt();
            int[] next = in.readIntArray(n);
            MiscUtils.decreaseByOne(next);
            int[] orNext = next.clone();
            ...
            ArrayUtils.sort(order, (a, b) -> next[a] != next[b] ? next[b] - next[a] : a - b);
            int current = n;
