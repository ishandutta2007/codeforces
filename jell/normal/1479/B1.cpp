#line 1 "codeforces-workspace/contest/1479/b1/b1.cpp"
...
#line 12 "codeforces-workspace/contest/1479/b1/b1.cpp"
...
#line 28 "codeforces-workspace/contest/1479/b1/b1.cpp"
...
void main() {
  ...
  int pv = 0;
  for (auto &&x : a) {
    auto tmp = max((s.fold(0, x) + s.fold(x + 1, n + 1)).v + 1, s[x].v);
    s.update({pv != x});
    chge(s[pv].v, tmp);
    pv = x;
  }
