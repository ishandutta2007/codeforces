...
int main(){
    LL(n);
    VV(char,c,n,n);
    rep(n)rep(j,n)dp[i][i+1][j][j+1]=c[i][j]=='#';
    rep(x2,n+1)rrep(x1,x2)rep(y2,n+1)rrep(y1,y2){
        if(x2-x1==1&&y2-y1==1)continue;
        int&a=dp[x1][x2][y1][y2]=max(x2-x1,y2-y1);
        rep(x3,x1+1,x2)chmin(a,dp[x1][x3][y1][y2]+dp[x3][x2][y1][y2]);
        rep(y3,y1+1,y2)chmin(a,dp[x1][x2][y1][y3]+dp[x1][x2][y3][y2]);
    }
    out(dp[0][n][0][n]);
}