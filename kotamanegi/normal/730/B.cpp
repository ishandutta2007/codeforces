    ...
    REP(tea, t) {
        ...
        for (int i = 0; i+1 < n; i += 2) {
            ...
            if (s[0] == '<') {
                ...
                kouho[1].push_back(i + 2);
            }
            else {
                kouho[0].push_back(i + 2);
                kouho[1].push_back(i + 1);
            }
        }
        if (n % 2 == 1) {
            kouho[0].push_back(n);
        ...
        int mins = 0, maxs = 0;
        for (int q = 1; q < kouho[0].size(); ++q) {
            cout << "? " << kouho[0][mins] << " " << kouho[0][q] << endl;
            string s;
            cin >> s;
            if (s == ">") {
                mins = q;
        ...
        for (int q = 1; q < kouho[1].size(); ++q) {
            cout << "? " << kouho[1][maxs] << " " << kouho[1][q] << endl;
            string s;
            cin >> s;
            if (s == "<") {
                maxs = q;
        ...
        cout << "! " << kouho[0][mins] << " " << kouho[1][maxs] << endl;
    }
}
