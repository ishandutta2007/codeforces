...
int calc(){ll h0=0,he=0,s=0;rfor(int c=readchar();isdigit(c);c=gc())c&1||((c==48&&!h0?h0:he)=1),s+=c;return!(s%3)&&h0&&he;}
int main(){ll T=readll();while(T --> 0)puts(calc()?"red":"cyan");return 0;}