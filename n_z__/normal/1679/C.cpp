...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
    ...
    while(q--)
    {
        ...
        if(op==1)
        {
            ...
            a[x]++;
            b[y]++;
            if(a[x]==1)add(x,1,h,n);
            if(b[y]==1)add(y,1,l,n);
        }
        else if(op==2)
        {
            int x,y;
            ...
            a[x]--;
            b[y]--;
            if(a[x]==0)add(x,-1,h,n);
            if(b[y]==0)add(y,-1,l,n);
        }
        else
        {
            int a,b,c,d;
            cin>>a>>b>>c>>d;
            if(query(c,h)-query(a-1,h)==c-a+1||query(d,l)-query(b-1,l)==d-b+1)cout<<"Yes"<<endl;
            else cout<<"No"<<endl;
        }
    }
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
