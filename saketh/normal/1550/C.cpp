...
void solve() {
    ...
    F0R (i, N) {
        // lis(x) = lowest possible final element for weakly increasing sequence of length x
        vi lis = { INT_MAX };
