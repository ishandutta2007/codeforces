...
int dp[2*N+1][N+1],c[2*N+1],ans[N+1];
//222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222//
/*default-var-------------------------------------------------------------------------------------*/
namespace nz{
/*namespace-head----------------------------------------------------------------------------------*/
...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
    ...
    dp[0][x]=1;
    c[0]=1;
    for(int x=1;x<=min(n,2*k);x++)
    c[x]=c[x-1]*(n-x+1)%p*qp(x)%p;
    for(int x=2;x<=min(n,2*k);x++)
    for(int y=1;y<=k;y++)
    dp[x][y]=(dp[x-1][y-1]+dp[x-2][y-1])*(x-1)%p;
    for(int x=0;x<=min(n,2*k);x++)
    for(int y=1;y<=k;y++)
    (ans[y]+=dp[x][y]*c[x]%p)%=p;
    for(int x=1;x<=k;x++)
    cout<<ans[x]<<' ';
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
/*Main-end----------------------------------------------------------------------------------------*/
