...
bool chck(int aPlusb, int var){
    if(aPlusb > inf / aPlusb)
        return false;

    int threeab = aPlusb * aPlusb - var;

    if(threeab % 3) return false;
    ...
    if(sqD * sqD != D) return false;

    int a1 = -b + sqD , a2 = -b + sqD;
