...
//Supported by Xu13 Virus Laboratory
...
inline matrix times(matrix a,matrix b)//a*b
{
...
inline void timesto(matrix& a,matrix b)//a*=b
{
...
//Yan Zack loves Sun Sandy
inline void SunSandy(int now,int nl,int nr,int l,int r,int what)//Beta version
{
	if(nl>r||nr<l)return;
	int m=(nl+nr)/2;
	//Gao ic
