...
using RH2 = RollingHash< 100000017 > ;

signed main(){
    ios_base::sync_with_stdio(0),cin.tie(0),cout.tie(0);cout<<fixed<<setprecision(15);
    int n=in(),m=in();
    int base1=rng()%100000;
    int base2=rng()%100000;
    vector<RH> rh;
    vector<RH2> rh2;
    string s;cin>>s;
    rep(j,26){
    ...
    rep(i,m){
        ...
        vecll a2,b2;
        rep(j,26){
            a.pb(rh[j].get(x-1,x+l-1));
            a2.pb(rh2[j].get(x-1,x+l-1));
            b.pb(rh[j].get(y-1,y+l-1));
            b2.pb(rh2[j].get(y-1,y+l-1));
        }
        sort(all(a));
        sort(all(a2));
        sort(all(b));
        sort(all(b2));
        cout<<(a==b and a2==b2 ? "YES\n":"NO\n");
    }
}