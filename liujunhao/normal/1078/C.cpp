...
void dfs(int u,int fa){
	...
	for(auto v:adj[u]){
		if(v!=fa){
			...
			int t[3]={0,0,0};
			//
			t[1]=(1ll*f[u][1]+f[u][0]+f[u][2])*f[v][2]%MOD;
			t[0]=1ll*f[u][0]*f[v][2]%MOD;
			t[2]=1ll*f[u][2]*f[v][2]%MOD;
			//
			t[1]=(t[1]+2ll*f[u][1]*f[v][1])%MOD;
			t[0]=(t[0]+(2ll*f[u][0]+f[u][2])*f[v][1])%MOD;
			t[2]=(t[2]+1ll*f[u][2]*f[v][1])%MOD;
			//
			t[1]=(t[1]+1ll*(f[u][0]+f[u][2])*f[v][0])%MOD;
			f[u][0]=t[0];
			f[u][1]=t[1];
			f[u][2]=t[2];
		}
