...
data class query(val type:Int, val a:Int, val b:Int){}
...
fun main(){
    solve.cases{
        ...
        val transform = IntArray(500002){it}

        val things = mutableListOf<Int>()
        for(a in qs.asReversed()){
            if(a.type == 2){
                transform[a.a] = transform[a.b]
            }else{
                val got = transform[a.a]
                things.add(got)
            }
        }
        things.reverse()
        put(things.joinToString(" "))
