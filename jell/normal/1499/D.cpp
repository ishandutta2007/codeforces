#line 1 "codeforces-workspace/contest/1499/d/d.cpp"
...
#line 11 "codeforces-workspace/contest/1499/d/d.cpp"
...
void pre() {
  ...
  called = 1;
  for (int d = 2; d < size(cnt); d++) {
    if (!cnt[d]) {
      cnt[d]++;
      for (int k = d * 2; k < size(cnt); k += d) cnt[k]++;
    }
  }
  p3[0] = 1;
  for (auto i : range(19)) {
