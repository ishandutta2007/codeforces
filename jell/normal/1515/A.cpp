#line 1 "codeforces-workspace/contest/1515/a/a.cpp"
...
#line 6 "codeforces-workspace/contest/1515/a/a.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace/contest/1515/a/a.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace/contest/1515/a/a.cpp"
...
void main() {
  ...
  cout << "YES"
       << "\n";
  if (auto it = find(begin(acc), end(acc), x); it != end(acc)) {
    auto pos = it - acc.begin();
    swap(a[pos], a[pos - 1]);
  }
  cout << a << "\n";
}
