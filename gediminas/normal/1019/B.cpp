...
int main () {
	...
	// 	int to = fr + 3;
	// 	int mid1 = (2 * fr + to + 1) / 3;
	// 	int mid2 = (fr + 2 * to + 2) / 3;
	// 	cout << fr << " " << mid1 << " " << mid2 << " " << to << endl;
	// }

	while (fr < to) {
		if (fr + 2 >= to and paklaus + to - fr + 1 <= 60) {
			for (int i = fr; i <= to; i++) {
				query2(i);
			}
