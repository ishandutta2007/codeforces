...
public:
	bool check(int c4, int c7, int c47, int c74, bool put4, ostream &cout) {
		...
		while (true) {
			if (put4) {
				if (!c4) return false;
				ss << '4'; --c4;
				while (c4 > c74) { ss << '4'; --c4; }
				if (c47) --c47; else break;
			} else {
				if (!c7) return false;
				ss << '7'; --c7;
				if (!c47) while (c7) { ss << '7'; --c7; }
				if (c74) --c74; else break;
			}
    ...
    void solve(istream& cin, ostream& cout) {
        int c4, c7, c47, c74;
        cin >> c4 >> c7 >> c47 >> c74;
		if (!check(c4,c7,c47,c74,true,cout) && !check(c4,c7,c47,c74,false,cout)) cout << -1 << endl;
    }
};
