#line 1 "codeforces-workspace/contest/1320/b/b.cpp"
...
#line 11 "codeforces-workspace/contest/1320/b/b.cpp"
...
void main() {
  ...
  for (auto i : range(k - 1)) {
    ...
    for (auto &&to : g[path[i]]) {
      if (to != path[i + 1] && dist[to] + 1 == dist[path[i]]) {
        ma += 1;
        break;
      }
    }
