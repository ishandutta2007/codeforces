...
signed main(){
    ...
    STR(s);
    n--;
    int min=1,max=999999999,cen=(min+max)/2;
    rep(n){
        out(cen,cen);
        STR(t);
        if(s==t)min=cen-1;
    ...
    if(min+max<=1000000000)out(0,min+max,min+max,0);
    else out(1000000000,min+max-1000000000,min+max-1000000000,1000000000);
}