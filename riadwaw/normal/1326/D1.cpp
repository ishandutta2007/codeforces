...
class D2PrefiksnoSuffiksniiPalindromUslozhnennayaVersiya {
public:
	...
	void solve(std::istream& in, std::ostream& out) {
		...
		while (s[k] == s[s.size() - 1 - k]) {
			++k;
		}
		string t = s.substr(k, s.size() - 2 * k);
		...
		out << s.substr(0, k) << t.substr(bestL, bestR - bestL + 1) << s.substr(s.size() - k) << "\n";
	}
};
...
int main() {
	...
	D2PrefiksnoSuffiksniiPalindromUslozhnennayaVersiya solver;
