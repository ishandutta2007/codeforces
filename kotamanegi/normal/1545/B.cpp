#line 1 "Contests/Codeforces_1545/B/main.cpp"
using namespace std;
...
#endif
#line 3 "Contests/Codeforces_1545/B/main.cpp"
...
#line 7 "Contests/Codeforces_1545/B/main.cpp"
using namespace std;
...
mint memo[1000000];
mint kaijo(int a){
    if(memo[a].val()) return memo[a];
    if(a == 0) return 1;
    return memo[a] = a * kaijo(a-1);
}
mint gyaku_S[1000000];
mint gyaku(int a){
    if(gyaku_S[a].val()) return gyaku_S[a];
    return gyaku_S[a] = 1 / kaijo(a);
}
mint comb(int a,int b){
    return kaijo(a) * gyaku(b) * gyaku(a-b);
}
void solve(){
