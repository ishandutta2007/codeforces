...
fun main(){
    solve.cases{
        ...
        fun lessmin(s:String, l:Int, r:Int):String{
            if((r-l) %2 == 0){
                return s.slice(l..r)
            }
            val mid = (r-l+1)/2 + l
            val A = lessmin(s,l,mid-1)
            val B = lessmin(s,mid,r)
            if(A < B){
                return A + B
            }else{
                return B + A
        ...
        val ans = lessmin(s,0,n-1) == lessmin(t,0,n-1)
        put(if(ans) "YES" else "NO")

//        fun equal(l:Int,r:Int, l2:Int, r2:Int):Boolean{
//            if(s.slice(l..r) == t.slice(l2..r2)){
//                return true
//            }
//            if((r-l+1) %2 == 0){
//                val mid = (r-l+1)/2 + l
//                val mid2 = (r2- l2+1) /2 + 1
//                if(equal())
//            }
//            return false
//        }
