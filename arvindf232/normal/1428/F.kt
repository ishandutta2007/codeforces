...
//        var ret = 0L
//        for(left in 0..n){
//            while(S.isNotEmpty() && S.st.firstKey() < left ){
//                val (a,v) = S.st.pollFirstEntry()
//                sum -= a.toLong() * v
//                repeat(v){
//                    S.addone(n)
//                    sum += n
...
//            }
//            val options = n- left
//            val basetotal = (options).toLong() * n
//            val adding = basetotal - (sum - left * n )
//            ret += adding
//
//            left dei adding
//        }
...
huge accuracy mistakes
    trasnfroamtion did not actually handle the condition, at all
