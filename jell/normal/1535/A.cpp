#line 1 "codeforces-workspace\\contest\\1535\\a\\a.cpp"
...
#line 11 "codeforces-workspace\\contest\\1535\\a\\a.cpp"
...
void main() {
  ...
  auto t = s[0] + s[1], t2 = s[2] + s[3];
  nth_element(s, s + 2, s + 4);
  if (t == s[2] + s[3] || t2 == s[2] + s[3])
    cout << "NO\n";
  else
    cout << "YES\n";
}
