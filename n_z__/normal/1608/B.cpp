...
int ida[100001],idb[100001];
/*var---------------------------------------------------------------------------------------------*/
void Main(){
/*Main-head---------------------------------------------------------------------------------------*/
    int n,a,b;
    cin>>n>>a>>b;
    if(a-b>1||b-a>1||a+b+2>n){cout<<-1<<endl;return;}
    if(a==b)
    {
        for(int x=1;x<=a+1;x++)
        cout<<x<<' '<<x+a+1<<' ';
        for(int x=(a+1)*2+1;x<=n;x++)
        cout<<x<<' ';
        cout<<endl;
        return;
    }
    if(a==b+1){
        cout<<n-b-1<<' ';
        for(int x=1;x<=a;x++)
        cout<<x+n-b-1<<' '<<n-x-b-1<<' ';
        for(int x=n-a-b-2;x>=1;x--)
        cout<<x<<' ';
        cout<<endl;
        return;
    }
