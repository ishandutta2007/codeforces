#line 1 "codeforces-workspace/contest/367/c/c.cpp"
...
#line 6 "codeforces-workspace/contest/367/c/c.cpp"
// #include "lib/cxx20"
...
#line 11 "codeforces-workspace/contest/367/c/c.cpp"
...
void main() {
  ...
  int n, m;
  cin >> n >> m;
  int k = binary_search(0, m + 1, [&](auto x) {
    auto e = i64(x - 1) * x / 2;
    return (x % 2 ? e : e + x / 2 - 1) < n;
  });
