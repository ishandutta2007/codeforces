...
fun main(){
    solve.cases{
        ...
        val indegree = G.indegree()
        val outdegree = G.outdegree()
        val canenter = BooleanArray(n){indegree[it] > 1}
        val canexit = BooleanArray(n){outdegree[it] > 1}
