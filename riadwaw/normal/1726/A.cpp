...
public:
	...
	void solve(std::istream& in, std::ostream& out) {
		...
		for(int i: range(n)) {
			updateMax(mx, a[i] - a[(i + 1) % n]);
//			cerr << mx << endl;
		}

		if (n > 1) {
			updateMax(mx, a.back() - *min_element(a.begin() + 1, a.end()));
//			cerr << a.back() << endl;
			updateMax(mx, *max_element(a.begin() + 1, a.end()) - a.front());
		}
		out << mx << "\n";
	}
};
