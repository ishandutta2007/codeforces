...
int n,k,m,x,y,l,l2,z,a[200001],ans,v1,v2,v3,vm;char q;bool check;char s[11][11];map<char,bool>letr,tst;
...
/*cin>>v1>>v2>>v3>>vm;
if(vm>2*v3||2*vm<v3)return cout<<-1,0;
if(v3<vm)v3=2*v3;v2=max(v2,v3+1);v1=max(v1,v2+1);
