 ...
 *  Created: 18-04-2022 at 22:02:35
 *
...
{
    pii ar[3];
    rep(i, 3) cin>>ar[i].ff>>ar[i].ss;
    sort(ar, ar+3);
    cout<<3<<nl;
    cout<<ar[0].ff<<' '<<ar[0].ss<<' '<<ar[1].ff<<' '<<ar[0].ss<<nl;
    cout<<ar[2].ff<<' '<<ar[2].ss<<' '<<ar[1].ff<<' '<<ar[2].ss<<nl;
    cout<<ar[1].ff<<' '<<max3(ar[2].ss, ar[1].ss, ar[0].ss)<<' '<<ar[1].ff<<' '<<min3(ar[2].ss, ar[1].ss, ar[0].ss)<<nl;
}
