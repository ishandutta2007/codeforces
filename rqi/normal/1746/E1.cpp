...
int main() {
    ...
    while(sz(states) > 2){
        ...
        vi which_set_12;
        if(querySet(spl.f.f)){
            which_set_12 = spl.f.s;
        }    
        else{
            which_set_12 = spl.f.f;
        }
        vi which_set_34;
        if(querySet(spl.s.f)){
            which_set_34 = spl.s.s;
        }
        else{
            which_set_34 = spl.s.f;
        }

        vi set_inter = intersectSets(which_set_12, which_set_34);
