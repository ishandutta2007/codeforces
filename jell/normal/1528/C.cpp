#line 1 "codeforces-workspace\\contest\\1528\\c\\c.cpp"
...
#line 6 "codeforces-workspace\\contest\\1528\\c\\c.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace\\contest\\1528\\c\\c.cpp"
// #include "lib/opt"
...
// #include "src/utils/rand/tree.hpp"
...
#line 24 "Library\\lib\\utils"
// #include "src\utils\reference_list.hpp"
#line 11 "codeforces-workspace\\contest\\1528\\c\\c.cpp"
...
#line 27 "codeforces-workspace\\contest\\1528\\c\\c.cpp"
...
void main() {
  ...
  fixed_point([&](const auto& dfs, int now) -> void {
    auto id = hld.index(now);
    int anc = -1;

    if (auto [l, r] = hld.subtree(now); 1) {
      auto lb = S.lower_bound(l);
      if (lb != S.end() && *lb < r) anc = id;
    }
    for (auto [l, r] : hld.path_decomposition(now)) {
      auto lb = S.lower_bound(l);
      if (lb != S.end() && *lb < r) anc = *lb;
    }
