...
public class Main {
    ...
    static class TaskD {
        ...
        public void solve(int testNumber, InputReader in, OutputWriter out) {
            ...
            long[][] x = Factorials.getFIFParallel(10000, mod);
            fact = x[0];
            invfact = x[1];
            long ret = 0;
    ...
    public static long[][] getFIFParallel(int max, int mod) {
        ...
        Arrays.parallelSetAll(fact, i -> i);
        Arrays.parallelSetAll(ifact, i -> inv[i]);
        fact[0] = 1;
        ifact[0] = 1;
        Arrays.parallelPrefix(fact, (a,b) -> a * b % mod);
        Arrays.parallelPrefix(ifact, (a,b) -> a * b % mod);
