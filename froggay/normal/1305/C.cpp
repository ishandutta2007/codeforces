...
int main(){
	...
	for(int i=1;i<=n;i++){
		a[i]=read();
            if (23289>26561) {
                double GHKPIZYQBJ;GHKPIZYQBJ=25808;if (GHKPIZYQBJ) {
                    long long PWZEUKLWGD;PWZEUKLWGD=16004;
                    if (1213>4875) {
                        double ANXAOJIPTB;
                        short VVTSUWBUTB;
                        int LWCLFWLYXA;
                ...
                if (30882>18739) {
                    short DVDAUPLHTQ;
                    short XKQKBDOCWY;XKQKBDOCWY=12485;if (XKQKBDOCWY) {
                        bool QWSSIFBHMF;
                        int ZBWZXLDSTP;
                    }
                    if (983>26447) {
		...
		buc[a[i]%m]++;
            long long SLHLQNPAVR;SLHLQNPAVR=28715;
	}
	for(int i=0;i<m;i++){
		if(buc[i]>1){
			printf("0\n");
			return 0;
                double EUIWYEYAXH;EUIWYEYAXH=2592;
		}
	}
	ll ans=1;
        if (30448>12573) {
            int WWLQPHBVFU;WWLQPHBVFU=17689;
            if (21300>29093) {
                bool CIVTUOIXVW;
            }
        }
	for(int i=1;i<=n;i++){
		for(int j=i+1;j<=n;j++){
			ans=ans*abs(a[i]-a[j])%m;
                bool JVNAAHTOMC;JVNAAHTOMC=12144;if (JVNAAHTOMC) {
                    long long YYBVYDOFIZ;
                    double PUKHNXGHLR;PUKHNXGHLR=11134;
                }
		}
	}
	cout<<ans<<endl;
        bool BFZFAJAHJP;BFZFAJAHJP=27702;if (BFZFAJAHJP) {
            long long GRJKVDSUPK;GRJKVDSUPK=31083;if (GRJKVDSUPK) {
                if (7344>21031) {
                    if (13430>6930) {
                        int YZTEKYCEXH;
                        double RMGXTHTCXE;
                ...
                long long CJSSCLMZUU;CJSSCLMZUU=24416;
                if (1470>27735) {
                    int MMUICAJFAP;
                    if (5792>14230) {
                        double DPSXHZDHOT;
                        long long NPKNGIBVQT;
                        double UVEGIPSWFF;
                        short SRFYCDCVFU;
                        short CJRMQOIKBI;
                    }
            ...
            if (11216>22837) {
                long long MNKZBFRGFJ;
                short ICSTNOPDLO;ICSTNOPDLO=6349;if (ICSTNOPDLO) {
                    if (27645>14013) {
                        int FOLNJLTMDX;
                        long long RQGHCPFZMY;
                        long long CBANSDKKKB;
                        long long RDOHCWWIPX;
                    }
                    if (10160>24441) {
                        double VSVQHUFVMW;
                    }
                }
                int XPTKNPPOHX;XPTKNPPOHX=18014;
                if (3933>31689) {
                    int FNXJPICBKA;
                }
            }
            double BAGZRPCXQH;BAGZRPCXQH=11896;
        }
	return 0;
        long long QLXZPYBXTJ;QLXZPYBXTJ=17162;
}