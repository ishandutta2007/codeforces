#line 1 "codeforces-workspace\\contest\\1552\\c\\c.cpp"
...
#line 16 "codeforces-workspace\\contest\\1552\\c\\c.cpp"
//*/
...
void main() {
  ...
  input n, k;
  vector<int> put(n * 2);
  auto ans = (n - k) * (n - k - 1) / 2;
  auto r = n - k;
  vector<pair<i32, i32>> s;
  while (k--) {
    input a, b;
    --a, --b;
    if (a > b) swap(a, b);
