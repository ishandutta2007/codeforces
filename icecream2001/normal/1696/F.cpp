...
string s;
bool mp[110][110][110];
bool ask(int z,int x,int y){
	if(x==y) return 1;
	else return mp[z][x][y];
}
int fa[110];
int q[110*110];
...
bool ask2(int z,int x,int y){
	return dis[z][x]==dis[z][y];
}
