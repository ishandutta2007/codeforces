...
public class TaskA {
	...
	private void solve() {
		...
		out.println(BigInteger.class.getSimpleName());
	}

	private static List<Test> createTests() {
		List<Test> tests = new ArrayList<Test>();
		tests.add(new Test("127", "byte"));
		tests.add(new Test("130", "short"));
		tests.add(new Test("123456789101112131415161718192021222324", "BigInteger"));
//		tests.add(new Test("", ""));
//		tests.add(new Test("", ""));
//		tests.add(new Test("", ""));
//		tests.add(new Test("", ""));
