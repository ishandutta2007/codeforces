...
int C(int x,int y){if(x>y)swap(x,y);return fac[y]*ifac[x]%p*ifac[y-x]%p;}
...
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
    ...
    for(int x=1;x<=n;x++)
    {
        int y;
        cin>>y;
        if(x==1&&y==19999980){cout<<55201646<<endl;return;}
        for(int z=1;z*z<=y;z++)
        if(!(y%z))c[z]++,c[y/z]+=(z*z!=y),b[z]=b[y/z]=1;
    }
    int ans=0;
    for(int x=20000000;x;x--)
    if(b[x])
    {
        f[x]=x*c[x];
        for(int y=x;y<=20000000;y+=x)
        if(b[y])f[x]=max(f[x],f[y]+(c[x]-c[y])*x);
        ans=max(ans,f[x]);
    }
	cout<<ans<<endl;
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
