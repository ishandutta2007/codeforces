#line 1 "codeforces-workspace/contest/1517/c/c.cpp"
...
#line 6 "codeforces-workspace/contest/1517/c/c.cpp"
// #include "lib/cxx20"
...
#endif
#line 8 "codeforces-workspace/contest/1517/c/c.cpp"
// #include "lib/opt"
...
#line 11 "codeforces-workspace/contest/1517/c/c.cpp"
...
void main() {
  ...
  auto a = make_vector<int>({n, n}, -1);
  auto used = a;

  auto dfs = fixed_point(
      [&](const auto& dfs, int i, int j, int tag, int& cnt) -> void {
        if (!cnt) return;
        if (j < 0 || i < 0) return;
        if (~a[i][j]) return;
        a[i][j] = tag;
