...
//topological-sort(vertex:1-indexed)
long long topological_sort(long long n,long long m,rs g[],mkj x[],long long res[]){
  long long cnt[524288]={0},c=0,i,j,w;
  for(i=0;i<m;i++){
    cnt[g[i].fi]++;
  }
  for(i=1;i<=n;i++){
