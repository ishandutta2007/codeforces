...
int main() {
    ...
    vector<mn> seq{3,  9,  4,  17, 11, 25, 8,  33, 19, 41, 12,  49, 27,  57, 16,
                   65, 35, 73, 20, 81, 43, 89, 24, 97, 51, 105, 28, 113, 59, 121};
    vector<mn2> seq2{3,  9,  4,  17, 11, 25, 8,  33, 19, 41, 12,  49, 27,  57, 16,
                     65, 35, 73, 20, 81, 43, 89, 24, 97, 51, 105, 28, 113, 59, 121};
    ...
    while (t--) {
        ...
        auto ans = lfsr[n - 1];
        auto ans2 = lfsr2[n - 1];
        auto res = crt(vll{998244353, int(1e9) + 7}, vll{ans.v, ans2.v});
        ps(res);
    }
