...
const double b=0.75;
int f[1001];
mt19937 mttt(time(0)),mtt(mttt()*time(0)*mttt()*time(0)),mt(mtt()*time(0)*mtt()*time(0));
//333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333333//
/*var-and-func------------------------------------------------------------------------------------*/
void Main(){
/*Main-head---------------------------------------------------------------------------------------*/
//444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444//
    ...
    while(m--)
    {
        ...
        double s1=0,s2=0;
        for(int x=1;x<=n;x++)
        if(s[x]=='0')s1+=pow(b,f[x]);
        else s2+=pow(b,f[x]);
        double p=mt()%100000000/100000000.0;
        if(p<=s1/(s1+s2))cout<<0<<endl;
        else cout<<1<<endl;
        char w;
        cin>>w;
        for(int x=1;x<=n;x++)
